...
PHASES: list[tuple[str, str, bool]] = [
    ...
    ("cost-seg-irs-setup", "6x. Cost Seg IRS Pipeline (global)", False),
    ("cost-seg-synthesized-link", "6x. Cost Seg Synthesized Link (global)", False),
    ("w2-irs-setup", "6x. W-2 IRS Pipeline (global)", False),
    ("w2-synthesized-link", "6x. W-2 Synthesized Link (global)", False),
    ("promote-pdf-ground-truth", "6x. Promote PDF Ground Truth (global)", False),
    ("form-4562-pdf-bridge", "6x. Form 4562 PDF Bridge [deprecated]", False),
    ("schedule-e-pdf-bridge", "6x. Schedule E PDF Bridge [deprecated]", False),
