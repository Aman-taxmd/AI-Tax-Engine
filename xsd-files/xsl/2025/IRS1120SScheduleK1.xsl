...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	...
	<xsl:template name="DisplayCodeAndAmountTable">
		...
		<xsl:if test="count($TargetNode) &gt; 0">
			...
			<table class="styDepTbl" style="font-size:7pt;" role="presentation">
	...
	<xsl:template match="/">
		...
		<html>
			...
			<body class="styBodyClass" style="width:187mm;">
				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family:Verdana; font-size: 7pt;" role="presentation">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right; width: 186mm;">671124</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="width: 186mm;">
								<span style="float: right; margin-bottom: 0.5mm;">
									<input aria-label="Final K-1" type="checkbox" class="styCkbox" name="checkbox" onclick="return false;">
									...
									<input type="checkbox" aria-label="Amended K-1" class="styCkbox" name="checkbox" id="dummyID2" onclick="return false;">
										<xsl:call-template name="PopulateCheckbox">
					...
					<tr>
						<td style="width: 93mm; border-right: 2px solid black;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" role="presentation">
									...
									<td style="width: 93mm;">
										<div style="width: 93mm;">
											...
											<div class="styTY" style="float: right; clear: none; padding-right: 0mm;">
												20<span class="styTYColor" style="padding-right: 2mm;">25</span>
											</div>
										</div>
									</td>
								</tr>
								<tr>
									<td style="font-size: 7pt;">Department of the Treasury<br/>
										...
										<span style="float: right; clear: none; padding-right: 2mm;">For calendar year 2025 or tax year 
										</span>
								...
								<tr>
									<td class="IRS1120SScheduleK1_tdLeft" style="height: 24mm;">
										...
										<span style="width: 3mm;"/>If the shareholder is a disregarded entity, a trust, an estate, or a nominee or similar person, enter the individual or entity responsible for reporting:
										<br/>
										TIN:
										<span style="width: 25mm; border-bottom: 1px solid black; text-align: left;">
										<xsl:choose>
											<xsl:when test="$FormData/ResponsibleBusinessEIN != ''">
												<xsl:call-template name="PopulateEIN">
													<xsl:with-param name="TargetNode" select="$FormData/ResponsibleBusinessEIN"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:when test="$FormData/ResponsibleIndividualSSN != ''">
												<xsl:call-template name="PopulateSSN">
													<xsl:with-param name="TargetNode" select="$FormData/ResponsibleIndividualSSN"/>
												</xsl:call-template>
											</xsl:when>
											...
											<xsl:otherwise>
												<xsl:call-template name="PopulateEIN">
													<xsl:with-param name="TargetNode" select="$FormData/MissingSSNReasonCd"/>
												</xsl:call-template>	
											</xsl:otherwise>
										</xsl:choose>
										</span>
										Name:
										<span style="width: 48mm; border-bottom: 1px solid black; text-align: left;">
										<xsl:choose>
											<xsl:when test="$FormData/ResponsibleIndividualNm != ''">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ResponsibleIndividualNm"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ResponsibleBusinessName/BusinessNameLine1Txt"/>
												</xsl:call-template>
												<br/>
											<xsl:if test="not($FormData/ResponsibleBusinessName/BusinessNameLine2Txt='' or not ($FormData/ResponsibleBusinessName/BusinessNameLine2Txt))">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/ResponsibleBusinessName/BusinessNameLine2Txt"/>
												</xsl:call-template>
												<br/>
											</xsl:if>
											</xsl:otherwise>
										...
										<!-- Line F3 -->
										<span style="font-weight: bold;">F3</span>
										<span style="width: 3mm;"/>What type of entity is this shareholder?
										<span style="width: 33mm; border-bottom: 1px solid black; text-align: left;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/EntityTypeTxt"/>
										</xsl:call-template>
										</span>
								...
								<tr>
									<td class="IRS1120SScheduleK1_tdLeft" style="height: 71.3mm; vertical-align: middle;">
										<!-- IRS Use Only box -->
						...
						<td width="93mm" style="width: 93mm; border-right: 2px solid black;" valign="top">
							<table width="93mm" border="0" cellpadding="0" cellspacing="0" nowrap="yes" style="border-top: 2px solid black; border-bottom: 0px;">
								...
								<tr>
										...
										<table width="46.5mm" border="0" cellpadding="0" cellspacing="0" style="border-right: 1px solid black;">
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													<div class="styTableContainer" style="width:46.5mm;float:none;clear:both;" id="SchK10Ctn">
														<table cellpadding="0" cellspacing="0" style="height:auto;" role="presentation">
															<tbody>
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													<div class="styTableContainer" style="width:46.5mm;float:none;clear:both; display: block;" id="SchK12Ctn">
														<table cellpadding="0" cellspacing="0" style="height:auto;" role="presentation">
															<tbody>
									...
									<td valign="top">
										<table width="46.5mm" border="0" cellpadding="0" cellspacing="0" role="presentation">
											<!-- Line 13 -->
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													<div class="IRS1120SScheduleK1_itemLabel" style="width:5.3mm;height:12mm;text-align:center;float:left;vertical-align:top;border-right:1px solid black;">14</div>
													<div style="width:40mm;vertical-align:top;height:11mm;padding-left:1mm;">
													...
													<span style="float:right;margin-bottom: 0.5mm; margin-top:0.5mm;">
														<input aria-label="Schedule K-3 is attached" type="checkbox" class="styCkbox" name="checkbox" onclick="return false;">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" select="$FormData/ScheduleK3AttachedInd"/>
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													<div class="styTableContainer" style="width:49mm;float:none;clear:both; display: block;" id="SchK15Ctn">
														<table cellpadding="0" cellspacing="0" style="height: auto;" role="presentation">
															<tbody>
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													<div class="styTableContainer" style="width:49mm;float:none;clear:both;display: block;" id="SchK16Ctn">
														<table cellpadding="0" cellspacing="0" style="height:auto;" role="presentation">
															<tbody>
											...
											<tr>
												<td colspan="3" class="IRS1120SScheduleK1_tdRight">
													...
													<div class="styTableContainer" style="width:49mm;float:none;clear:both; display: block;" id="SchK17Ctn">
														<table cellpadding="0" cellspacing="0" style="height:auto;" role="presentation">
															<tbody>
								...
								<tr>
									<td colspan="2" style="height:13.2mm;font-family: Verdana; font-size: 7pt;border-top: 1px solid black;text-align: center;">
					...
					<tr>
						<td width="187mm" colspan="2" style="width: 187mm; font-family: Verdana; font-size: 6pt;font-weight: bold; border-top: 2px solid black;">
							...
							<span style="width: 51.5mm;text-align:right;">Schedule K-1 (Form 1120-S) 2025</span>
						</td>
					</tr>
				</table>
