  ...
  <form name="Form8866">
    ...
    <div style="width:187mm;">
      ...
      <div class="styFNBox" style="float:left;width:30mm;height:22mm;">
        ...
        <div style="padding-top:1.5mm; font-size:6pt;">(Rev. December 2025)
...
<!--     <div class="styNameBox" style="border-right-width:0px;width:20mm;text-align:center;font-size:7pt;font-weight:bold;padding-top:.5mm;height:10mm;">
      ...
      <div class="styNameBox" style="font-size:7pt;width:130mm;border-left-width:1px;border-bottom-width:1px;padding-left:1mm;height:10mm;">Name<br/>
    ...
    <!--<div class="styBB" style="width:187mm;">-->
	<!--		<xsl:choose>
			<xsl:when test="$RtnHdrData/Filer/USAddress"></xsl:when>
...
-->
      ...
      <div style="width:130mm;float:left;">
        <div class="styNameBox" style="border-left-width:1px;font-size:7pt;width:130mm;height:10mm;border-bottom-width:1px;">
          ...
          <div style="float:left;font-size:7pt;width:104mm;">
            <span style="width:1mm;"/>
          	...
          	<xsl:when test="$RtnHdrData/Filer/USAddress">
          	       	<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/USAddress/AddressLine1Txt"></xsl:with-param></xsl:call-template>
					<span style="padding-left:1mm"/><br/> 
					<span style="width:1mm;"/>
					<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/USAddress/AddressLine2Txt"></xsl:with-param></xsl:call-template> 
          	</xsl:when>
			<xsl:otherwise>
					<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/ForeignAddress/AddressLine1Txt"></xsl:with-param></xsl:call-template>
					<span style="padding-left:1mm"/><br/> 
					<span style="width:1mm;"/>
					<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/ForeignAddress/AddressLine2Txt"></xsl:with-param></xsl:call-template> 
			</xsl:otherwise>
          	</xsl:choose>
      ...
      <!--</xsl:if>       -->
            ...
            <!-- City or Town Box-->
        <div class="styNameBox" style="border-left-width:1px;float:left;font-size:7pt;width:60mm;height:10mm;">
          <span style="width:3px;"/>
          City or town
          <div style="float:left;font-size:7pt;width:60mm;">
            <span style="width:3px;"/>
            <xsl:choose>
            <!-- US address -->
            <xsl:when test="$RtnHdrData/Filer/USAddress">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/USAddress/CityNm"></xsl:with-param></xsl:call-template>
			</xsl:when>
			<!-- Foreign address -->
			<xsl:otherwise>
			<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/ForeignAddress/CityNm"></xsl:with-param></xsl:call-template>
			</xsl:otherwise>
			</xsl:choose>
          </div>
        </div>
			<!-- State or Province-->
			<div class="styNameBox" style="float:left;clear:none;padding-left:2mm;font-size:7pt;width:40mm;height:10mm;border-left-width:0px;border-color:black;">
			State or province
			<div style="float:left;font-size:7pt;width:40mm;">
            <span style="width:3px;"/>
            <xsl:choose>
            <!-- US address -->
            <xsl:when test="$RtnHdrData/Filer/USAddress">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/USAddress/StateAbbreviationCd"></xsl:with-param></xsl:call-template>
			</xsl:when>
			<!-- Foreign address -->
			<xsl:otherwise>
			<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/ForeignAddress/ProvinceOrStateNm"></xsl:with-param></xsl:call-template>
			</xsl:otherwise>
			</xsl:choose>
		    </div>
		</div>
		...
		<div class="styNameBox" style="float:left;clear:none;padding-left:2mm;font-size:7pt;width:30mm;height:10mm;border-left-width:0px;border-right-width:1px;border-color:black;">
			ZIP or foreign postal code
			<div style="float:left;font-size:7pt;width:30mm;">
            <span style="width:3px;"/>
            <xsl:choose>
            <!-- US address -->
            <xsl:when test="$RtnHdrData/Filer/USAddress">
            <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/USAddress/ZIPCd"></xsl:with-param></xsl:call-template>
			</xsl:when>
			<!-- Foreign address -->
			<xsl:otherwise>
			<xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/ForeignAddress/ForeignPostalCd"></xsl:with-param></xsl:call-template>
			</xsl:otherwise>
			</xsl:choose>
		    </div>
		</div>			
...
<xsl:call-template name="part5Loop">
  ...
  <!-- SCH B line 9-1 -->
<div style="width:187mm;">
<div class="styLNLeftNumBox" style="width:5mm">9a</div>
<div class="styLNDesc" style="width:152.1mm;">
 <span style="float: left; clear: none;">
      <span style="font-weight:bold;">Net interest to be refunded to you.</span> If line 8, column (c), is greater than line 7, column (c), enter the excess. File </span>
</div>
...
<span style="float: left; clear: none;">Form 8866 separately. <span style="font-weight:bold;">Do not </span> attach it to your tax return (see instructions)</span>
<!--Dotted Line-->
...
<!--   ********************************************************************* -->
							...
							<div style="width:187mm;">
								<div class="styLNLeftNumBox">
									...
									<div class="sty1040Desc">
										...
										<span class="styLNCtrNumBox" style="width:34mm;border-top-width:1px;padding-top:0mm;padding-bottom:0mm;font-weight:normal">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="$Form8866Data/RoutingTransitNum"/>
											</xsl:call-template>
										</span>
										...
										<input type="checkbox" class="styCkboxNM">
											<xsl:call-template name="PopulateEnumeratedCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8866Data/BankAccountTypeCd"/>
								...
								<!-- Line 9b GreyBox -->
								<div class="styLNAmountBox" style="width:29.9mm;height:4mm;border-left-width:1px;background-color:lightgrey;float:right;border-bottom:0px;"/>														
						</div>
							...
							<div class="styLNLeftNumBox">
								...
								<div class="sty1040Desc" style="height:4.4mm;">
									...
									<span class="styLNCtrNumBox" style="width:84mm;border-top-width:1px;padding-top:0mm;padding-bottom:0mm;font-weight:normal">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8866Data/DepositorAccountNum"/>
										</xsl:call-template>
									</span>
								</div>
								<!-- Line 9d GreyBox -->
								<div class="styLNRightNumBox" style="width:29.9mm;height:4.4mm;border-left-width:1px;background-color:lightgrey;float:right;border-bottom-width:1px;"/>
						</div>
...
<div class="styLNDesc" style="width:152.1mm;">
 <span style="float: left; clear: none;">
      <span style="font-weight:bold;">Net interest you owe.</span> If line 7, column (c), is greater than line 8, column (c), enter the excess. Attach Form 8866</span>
</div>
<div class="styLNRightNumBox" style="height:5mm;border-bottom-width:0px;border-right-width:0px"/>
<div class="styLNAmountBox" style="width:20.7mm;height:5mm;border-bottom-width:0px;border-left-width:0px;">
</div>
...
<!-- footer line -->
  <!-- Footer line -->
      <div style="width:187mm;clear:both;padding-top:1mm;">
        ...
        <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8866</span> (Rev. 12-2025)</div>
      </div>
  <!-- End Footer Line -->
