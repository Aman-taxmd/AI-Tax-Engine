	...
	<tr>
	  <td class="styIRS4562TableCellA" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
		<span class="styLN" style="font-weight:bold">
		  ...
		  <xsl:if test="$Classification = 51">
			<span style="width=3.5mm; padding-left:3mm"/>h</xsl:if>
		  <xsl:if test="$Classification = 50">
			<span style="width=3.5mm; padding-left:3mm"/>e </xsl:if>
		...
		<xsl:if test="$Classification != 1 and $Classification != 12 and $Classification != 30 and $Classification != 40 and $Classification != 51">
	  ...
	  <td class="styIRS4562TableCellB">
		...
		<xsl:if test="$Classification = 50 or $Classification = 51">
		  <xsl:attribute name="style">border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px;</xsl:attribute>
		</xsl:if>		
		<span class="styIRS4562TableCellPad"/>
	  </td>
	  ...
	  <td class="styIRS4562TableCellD" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
		...
		<xsl:if test="$Classification = 50">50 yrs.</xsl:if>
		<xsl:if test="$Classification = 51">50 yrs.</xsl:if>				
		<span class="styIRS4562TableCellPad"/>
	  </td>
	  <td class="styIRS4562TableCellE" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
		<xsl:if test="$Classification = 30 or $Classification = 40 or $Classification = 50 or $Classification = 51">MM</xsl:if>
		<span class="styIRS4562TableCellPad"/>
	  </td>
	  <td class="styIRS4562TableCellF" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
		<xsl:if test="$Classification = 25 or $Classification = 1 or $Classification = 12 or $Classification = 30 or $Classification = 40 or $Classification = 50 or $Classification = 51">S/L</xsl:if>
		<span class="styIRS4562TableCellPad"/>
	  </td>
		  ...
		  <body class="styBodyClass">
			<form name="IRS4562">
			  ...
			  <div class="styTBB" >
				...
				<div class="styFTBox" style="width:125mm;">
				  ...
				  <div class="styFBT" style=" font-size:7pt;">
					<img src="{$ImagePath}/4562_Bullet_Lg.gif" aria-label="Right Pointing arrow"/> Attach to your tax return. 
				  </div>
				  <div class="styFBT" style=" font-size:7pt;">
					<img src="{$ImagePath}/4562_Bullet_Lg.gif" aria-label="Right Pointing arrow"/>
			  ...
			  <div style="width:187mm; height:10mm">
				<div style="float:left;">
				  ...
				  <div class="styGenericDiv" style="height:4mm; padding-top:.5mm; padding-bottom:.5mm;">
					...
					<img src="{$ImagePath}/4562_Bullet_Lg.gif" aria-label="Right Pointing Arrow"/>
					<span style="width:1mm;"/>
					<input type="checkbox" aria-label="General Asset Account Election Indicator" class="styIRS4562Ckbox">
			  ...
			  <div class="styIRS4562Section" style="float:none; clear:both; border-top-width:1px; border-bottom-width:0px; font-weight:bold; padding-left:10mm; font-size:7pt">
				Section B&#151;Assets Placed in Service During 2025 Tax Year Using the General Depreciation System
				<xsl:call-template name="SetFormLinkInline">
				...
				<xsl:choose>
				  ...
				  <xsl:when test="count($IRS4562Data/GeneralDepreciationSystem/GDS50YearPropertyGrp)&gt;1">
					<xsl:call-template name="SetDynamicTableToggleButton">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/GeneralDepreciationSystem/GDS50YearPropertyGrp"/>
					  <xsl:with-param name="containerHeight" select="1"/>
					  <xsl:with-param name="containerID" select=" 'GDctn' "/>
					  <xsl:with-param name="imageID" select=" 'GDimg' "/>
					  <xsl:with-param name="buttonID" select=" 'GDbtn' "/>
				  ...
				  <thead class="styTableThead">
					<tr scope="col">
					  <th scope="col" class="styIRS4562TableCellA" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px; text-align:center">
					    <b>(a)</b><br/>Classification of property<br/>(see instructions)
					  </th>
					  <th scope="col" class="styIRS4562TableCellB" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px; text-align:center">
						<b>(b)</b><br/>Month and <br/>year placed in <br/>service
					  </th>
					  <th scope="col" class="styIRS4562TableCellC" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px; text-align:center">
					    <b>(c)</b><br/>Basis for depreciation<br/>(business/investment use<br/>only&#151;see instructions)
					  </th>
					  ...
					  <th scope="col" class="styIRS4562TableCellG" style="border-color:black; border-left-width:0px; border-right-width:0px; border-top-width:1px; border-bottom-width:0px; text-align:center">
						<b>(g)</b><br/>Depreciation deduction
					  </th>
					</tr>
				  </thead>
				  <tfoot/>
				  <tbody>
					...
					<xsl:choose>
 					  <xsl:when test="not(((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or 
					    ...
					    (count($IRS4562Data/GeneralDepreciationSystem/GDS50YearPropertyGrp) &gt; 1) or 					    
					...
					<xsl:if test="not(((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or                             
					  ...
					  (count($IRS4562Data/GeneralDepreciationSystem/GDSNonRsdntlRealProp) &gt; 1) or                            
					  (count($IRS4562Data/GeneralDepreciationSystem/GDSNonRsdntlRealPropSpecify) &gt; 1)) and $Print = $Separated)">
					  <xsl:for-each select="$IRS4562Data/GeneralDepreciationSystem/GDS50YearPropertyGrp">
						<tr>
						  <td class="styIRS4562TableCellA" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
						  ...
						  <td class="styIRS4562TableCellB" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:0px; border-bottom-width:0px;">
						    <xsl:call-template name="PopulateAmount">
					...
					<xsl:if test="(count($IRS4562Data/GeneralDepreciationSystem/GDS50YearPropertyGrp) &lt;1) or 
					  (((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or                             
					  (count($IRS4562Data/GeneralDepreciationSystem/GDS5YearProperty) &gt; 1) or                             
					  (count($IRS4562Data/GeneralDepreciationSystem/GDS7YearProperty) &gt; 1) or                            
					  (count($IRS4562Data/GeneralDepreciationSystem/GDS10YearProperty) &gt; 1) or                             
					  ...
					  (count($IRS4562Data/GeneralDepreciationSystem/GDSNonRsdntlRealPropSpecify) &gt; 1)) and $Print = $Separated)">
					  <xsl:call-template name="AddRowsPartIII">
						<xsl:with-param name="Classification" select="51"/>
					  </xsl:call-template>
					</xsl:if>
					<!-- i (Old H) Residential Rental Property  -->
					...
					<!-- j (Old i) Nonresidential real property  -->
						...
						<tr>
						  <xsl:if test="position()=1">
							<td class="styIRS4562TableCellA" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
							  ...
							  <span class="styLN" style="margin-left:3.25mm; font-weight:bold">j</span>							  
...
<!--&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Line 20 START &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
			  ...
			  <div class="styIRS4562Section" style="float:none; clear:both; border-top-width:1px; border-bottom-width:0px; font-weight:bold; padding-left:10mm; font-size:7pt">
				Section C&#151;Assets Placed in Service During 2025 Tax Year Using the Alternative Depreciation System 
						<xsl:call-template name="SetFormLinkInline">
				  ...
				  <tbody>
					...
					<xsl:choose>
					  <xsl:when test="not( ( (count($IRS4562Data/AlternativeDepreciationSystem/ADSClassLifeProperty) +
						count($IRS4562Data/AlternativeDepreciationSystem/ADS12YearProperty) +
						count($IRS4562Data/AlternativeDepreciationSystem/ADS40YearProperty) +
						count($IRS4562Data/AlternativeDepreciationSystem/ADS50YearProperty)) &gt; 3) and ($Print = $Separated))">						
						...
						<!--  BEGIN 20e 50-YEAR  -->
						<xsl:for-each select="$IRS4562Data/AlternativeDepreciationSystem/ADS50YearProperty">
						  <tr>
							<td class="styIRS4562TableCellA" style="border-color:black; border-left-width:0px; border-right-width:1px; border-top-width:1px; border-bottom-width:0px">
							  <span class="styLN" style="margin-left:3.25mm;font-weight:bold;">e</span>
							  50-year
						...
						<xsl:if test="count($IRS4562Data/AlternativeDepreciationSystem/ADS40YearProperty) &lt;1">
						  <xsl:call-template name="AddRowsPartIII">
							<xsl:with-param name="Classification" select="50"/>
						  </xsl:call-template>
						</xsl:if>
					  </xsl:when>
					  <xsl:otherwise>
					   <!-- BEGIN Blank 20a Class Life --> 
						...
						<!-- BEGIN Blank 20e 50-Year -->
						<tr>
						  <td class="styIRS4562TableCellA" style="border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 1px; border-bottom-width:0px;">
							<span class="styLN" style="font-weight: bold;">
							  <span style="width=3.5mm;padding-left:3mm;"/>e
							  <span style="width: 3px"/>
							</span>
						    50-year
						    <span class="styIRS4562TableCellPad"/>
...
<!--&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Line 20 END &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
				...
				<div style="width:187mm; border-color:black; border-style:solid; border-right-width:0px; border-left-width:0px; border-top-width:2px; border-bottom-width:0px">
				  <div style="float:left; clear:none;">
					...
					Form <span class="styBoldText" style="font-size:8pt">4562</span> (2025)
				  </div>
				</div>
				...
				<div class="styBB" style="width:187mm;">
				  <div style="float:left; clear:none;">Form 4562 (2025)</div>
				  <div style="float:right;">
			  ...
			  <div class="styIRS4562LineItem" style="float:none; clear:all;">
			    <div class="styLNLeftNumBox" style="height:10mm; width:5mm;">23a</div>
				  <span class="styIRS4562LNDesc" style="width:109mm; padding-left:2mm;">
				  ...
				  <span class="styLNRightNumBox" style="padding-top:4mm; border-top-width:1px; border-bottom-width:0px; height:10.5mm">23a</span>
				  <div class="styIRS4562LNAmountBox" style="border-top-width:1px; border-bottom-width:0px; height:10.5mm; padding-top:4mm; width:24mm; font-size:7pt;">
					<xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/CapSect263AfIntCostsAstAmt"/>
					</xsl:call-template>
				  </div>
				  <div class="styLNAmountBox" style="background-color:lightgrey; border-bottom-width:0px; border-top:1px solid black; height:10.5mm; width:40mm;"/>
			    <div class="styLNLeftNumBox" style="height:13.1mm; width:5mm;padding-left:4.5mm;">b</div>
				  <span class="styIRS4562LNDesc" style="width:109mm; padding-left:2mm;">
				  ...
				  <span class="styLNRightNumBox" style="padding-top:4mm; border-top-width:1px; border-bottom-width:0px; height:13.1mm">23b</span>
				  <div class="styIRS4562LNAmountBox" style="border-top-width:1px; border-bottom-width:0px; height:13.1mm; padding-top:4mm; width:24mm; font-size:7pt;">
					<xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/AllOthCapSect263ACostsAstAmt"/>
					</xsl:call-template>
				  </div>
				  <div class="styLNAmountBox" style="background-color:lightgrey; border-bottom-width:0px; border-top:0px; height:13.1mm; width:40mm;"/>
				</div>
				<!--   END LINE 23   -->
				...
				<span class="styIRS4562LNDesc" style="width:187mm;">
				  <b>24a&#160;</b>
				...
				<span>
				  ...
				  <input type="checkbox" aria-label="Have Evidence To Support the business or investment Yes" class="styIRS4562Ckbox">
				...
				<span>
				  ...
				  <span style="width:5mm"/>				  
				  <input type="checkbox"  aria-label="Have Evidence To Support the business or investment No" class="styIRS4562Ckbox">
			  ...
			  <span class="styIRS4562LNDesc" style="width:187mm;padding-left:3.1mm;">
				  <b>b&#160;</b>
				  <span style="font-family:arial;"> If "Yes," is the evidence written?</span>				  
				<span class="styDotLn" style="float:none; padding-right:0.7mm;">...........................</span>
			    <span>
					<xsl:call-template name="PopulateSpan">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/EvidenceWrittenInd"/>
					</xsl:call-template>

				<input type="checkbox" aria-label="Is Evidence Written Indicator Yes" class="styIRS4562Ckbox">
				  <xsl:call-template name="PopulateYesCheckbox">
					<xsl:with-param name="TargetNode" select="$IRS4562Data/EvidenceWrittenInd"/>
				...
				<span>
				  ...
				  <span style="width:5mm"/>
				  <input type="checkbox" aria-label="Is Evidence Written Indicator No" class="styIRS4562Ckbox">
					<xsl:call-template name="PopulateNoCheckbox">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/EvidenceWrittenInd"/>
				...
				<span style="padding_left:0.0mm;font-size:6pt">
				  <b>
				  <label>
					<xsl:call-template name="PopulateLabelNo">
					  <xsl:with-param name="TargetNode" select="$IRS4562Data/EvidenceWrittenInd"/>
			  ...
			  <!--	</div>-->
			  <!--   END LINE 24a   -->
				<!--   BEGIN LINE 24c of section a Part V -->
				<span class="styIRS4562LNDesc" style="width:187mm;padding-left:3.1mm;">
				  <b>c&#160;</b>
				  <span style="font-family:arial;"> Do you own, lease, or charter an aircraft? Check all that apply. See instructions.</span>
				  ...
				  <span style="width:15px;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;margin-bottom:1.5mm;">
									<xsl:call-template name="PopulateEnumeratedCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS4562Data/OwnInd"/>
										<xsl:with-param name="DisplayedCheckboxValue" select="1"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[1]</xsl:with-param>
									</xsl:call-template>
								</input>
								<span style="font-size:6pt">
								<b>
								<label>
									<xsl:call-template name="PopulateLabel">
										...
										<xsl:with-param name="DisplayedCheckboxValue" select="1"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[1]</xsl:with-param>
									</xsl:call-template>Own</label>
								</b>
								</span>									
								<span style="width:4.7mm;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;margin-bottom:1.5mm;">
									<xsl:call-template name="PopulateEnumeratedCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS4562Data/LeaseInd"/>
										<xsl:with-param name="DisplayedCheckboxValue" select="2"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[2]</xsl:with-param>
									</xsl:call-template>
								</input>
								<span style="font-size:6pt">
								<b>								
								<label>
									<xsl:call-template name="PopulateLabel">
										...
										<xsl:with-param name="DisplayedCheckboxValue" select="2"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[2]</xsl:with-param>
									</xsl:call-template>Lease</label>
								</b>
								</span>									
								<span style="width:3mm;"/>	
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;margin-bottom:1.5mm;">
									<xsl:call-template name="PopulateEnumeratedCheckbox">
										<xsl:with-param name="TargetNode" select="$IRS4562Data/CharterInd"/>
										<xsl:with-param name="DisplayedCheckboxValue" select="3"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[3]</xsl:with-param>
									</xsl:call-template>
								</input>
								<span style="font-size:6pt;width:4.7mm;">
								<b>	
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$IRS4562Data/CharterInd"/>
										<xsl:with-param name="DisplayedCheckboxValue" select="3"/>
										<xsl:with-param name="BackupName">IRS4562OwnLeaseCharterCd[3]</xsl:with-param>
									</xsl:call-template>Charter</label>
								</b>
								</span>									
								<span style="width:3mm;"/>																	
			  </span>
         ...
         <xsl:call-template name="PopulateText">
					...
					<div class="styIRS4562LineItem" style="float:none; width:187mm; border: 0px;">
						...
						<span style="float:right; clear:none;">						
							...
							<div class="styIRS4562LNAmountBox" style="width:21.8mm;border-top:0; padding-right:1mm; font-size:6.3pt; height:4mm;">
								<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS4562Data/TotalListedDepreciationAmt"/>
								</xsl:call-template>
							</div>
							<div class="styIRS4562LNAmountBox" style="width:22mm; border-bottom-width:1px; height:4mm; background-color:lightgray;"/>
						</span>
					</div>
					<!--   END LINE 28  -->
					<!--   BEGIN LINE 29   -->
				...
				<div class="styLNLeftNumBox" style="height:4mm; width:6mm;">29</div>
						<span class="styIRS4562LNDesc" style="width:150mm;">
						<span style="float:left;">
						...
						<div class="styIRS4562LNAmountBox" style="width:20mm; border-bottom:0px; border-top:0px;font-size:6.3pt;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS4562Data/TotalSection179ExpenseAmt"/>
							</xsl:call-template>
						</div>
								...
								<td width="14mm">
									<table cellspacing="0" cellpadding="0" border="0" width="14mm">
										...
										<tbody>
											<tr>
												<td>
												<div class="styIRS4562LNAmountBox" style="width:22mm; background-color:lightgrey; border-left:1px solid black; border-top-width:1px; border-bottom-width:0px; height:5mm;"/>
												</td>
												<!--  No box  -->
											</tr>
										</tbody>
							...
							<tbody>
								<tr>
									<td class="styIRS4562OtherCell" style="border-color:black; border-left-width:0px; border-right-width:0px; border-top-width:0px; border-bottom-width:1px; " colspan="6">
										...
										<span class="styLNDesc" style="padding-left:2mm;"> Amortization of costs that begins during your 2025 tax year (see instructions):</span>
										<span class="styIRS4562TableCellPad"/>
									</td>
								</tr>
					...
					<div style="width:187mm; clear:both;">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">4562</span> (2025)</div>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<p style="page-break-before:always"/>
          ...
          Additional Data        
					...
					<xsl:if test="(((count($IRS4562Data/GeneralDepreciationSystem/GDS3YearProperty) &gt; 1) or                             (count($IRS4562Data/GeneralDepreciationSystem/GDS5YearProperty) &gt; 1) or                             (count($IRS4562Data/GeneralDepreciationSystem/GDS7YearProperty) &gt; 1) or                            (count($IRS4562Data/GeneralDepreciationSystem/GDS10YearProperty) &gt; 1) or                             (count($IRS4562Data/GeneralDepreciationSystem/GDS15YearProperty) &gt; 1) or                             (count($IRS4562Data/GeneralDepreciationSystem/GDS20YearProperty) &gt; 1) or                            (count($IRS4562Data/GeneralDepreciationSystem/GDS25YearProperty) &gt; 1) or                             (count($IRS4562Data/GeneralDepreciationSystem/GDSResidentialRentalProperty) &gt; 2) or                            (count($IRS4562Data/GeneralDepreciationSystem/GDSNonResidentialRealProperty) &gt; 1) or                            (count($IRS4562Data/GeneralDepreciationSystem/GDSNonRsdntlRealProp) &gt; 1) or                            (count($IRS4562Data/GeneralDepreciationSystem/GDSNonRsdntlRealPropSpecify) &gt; 1)) and $Print = $Separated)">
						<span style="height:2mm;"/>	
						<span class="styRepeatingDataTitle">Form 4562, Part III, Line 19, Section B&#151;Assets Placed in Service During 2023 Tax Year Using the General Depreciation System:</span>
					...
					<xsl:if test="((count($IRS4562Data/AlternativeDepreciationSystem/ADSClassLifeProperty) &gt; 1) or                            		
					  ...
					  <span class="styRepeatingDataTitle">
					    Form 4562, Part III, Line 20, Section C&#151;Assets Placed in Service During 2023 Tax Year Using the Alternative Depreciation System:
					  </span>
					  ...
					  <table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
						...
						<!--  50-year Part III, line 20e   -->
						<xsl:for-each select="$IRS4562Data/AlternativeDepreciationSystem/ADS50YearProperty">
						  <tr>
							<xsl:choose>
							  <xsl:when test="(count($IRS4562Data/AlternativeDepreciationSystem/ADSClassLifeProperty) +                                         count($IRS4562Data/AlternativeDepreciationSystem/ADS12YearProperty + ADS40YearProperty)) mod 2 = 1">
							    <!-- Define background colors to the rows -->
							    <xsl:attribute name="class">
								  <xsl:choose>
								    <xsl:when test="position() mod 2 = 1">styDepTblRow2</xsl:when>
				  ...
				  <!-- Repeating vertical table for Part V, Line 26 -->
					...
					<xsl:if test="(count($IRS4562Data/AmortizationInfo/AmortizationInfoTable) &gt; 2) and ($Print = $Separated)">
						<br/>
						<span class="styRepeatingDataTitle">Form 4562, Part VI, Line 42, Amortization of costs that begins during your 2023 tax year (see instructions):</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr scope="col" class="styDepTblHdr">
