...
<!-- 11/13/2023 - Changes made for defect 1252949 - Jeremy Nichols -->
<!-- 01/10/2024 - Changes made for IRWorks TESTINC0009270 - Jeremy Nichols -->
<!-- 02/29/2024 - defect 1386675 - Jeremy Nichols -->
<!-- 03/11/2024 - IRWorks TESTINC0004971 - Jeremy Nichols -->
<!-- 03/11/2024 - IRWorks TESTINC0006808 - Jeremy Nichols -->
<!-- 07/29/2025 - UWR 1003202 - Jeremy Nichols -->
<!-- 08/27/2025 - 2025 pdf review - Jeremy Nichols -->
				...
				<form name="Form1118">
					...
					<div class="styTBB" style="width:256mm;height:22mm;border-bottom-width:1px;">
						...
						<div class="styFTBox" style="width:178mm;height:22mm;">
							...
							<br/>
							<div class="styFBT" style="height:4mm;font-weight:bold;">
								Go to <i>www.irs.gov/Form1118</i> for instructions and the latest information.
							</div>
							<br/>
					...
					<div class="styBB" style="width:256mm;padding-bottom:1.5mm;">
						...
						<div style="text-align:right;padding-right:1mm;display:inline;">
							...
							<span style="width:25mm;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1118Data/Sect951AOrPassiveCatIncomeCd"/>
								</xsl:call-template>
							</span>
						</div>
						<br/>
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:70mm;height:22mm;" rowspan="3" scope="col">1(a). <span class="styNormalText" style="display:inline;">EIN or Reference ID number (see instructions)</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;height:22mm;" rowspan="3" scope="col">1(b). <span class="styNormalText" style="display:inline;">Code*</span>
									</th>
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;height:22mm;" rowspan="3" scope="col">2. <span class="styNormalText" style="display:inline;">Foreign Country or U.S. Territory (enter two-letter code-use a separate line for each)(see instructions)</span>
									</th>
					...
					<div style="width:256mm;height:7mm;padding-top:0.5mm;border-top:0px solid black;">
						* For section 863(b) income, NOLs, income from RICs, high-taxed income, section 951A, and reattribution of income by reason of disregarded payments, and enter the applicable
code in column l (b) (see instructions).  Also, for reporting branches that are QBUs, use a separate line for each such branch.
					</div>
					<!--BEGIN FOOTER-->
					<div style="width:256mm;padding-top:0.5mm;border-top:1px solid black;">
						...
						<div style="float:right">
						  ...
						  Form <b style="font-size:8pt;">1118</b> (Rev. 12-2025)
						</div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="display:block;">
						<div class="styBB" style="width:256mm">
							<div style="float: left; clear: none">Form 1118 (Rev. 12-2025)</div>
							<div style="float:right">
							...
							<table class="styLandscapeTable" cellspacing="0" style="width:256mm;height: auto">
								<thead class="styTableThead">
									<tr>
										...
										<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:193mm;height:7mm;" colspan="7">2. <span class="styNormalText" style="display:inline;">Foreign Country or U.S. Posseession (enter two-letter code--use a separate line for each) (see instructions)</span>
										</th>
									</tr>
									<tr>
										<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:114mm;height:7mm;" colspan="7">
									...
									<tr>
										...
										<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:19mm;height:7mm;">(b)(1) <span class="styNormalText" style="display:inline;">Distributions of Previously Taxed Earnings and Profits</span>
										</th>
										<th class="styIRS1118TableCellHeaderSmall" scope="col" style="width:19mm;height:7mm;">(b)(2) <span class="styNormalText" style="display:inline;">PTEP Group (see instructions)</span>
										</th>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">Total foreign taxes paid or accrued (total from Part I, column 2(j))
						    <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:16px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">1a</div>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">Foreign taxes paid or accrued by the corporation during prior tax years that were suspended due to the rules of section 909 and for which the related income is taken into account by the corporation during the current tax year (see instructions)
						    <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
							...
							<div class="styLNDescLandscape" style="width:4mm;height:7.5mm;text-align:center;padding-top:4mm;border-bottom:1px solid black;border-left:1px solid black;">1b</div>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">Total taxes deemed paid (total from Part I, column 3)
							  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:12px"/>.
									<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">2</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1118ScheduleB/TotalTaxesDeemedPaidAmt"/>
								</xsl:call-template>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">3</div>
							<div class="styLNAmountBox">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">4</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm;">Enter the sum of any carryover of foreign taxes (from Schedule K, line 3, column (xiv) and from Schedule I, Part III, line 3) plus any carrybacks to the current tax year
							  <!-- Form to Form links -->
								<xsl:call-template name="SetFormLinkInline">
							...
							<div class="styLNDescLandscape" style="width:4mm;height:8mm;padding-top:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">5</div>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Total foreign taxes (combine lines 1a through 5)
							<!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:16px"/>.
									<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">6</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Enter the amount from the applicable column of Schedule J, Part I, line 11 (see instructions). If Schedule J is <b>not</b> required
							...
							<div class="styLNDescLandscape" style="width:4mm;height:8mm;padding-top:4mm;text-align:center;border-left:1px solid black;">7</div>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">Total taxable income from all sources (enter
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-top:1px solid black;border-bottom:1px solid black;border-left:1px solid black;">8a</div>
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:180mm">Adjustments to line 8a (see instructions)
							  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:16px"/>.
									<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">8b</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Subtract line 8b from line 8a
							  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:16px"/>.
									<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">8c</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Divide line 7 by line 8c. Enter the resulting fraction as a decimal (see instructions). If line 7 is greater than line 8c, enter 1
							  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">.
								<span style="width:16px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">9</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateText">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Total U.S. income tax against which credit is allowed (regular tax
						  ...
						  <!--Dotted Line-->
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">10</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">Multiply line 9 by line 10
							<!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:14px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">11</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">  Increase in limitation (section 960(c)) 
						  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">
									<span style="width:16px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">12</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;"> Credit limitation (add lines 11 and 12) (see instructions) 
						  <!--Dotted Line-->
								<span class="styNoAudioRead" style="font-weight:bold;">.
								<span style="width:16px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">13</div>
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
						...
						<div class="styBB" style="width:256mm;">
							...
							<div class="styLNDescLandscape" style="width:212mm;">
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-left:1px solid black;">14</div>
						...
						<div style="display:block;">
						  ...
						  <span class="styItalicText" style="font-weight:normal">(continued) (Report all foreign tax amounts in U.S. dollars.)</span>
							...
							<div style="width:256mm;">
								...
								<div class="styLNDescLandscape" style="width:180mm">Credit for taxes on section 951A category income
							<!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
								<span style="width:16px"/>.
							...
							<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">1</div>
							<div class="styLNAmountBox">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:256mm;">
								<div class="styLNLeftNumBoxSD">2</div>
								<div class="styLNDescLandscape" style="width:180mm">Credit for taxes on foreign branch category income
							<!--Dotted Line-->
									<span class="styBoldText">
							...
							<div style="width:256mm;">
								<div class="styLNLeftNumBoxSD">3</div>
								<div class="styLNDescLandscape" style="width:180mm">Credit for taxes on passive category income
							<!--Dotted Line-->
									<span class="styBoldText">
							...
							<div style="width:256mm;">
								<div class="styLNLeftNumBoxSD">4</div>
								<div class="styLNDescLandscape" style="width:180mm">Credit for taxes on general category income
								  <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:19px"/>.
										<span style="width:16px"/>.
							...
							<div style="width:256mm;">
								<div class="styLNLeftNumBoxSD">5</div>
								<div class="styLNDescLandscape" style="width:180mm">Credit for taxes on section 901(j) category income (combine all such credits on this line)
									<!--Dotted Line-->
									<span class="styBoldText">
								...
								<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">5</div>
								<div class="styLNAmountBox">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:256mm;">
								<div class="styLNLeftNumBoxSD">7</div>
								<div class="styLNDescLandscape" style="width:212mm;">Total (add lines 1 through 6)
								  <!--Dotted Line-->
									<span class="styBoldText">
										<span style="width:16px"/>.
										<span style="width:16px"/>.
								...
								<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">7</div>
								<div class="styLNAmountBox">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:256mm;">
								...
								<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">8</div>
								<div class="styLNAmountBox">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1118ScheduleB/SummaryOfSeparateCredits/SmllrTotUSIncmTxOrRltdTxAdjAmt"/>
									</xsl:call-template>
								</div>
							</div>
							<div style="width:256mm;">
							...
							<div class="styBB" style="width:256mm;">
								...
								<div class="styLNDescLandscape" style="width:212mm;">
								  ...
								  (subtract line 9 from line 8). Enter here and on the appropriate line of 
								...
								<div class="styLNDescLandscape" style="width:4mm;text-align:center;border-left:1px solid black;">10</div>
								<div class="styLNAmountBoxNBB">
									<xsl:call-template name="PopulateAmount">
									...
									<xsl:if test="(count($Form1118ScheduleC/Section951a1InclusionsCorpGrp) &lt; 7) or ((count($Form1118ScheduleC/Section951a1InclusionsCorpGrp) &gt; 6) and ($Print != $Separated))">
										<xsl:for-each select="$Form1118ScheduleC/Section951a1InclusionsCorpGrp">
											<tr style="height:6mm;">
												...
												<td class="styIRS1118TableCellSmallArial" style="text-align:center;">
													<xsl:if test="(TestedUnitReferenceIdNum)">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="TestedUnitReferenceIdNum"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:if test="(QBUReferenceIdNum)">
														<xsl:call-template name="PopulateText">
					...
					<div style="display:block;">
						...
						<div class="styBB" style="width:256mm;height:9mm;">
							...
							<div class="styIRS1118TitleDesc">Taxes Paid, Accrued, or Deemed Paid With Respect to Previously Taxed Earnings and Profits (PTEP) by Domestic Corporation Filing the Return (Sections
901 and 960(b))
						</div>
						</div>
						<!-- BEGIN SCHEDULE E -->
...
each line in Schedule E, Part I, include the column 14 amount in column 2(b)(1) of the line in Schedule B, Part I, that corresponds with the identifying number specified in column 1 of Schedule A and that also corresponds with the identifying number specified in column 1b of this Schedule E, Part I. Also include the column 15 and 16 amounts in lines F and H of Schedule G, respectively (see instructions).<span style="width:28mm;"/>
							...
							<table class="styTable" cellspacing="0" style="bordder-bottom-width:0px;">
								<thead class="styTableThead">
									<tr>
										...
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">11. <span class="styNormalText" style="display:inline;">Foreign income taxes properly attributable to PTEP Under Section 960(b)(1) and not previously deemed paid (multiply column 8 by column 10)(see instructions)</span>
										</th>
									</tr>
								</thead>
								<tfoot/>
								<tbody>
									...
									<!-- End of filler rows -->
									<tr style="height:6mm;">
										<td class="styIRS1118TableCellSmallArial" style="text-align:left;font-size:7pt;border-bottom-width:1px;border-right-width:0px;" colspan="5">
										</td>
									</tr>
								</tbody>
							</table>
						...
						<div class="styTableContainerLandscape" id="3TUEctnB" style="width:260mm;border-bottom-width:0px;">
							...
							<table class="styTable" cellspacing="0" style="bordder-bottom-width:0px;">
								<thead class="styTableThead">
									<tr>
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">12. <span class="styNormalText" style="display:inline;">Amount Disallowed under section 965(g) with respect to taxes deemed paid under section 960(b)(1)</span>
										</th>
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">13. <span class="styNormalText" style="display:inline;">Amount Disallowed
under Section 960(d)(4) with respect to taxes deemed paid under section 960(b)(1)</span>
										</th>
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">14. <span class="styNormalText" style="display:inline;">Section 901 Taxes Paid or Accrued (see instructions)</span>
										</th>
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">15. <span class="styNormalText" style="display:inline;">Amount Disallowed under Section 965(g) with respect to taxes paid or accrued under section 901</span>
										</th>
										<th class="styIRS1118TableCellHeaderSmall" style="width:52mm;" scope="col">16. <span class="styNormalText" style="display:inline;">Amount Disallowed under Section 960(d)(4) with respect to taxes paid or accrued under section 901</span>
										</th>
									</tr>
								</thead>
								<tfoot/>
								<tbody>
									...
									<tr style="height:6mm;">
										<td class="styIRS1118TableCellSmallArial" style="text-align:left;font-size:7pt;bordder-bottom-width:0px;" colspan="4">
											<b>Total</b> (add amounts in each of columns 11 through 16).
												<!--Dotted Line-->
											<span>
												<span style="width:10px"/>.
													  <span style="width:10px"/>.
					...
					<div style="display:block;">
						...
						<div class="styBB" style="width:256mm;height:9mm;">
							<div class="styTitleName">Schedule E</div>
							<div class="styIRS1118TitleDesc">
								Taxes Paid, Accrued, or Deemed Paid With Respect to Previously Taxed Earnings and Profits (PTEP) by Domestic Corporation Filing the Return (Sections 901 and 960(b))<span style="font-weight:normal;font style:italic">(continued)</span>
							</div>
						</div>
						...
						<table class="styTable" cellspacing="0" style="width:256mm;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:35mm;" scope="col">14. <span class="styNormalText" style="display:inline;">Foreign income taxes properly attributable to PTEP Under Section 960(b)(2) and not previously deemed paid (multiply column 11 by column 13)</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
						...
						<div class="styBB" style="width:256mm;clear:both;border-left-width:0px;border-bottom-width:0px;">
							<div class="styIRS1118ScheduleCell" style="width:256;border-left-width:1px;border-right-width:0px;border-left-width:0px;border-bottom-width:0px;">
								...
								<div style="width:256mm;float:left;clear:none;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:8mm;padding-top:2mm;">
									...
									<div class="styIRS1118LNLeftNumBoxB" style="height:8mm;text-align:center;padding-top:2mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">A</div>
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Reduction of Foreign Oil and Gas Taxes—Enter
									amount from Schedule I, Part II, line 4<span style="width:3mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">................... </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:1mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">B</div>
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:8mm;">Reduction of Taxes Due to International Boycott Provisions—Enter appropriate portion from Schedule C (Form 5713) (see instructions). <span class="styBoldText">Important:</span> Enter only "specifically attributable taxes" here.<span style="width:2mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">................................ </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:8mm;text-align:center;padding-top:2mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">C</div>
									<div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
										<xsl:call-template name="PopulateAmount">
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">
								  ...
								  <xsl:call-template name="SetFormLinkInline">
									...
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:1mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">D</div>
									<div class="styLNAmountBox" style="height:5mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleG/Sect6038cPnltyTxReductionAmt"/>
										</xsl:call-template>
								...
								<xsl:choose>
									<xsl:when test="count($Form1118ScheduleG/TaxesSuspendedUnderSect909Amt) &lt; 1">
										<div style="width:256mm;">
											...
											<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Taxes suspended under section 909
											<xsl:call-template name="SetFormLinkInline">
											...
											<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:1mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">E</div>
											<div class="styLNAmountBox" style="height:5mm;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleG/TaxesSuspendedUnderSect909Amt"/>
												</xsl:call-template>
									...
									<xsl:otherwise>
										<xsl:for-each select="$Form1118ScheduleG/TaxesSuspendedUnderSect909Amt">
											...
											<div style="width:256mm;">
												<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:0.5mm;float:left;clear:none;border-left-width:0px;">E</div>
												<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Taxes suspended under section 909
												<xsl:call-template name="SetFormLinkInline">
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Reduction for disallowed taxes under section 965(g)<span style="width:1.5mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............................ </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:1mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">F</div>
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Reduction for disallowed taxes under section 245A<span style="width:3.25mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">............................ </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;padding-top:1mm;float:left;clear:none;border-left-width:1px;border-right-width:0px;">G</div>
									<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
										<xsl:call-template name="PopulateAmount">
								...
								<div style="width:256mm;">
									...
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Reduction for disallowed taxes under section 960(d)(4)<span style="width:1mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">........................... </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;float:left;clear:none;padding-top:0.5mm;border-left-width: 1px;border-right-width: 0px;">H</div>
									<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
										<xsl:call-template name="PopulateAmount">
								...
								<div style="width:256mm;">
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;float:left;clear:none;padding-top:0.5mm;border-left-width: 0px">I</div>
									<div class="styIRS1118LNDescRed" style="width:208mm;height:5mm;">Other reductions in taxes (attach schedule—see instructions)<span style="width:1mm;"/>
										<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.......................... </span>
									</div>
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;text-align:center;float:left;clear:none;padding-top:0.5mm;border-left-width: 1px;border-right-width: 0px;">I</div>
									<div class="styLNAmountBox" style="height:5mm;padding-top:1mm;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form1118ScheduleG/OtherTaxReductionsAmt"/>
										</xsl:call-template>
								...
								<div style="width:256mm;height:5.2mm;float:left;clear:none;border-bottom:0pt;border-top:1pt solid black;border-left:0pt solid black;padding-left:1mm;">
									<div class="styIRS1118LNLeftNumBoxB" style="height:5mm;padding-top:1.5mm;border-left-width:0px;border-bottom-width:0px;text-align:center;float:left;clear:none;;">K</div>
						...
						<div style="width:256mm;border-top:1pt solid black;">
							<div style="float:right;clear:none;">
								<div style="width:100mm;">
								 ...
								 Form <b style="font-size:8pt;">1118</b> (Rev. 12-2025)</div>
							</div>
						</div>
						<div class="pageEnd"/>
						<!--END FOOTER-->
					...
					<div style="width:256mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2025)</div>
						</div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
          ...
          <!-- The xsl:choose code block below enables this stylesheet to display data from more than one schema version -->
						...
						<div style="height:auto;width:256mm;display:block;">
							<table class="styTable" style="height:auto;width:256mm;" cellspacing="0">
									...
									<tr>
										<td colspan="2" rowspan="2" scope="rowgroup" style="width:35mm;">
											<span style="width:1px;"/>
										</td>
										<td colspan="2" scope="colgroup" style="width:50mm;text-align:left;float:none;border-bottom:1px solid black;border-left:1px solid black;">
											<span style="width:16px"/>
										...
										<td colspan="2" scope="colgroup" style="width:56mm;text-align:center;float:none;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(b)</span>
											Interest Deductions
										</td>
										<td rowspan="2" scope="rowgroup" style="width:28mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:0px solid black;">
											<span class="styBoldText">(c)</span>
											Stewardship Deductions
										</td>
										<td rowspan="2" scope="rowgroup" style="width:28mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:0px solid black;">
											<span class="styBoldText">(d)</span>
											Certain Industrial/<br/>Investor Damages (see instructions)
										</td>
										<td rowspan="2" scope="rowgroup" style="width:28mm;text-align:center;border-left:1px solid black;">
										...
										<td rowspan="5" scope="rowgroup" style="width:30mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:1px solid black;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescRD" style="height:8mm;vertical-align:bottom;padding-bottom:1mm;border-bottom:0px solid black;">Enter Code
											<span style="width:20mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp/Section901jIncomeCd"/>
												</xsl:call-template>
												<span style="width:1mm;"/>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp/SanctionedCountryCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td class="styShadingCellSmall" style="height:8mm;width:25mm;padding-top:4mm;float:none;border-left-width:1px;border-right-width:0px;border-bottom-width:1px;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescDed" style="height:7mm;vertical-align:top;padding-top:1mm;" cellpadding="0" cellspacing="0" colspan="8">
											<div style="width:215mm;border-right:1px solid black;">
											Expenses Allocated and Apportioned to Section 245A Dividends.  
											...
											3d(1), 3e(1), and 3f(1). Include this line 4 result as a negative amount on Schedule B, Part II, line 8b
												...
												<div style="padding-left:1mm;">4</div>
											</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:7mm;padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
					...
					<div style="display:block;">
						...
						<div style="height:auto;width:256mm;">
							<table class="styLandscapeTable" style="height:auto;width:256mm;font-size:6pt;" cellspacing="0">
								<thead class="styTableThead">
									<tr>
										<td colspan="2" scope="col" style="width:62mm;border-bottom:1px solid black;;">
											<span style="width:61mm;"/>
										</td>
								...
								<tbody>
									<tr>
										<td scope="col" style="width:10mm;padding-top:1mm;text-align:center;vertical-align:top;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/Total951AIncmSect245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/TotalSect951AOtherCatIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/TotalFrgnBrIncmSect245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/TotalFrgnBrOtherCatIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/TotalPssvIncmSect245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/TotalPassiveOtherCatIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/TotalGenIncmSect245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/TotalGeneralOtherCatIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											...
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp/Section901jIncomeCd"/>
												</xsl:call-template>
												<span style="width:1mm;"/>
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp/SanctionedCountryCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:for-each select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/Section245ADividendAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:for-each select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ResourcedByTreatyIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="ResourcedByTreatyIncomeGrp/OtherCategoryIncomeAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
										</td>
									</tr>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/TotalUSSourceSect245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;vertical-align:bottom;padding-top:2.5mm;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnDedExpnssApprtn245ADivAmt"/>
											</xsl:call-template>
										</td>
