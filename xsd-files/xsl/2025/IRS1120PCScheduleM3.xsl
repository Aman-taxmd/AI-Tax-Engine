	  ...
	  <body class="styBodyClass" style="width:187mm">
        <form name="Form1120PCScheduleM3">
          ...
          <div style="width:187mm;">
            ...
            <input type="checkbox" aria-label="Non-consolidated Return Indicator" class="styCkbox">
            ...
            <span style="width:5px;"/>
            <input type="checkbox" aria-label="Consolidated Return Indicator for Form 1120-PC only" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <span style="width:5px;"/>
            <input type="checkbox"  aria-label="Mixed 1120/L/PC Group Ind" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
            ...
            <input type="checkbox" aria-label="Dormant Subsidiaries Schedule Attached Indicator" class="styCkbox">
              <xsl:call-template name="PopulateCheckbox">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpFiledSECForm10KIndicatorYes" class="styCkbox">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpFiledSECForm10KIndicatorNo" class="styCkbox">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpPrepCertAuditedIncomeStmtIndicatorYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpPrepCertAuditedIncomeStmtIndicatorNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpPrepIncomeStatementIndicatorYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationPreparedIncmStmtInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpPrepIncomeStatementIndicatorNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationPreparedIncmStmtInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpIncomeStatementRestatedIndicatorYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationIncmStmtRestatedInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpIncomeStatementRestatedIndicatorNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationIncmStmtRestatedInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox"  aria-label="CorpIncmStmtRestated5PrecedingIndicatorYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorpIncmStmtRestated5PrecInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpIncmStmtRestated5PrecedingIndicatorNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorpIncmStmtRestated5PrecInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpVotingCommonStockPubTradedIndicatorYes" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationVtngComStkPubTrdInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" aria-label="CorpVotingCommonStockPubTradedIndicatorNo" class="styCkbox">
                  <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/CorporationVtngComStkPubTrdInd"/>
          ...
          <div style="width:187mm;font-size:6pt;">
            <div class="styGenericDiv">
              ...
              <!-- Check box 1 -->
              <b>(1)</b>
              <input type="checkbox" aria-label="Page 2 Consolidated Group Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ConsolidatedGroupInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedGroupIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ConsolidatedGroupInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedGroupLabelP2</xsl:with-param>
                </xsl:call-template>
		        Consolidated group
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 2 -->
              <b>(2)</b>
              <input type="checkbox" aria-label="Page 2 Parent Corporation Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ParentCorporationInd"/>
                  <xsl:with-param name="BackupName">ParentCorporationIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ParentCorporationInd"/>
                  <xsl:with-param name="BackupName">ParentCorporationLabelP2</xsl:with-param>
                </xsl:call-template>
		        Parent corp
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check  box 3 -->
              <b>(3)</b>
              <input type="checkbox" aria-label="Page 2 Consolidated Eliminations Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ConsolidatedEliminationsInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedEliminationsIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/ConsolidatedEliminationsInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedEliminationsLabelP2</xsl:with-param>
                </xsl:call-template>
            ...
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 4 -->
              <b>(4)</b>
              <input type="checkbox" aria-label="Page 2 Subsidiary Corporation Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/SubsidiaryCorporationInd"/>
                  <xsl:with-param name="BackupName">SubsidiaryCorporationIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/SubsidiaryCorporationInd"/>
                  <xsl:with-param name="BackupName">SubsidiaryCorporationLabelP2</xsl:with-param>
                </xsl:call-template>
		        Subsidiary corp
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 5 -->
              <b>(5)</b>
              <input type="checkbox" aria-label="Page 2 Mixed 1120/L/PC Group Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Mixed1120LPCGroupInd"/>
                  <xsl:with-param name="BackupName">Mixed1120LPCGroupIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Mixed1120LPCGroupInd"/>
                  <xsl:with-param name="BackupName">Mixed1120LPCGrouplabelP2</xsl:with-param>
                </xsl:call-template>
		        Mixed 1120/L/PC group
		      </label>
            </div>
          ...
          <div style="width:187mm;font-size:6pt;">
            <div class="styGenericDiv">
              ...
              <!-- Check box 6 -->
              <b>(6)</b>
              <input type="checkbox" aria-label="Page 2 1120-PC Group Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Is1120PCGroupInd"/>
                  <xsl:with-param name="BackupName">1120PCGroupIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Is1120PCGroupInd"/>
                  <xsl:with-param name="BackupName">1120PCGroupLabelP2</xsl:with-param>
                </xsl:call-template>
              </label>
		      1120-PC group	
           	</div>
            <div class="styGenericDiv" style="padding-left:3mm;">
              <!-- Check box 7 -->
              <b>(7)</b>
              <input type="checkbox" aria-label="Page 2 1120-PC Eliminations Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Is1120PCEliminationsInd"/>
                  <xsl:with-param name="BackupName">1120PCEliminationsIndP2</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/IncomeLossItems/Is1120PCEliminationsInd"/>
                  <xsl:with-param name="BackupName">1120PCEliminationsLabelP2</xsl:with-param>
                </xsl:call-template>
              </label>
...
<!--                <span class="styDotLn" style="float:right;padding-right:1mm;">.............</span>-->
          ...
          <div style="width:187mm;font-size:6pt;">
            <div class="styGenericDiv">
              ...
              <!-- Check box 1 -->
              <b>(1)</b>
              <input type="checkbox" aria-label="Page 3 Consolidated Group Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ConsolidatedGroupInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedGroupIndP3</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ConsolidatedGroupInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedGroupLabelP3</xsl:with-param>
                </xsl:call-template>
		        Consolidated group
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 2 -->
              <b>(2)</b>
              <input type="checkbox" aria-label="Page 3 Parent Corporation Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ParentCorporationInd"/>
                  <xsl:with-param name="BackupName">ParentCorporationIndP3</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ParentCorporationInd"/>
                  <xsl:with-param name="BackupName">ParentCorporationLabelP3</xsl:with-param>
                </xsl:call-template>
		        Parent corp
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 3 -->
              <b>(3)</b>
              <input type="checkbox" aria-label="Page 3 Consolidated Eliminations Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ConsolidatedEliminationsInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedEliminationsIndP3</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/ConsolidatedEliminationsInd"/>
                  <xsl:with-param name="BackupName">ConsolidatedEliminationsLabelP3</xsl:with-param>
                </xsl:call-template>
		        Consolidated eliminations
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 4 -->
              <b>(4)</b>
              <input type="checkbox" aria-label="Page 3 Subsidiary Corporation Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/SubsidiaryCorporationInd"/>
                  <xsl:with-param name="BackupName">SubsidiaryCorporationIndP3</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/SubsidiaryCorporationInd"/>
                  <xsl:with-param name="BackupName">SubsidiaryCorporationLabelP3</xsl:with-param>
                </xsl:call-template>
		        Subsidiary corp
		      </label>
            </div>
            <div class="styGenericDiv" style="padding-left:1.5mm;">
              <!-- Check box 5 -->
              <b>(5)</b>
              <input type="checkbox" aria-label="Page 3 Mixed 1120/L/PC Group Indicator" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/Mixed1120LPCGroupInd"/>
                  <xsl:with-param name="BackupName">Mixed1120LPCGroupIndP3</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
                  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleM3/ExpenseDeductionItems/Mixed1120LPCGroupInd"/>
                  <xsl:with-param name="BackupName">Mixed1120LPCGroupLabelP3</xsl:with-param>
                </xsl:call-template>
		         Mixed 1120/L/PC group
		      </label>
            </div>
          ...
          <div style="width:187mm;font-size:6pt;">
            <div class="styGenericDiv">
              ...
              <!-- Check box 6 -->
              <b>(6)</b>
              <input type="checkbox" aria-label="Is1120PCGroup3" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
            ...
            <div class="styGenericDiv" style="padding-left:2mm;">
              <!-- Check box 7 -->
              <b>(7)</b>
              <input type="checkbox" aria-label="Is1120PCEliminations3" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
