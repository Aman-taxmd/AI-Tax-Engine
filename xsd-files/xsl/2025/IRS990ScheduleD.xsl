...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:28mm;height:auto;">
							<div style="padding-top:1mm;font-weight:bold;font:8pt">
								...
								<br/>
								<br><span style="font-size:6pt;font-weight:normal;">(Rev. January 2025)</span></br>
		...
		Form 990, <br/>Part IV, line 6, 7, 8, 9, 10, 11a, 11b, 11c, 11d, 11e, 11f, 12a, or 12b.<br/>
          ...
          Go to <!--www.irs.gov/form990.-->
						...
						<div class="styTYBox" style="width:30mm;">
							<div class="styOMB" style="height:10mm;padding-top:4mm">OMB No. 1545-0047</div>

							<div class="styPartName" style="height:12mm; width:30.5mm;padding-top:0.3mm">Open to Public Inspection</div>
						</div>
					</div>
        ...
        <span style="font-size: 8pt;font-weight:normal;height:auto;">
          Complete if the organization answered "Yes" on Form 990, Part IV, line 6.
            ...
            (b) <span class="styNormalText"> Funds and other accounts</span>
						...
						<tbody valign="top">
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 1mm;height:4.5mm;float:none;">1</td>
								<td class="styLNDesc" scope="col" style="height:4.5mm;padding-left:2mm;float:none;">
        Total number at end of year
       <span class="styIRS990ScheduleD_DotSpacing">.........</span>
								</td>
								<td class="styLNAmountBox" scope="col" style="width:62mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:none;">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 1mm;height:4.5mm;float:none;">2</td>
								<td class="styLNDesc" scope="col" style="height:4.5mm;padding-left:2mm;float:none;">
        ...
        <span class="styIRS990ScheduleD_DotSpacing"/>
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 1mm;height:4.5mm;float:none;">3</td>
								<td class="styLNDesc" scope="col" style="height:4.5mm;padding-left:2mm;float:none;">
       ...
       <span class="styIRS990ScheduleD_DotSpacing"/>
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="height:4.5mm;float:none;">4</td>
								<td class="styLNDesc" scope="col" style="height:4.5mm;padding-left:2mm;float:none;">
						...
						<span style="padding-top:1mm;padding-top:4mm;">
							...
							<input type="checkbox" class="styCkbox" alt="DisclosedOrgLegCtrlIndYes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/DisclosedOrgLegCtrlInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDDisclosedOrgsLegalControlYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						...
						<span>
							...
							<input type="checkbox" class="styCkbox" alt="DisclosedOrgLegCtrlIndNo">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/DisclosedOrgLegCtrlInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDDisclosedOrgsLegalControlNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
...
<span class="styIRS990ScheduleD_DotSpacing">...................................</span>
						...
						<span style="padding-top:1mm;padding-top:7mm;">
							...
							<input type="checkbox" class="styCkbox" alt="DisclosedForCharitablePrpsIndYes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/DisclosedForCharitablePrpsInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDDisclosedForCharitablePurposesYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
        ...
        Yes
						...
						<span>
							...
							<input type="checkbox" class="styCkbox" alt="DisclosedForCharitablePrpsIndNo">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/DisclosedForCharitablePrpsInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDDisclosedForCharitablePurposesNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:7mm">
...
Complete lines 2a through 2d if the organization held a qualified conservation contribution 
 in the form of a conservation easement on the last day of the tax year. 
					...
					<table class="styTable" style="font-size:7pt;width:187mm;border-bottom-width:1px" cellspacing="0">
						...
						<tbody valign="top">
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="width:4.2mm; height:4.5mm;padding-left:3mm">a</td>
								<td style="border:0px 0px 0px 0px; height:4.5mm;width:125mm;">
			Total number of conservation easements
			<span class="styIRS990ScheduleD_DotSpacing">......................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="border:1px solid black; border-top: 0px;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">2a</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;border: 1px solid black; border-left: 0px; border-top:0px; vertical-align:bottom;padding-right:0.75mm;height:4.5mm;text-align:right">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="width:4.2mm; height:4.5mm;padding-left:3mm">b</td>
								<td style="border:0px 0px 0px 0px; height:4.5mm;width:125mm;">
			Total acreage restricted by conservation easements
			<span class="styIRS990ScheduleD_DotSpacing">....................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="border:1px solid black; border-top: 0px;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">2b</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;border: 1px solid black; border-left: 0px; border-top:0px; vertical-align:bottom;padding-right:0.75mm;height:4.5mm;text-align:right">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="width:4.2mm; height:4.5mm;padding-left:3mm">c</td>
								<td style="border:0px 0px 0px 0px; height:4.5mm;width:125mm;">
			Number of conservation easements on a certified historic structure included in (a)
			<span class="styIRS990ScheduleD_DotSpacing">.....</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="border:1px solid black; border-top: 0px;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">2c</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;border: 1px solid black; border-left: 0px; border-top:0px; vertical-align:bottom;padding-right:0.75mm;height:4.5mm;text-align:right">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="width:4.2mm; height:4.5mm;padding-left:3mm">d</td>
								<td style="border:0px 0px 0px 0px; height:4.5mm;width:125mm;">
			...
			<span class="styIRS990ScheduleD_DotSpacing">...</span>
								...
								<td class="styLNRightNumBox" scope="col" style="border:1px solid black; border-top: 0px;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">2d</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;border: 1px solid black; border-left: 0px; border-top:0px; vertical-align:bottom;padding-right:0.75mm;height:4.5mm;text-align:right">
									<xsl:call-template name="PopulateAmount">
...
<span class="styIRS990ScheduleD_DotSpacing">............</span>
						...
						<span style="padding-top:1mm;padding-top:4mm">
							...
							<input type="checkbox" class="styCkbox" alt="WrittenPolicyMonitoringYes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/WrittenPolicyMonitoringInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDWrittenPolicyMonitoringYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
        ...
        Yes
						...
						<span>
							...
							<input type="checkbox" class="styCkbox" alt="WrittenPolicyMonitoringNo">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/WrittenPolicyMonitoringInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDWrittenPolicyMonitoringNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
...
<span class="styIRS990ScheduleD_DotSpacing">.............................</span>
						...
						<span style="padding-top:1mm;padding-top:4mm">
							...
							<input type="checkbox" class="styCkbox" alt="Sect170hRequirementsSatisfiedYes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section170hRqrStsfdInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDSect170hRequirementsSatisfiedYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
        ...
        Yes
						...
						<span>
							...
							<input type="checkbox" class="styCkbox" alt="Sect170hRequirementsSatisfiedNo">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section170hRqrStsfdInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDSect170hRequirementsSatisfiedNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
 ...
 $
  ...
  <span class="styIRS990ScheduleDUnderlineAmount" style="float:none;width:32mm;">
					...
					<div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageEnd">
						<div class="styGenericDiv" style="width:107mm;font-weight:bold">For Paperwork Reduction Act Notice, see the Instructions for Form 990.</div>
						<div class="styGenericDiv" style="width:23mm;">Cat. No. 52283D</div>
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText">Schedule D (Form 990) (Rev. 1-2025)</span>
						</div>
					</div>
					<br/>
					<!-- header -->
					<div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule D (Form 990) (Rev. 1-2025)</div>
 ...
 Using the organization’s acquisition, accession, and other records, check any of the following that are a significant use of its collection items (check all that apply):</div>
       ...
       Scholarly research
        ...
        Other
								...
								<span class="styLNDesc" style="float:none;width:52mm;text-align:left;padding-left:1mm;padding-top:0mm;vertical-align:top;border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;">
									<xsl:call-template name="PopulateText">
...
<br/>assets to be sold to raise funds rather than to be maintained as part of the organization’s collection?<span class="styIRS990ScheduleD_DotSpacing">...</span>
						...
						<span style="padding-top:1mm;padding-top:4mm">
							...
							<input type="checkbox" class="styCkbox" alt="SolicitedAssetsSaleYes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SolicitedAssetsSaleInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDSolicitedAssetsForSaleYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
        ...
        Yes
						...
						<span>
							...
							<input type="checkbox" class="styCkbox" alt="SolicitedAssetsSaleNo">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SolicitedAssetsSaleInd"/>
									<xsl:with-param name="BackupName">IRS990ScheduleDSolicitedAssetsForSaleNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<label style="font-weight:bold;padding-top:4mm">
  ...
  <span class="styIRS990ScheduleD_DotSpacing">....................................</span>
        ...
        No
					...
					<table class="styTable" style="font-size:7pt;width:187mm;border-bottom-width:1px;" cellspacing="0">
						...
						<tbody valign="top">
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left:3mm;padding-top:1mm;">b</td>
								<td class="styLNDesc" scope="col" style="width:117mm;border-right-width:0;padding-top:1mm;height:auto;">
 If "Yes," explain the arrangement in Part XIII and complete the following table:
 <span class="styIRS990ScheduleD_DotSpacing"/>
								</td>
								<td class="styLNRightNumBox" scope="col" style="height:4.5mm;border-top-width:1px;"/>
								<td class="styLNAmountBox" scope="col" style="width:45mm;height:4.5mm;text-align:center;padding-right:0.75mm;border-top-width:1px;">
									<b>Amount</b>
								</td>
							</tr>
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left:3mm;height:4.5mm;">c</td>
								<td class="styLNDesc" scope="col" style="height:auto;width:117mm;border-right-width:0;padding-top:1mm;padding-left:0mm">
       Beginning balance 
      <span class="styIRS990ScheduleD_DotSpacing">.............................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="height:4.5mm;">1c</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 3mm;height:4.5mm;">d</td>
								<td class="styLNDesc" scope="col" style="height:auto;width:117mm;border-right-width:0;padding-top:1mm;padding-left:0mm">
       Additions during the year
       <span class="styIRS990ScheduleD_DotSpacing">............................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="height:4.5mm;">1d</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:right">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 3mm;height:4.5mm;">e</td>
								<td class="styLNDesc" scope="col" style="width:117mm;border-right-width:0;padding-top:1mm;padding-left:0mm">
       Distributions during the year 

       <span class="styIRS990ScheduleD_DotSpacing">..........................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="height:4.5mm;">1e</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:right">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" scope="col" style="padding-left: 3mm;height:4.5mm;">f</td>
								<td class="styLNDesc" scope="col" style="width:117mm;border-right-width:0;padding-top:1mm;padding-left:0mm">
       Ending balance        
       <span class="styIRS990ScheduleD_DotSpacing">................................</span>
								</td>
								<td class="styLNRightNumBox" scope="col" style="height:4.5mm;">1f</td>
								<td class="styLNAmountBox" scope="col" style="width:45mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:right">
									<xsl:call-template name="PopulateAmount">
