			...
			<body class="styBodyClass">
				<form id="Form9000">
					...
					<div class="styStdDiv" style="padding-left:8mm;height:auto;margin-bottom:4mm;">
						...
						<input type="checkbox" aria-label="F9000AlternativeMediaCd00" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
						...
						<br/>
						<input type="checkbox" aria-label="F9000AlternativeMediaCd01" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AlternativeMediaCd"/>
						...
						<br/>
						<input type="checkbox" aria-label="F9000AlternativeMediaCd02" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AlternativeMediaCd"/>
						...
						<br/>
						<input type="checkbox" aria-label="F9000AlternativeMediaCd03" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AlternativeMediaCd"/>
						...
						<br/>
						<input type="checkbox" aria-label="F9000AlternativeMediaCd04" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AlternativeMediaCd"/>
						...
						<br/>
						<input type="checkbox" aria-label="F9000AlternativeMediaCd05" class="styCkboxNM" style="margin-right:12px;">
							<xsl:call-template name="PopulateEnumeratedCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/AlternativeMediaCd"/>
