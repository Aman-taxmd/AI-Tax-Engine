			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleD">
					...
					<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:.5mm;">
						...
						<div class="styTY" style="padding-top:1mm;height:14mm;">20<span class="styTYColor">25</span></div>
					</div>
				</div>
				<!-- END FORM HEADER -->
				<!-- BEGIN TAXPAYER INFO -->
          ...
          <!-- Qurstion in qualified opportunity fund -->
					...
					<table class="styTable" style="width:187mm;border-color:black;font-size:7pt;" cellspacing="0" >
						...
						<tr style="height:20mm;vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:22mm;">1a</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all short-term transactions reported on Form 1099-B or Form 1099-DA for which basis was reported 
							...
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									...
									select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">		
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
							</td>
							...
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--line 1b-->
						<tr style="vertical-align:top;">
							...
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
								Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box A</b> or <b>Box G</b> checked
								 <!--<span class="IRS1120ScheduleD_styDotLn">..</span>-->
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--line 2-->
						<tr style="vertical-align:top;">
							...
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box B</b> or <b>Box H</b> checked
								<!--<span class="IRS1120ScheduleD_styDotLn">..</span>-->
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template> 
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--line 3-->
						<tr style="vertical-align:top;">	
							...
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box C</b> or <b>Box I</b> checked
								 <!--<span class="IRS1120ScheduleD_styDotLn">..</span>-->
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template> 
						    </td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">	
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotReceivedGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
					</table>
					...
					<table class="styTable" style="width:187mm;border-color:black;font-size:7pt;" cellspacing="0">
						...
						<!--Line 8a-->
						<tr style="height:20mm;vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:22mm;">8a</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all long-term transactions reported on Form 1099-B or Form 1099-DA for which basis was 
							...
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">				    
									<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
								</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="background-color:lightgrey;">
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--Line 8b-->
						<tr style="vertical-align:top;">
							...
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box D</b> or <b>Box J</b> checked
								 <!--<span class="IRS1120ScheduleD_styDotLn">..</span>--> 
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="padding-left:16px;vertical-align:bottom;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
									<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
								</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--Line 9-->
						<tr style="vertical-align:top;">		
							...
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
							    Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box E</b> or <b>Box K</b> checked
								<!--<span class="IRS1120ScheduleD_styDotLn">..</span>-->
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template> 
								</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!--Line 10-->
						...
						<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;padding-left:2.75mm;">10</td>
						    <td class="IRS1120ScheduleD_DescCol" scope="row" style="width:60mm;">
								Totals for all transactions reported on <br/>Form(s) 8949 with <b>Box F</b> or <b>Box L</b> checked
								<!--<span class="IRS1120ScheduleD_styDotLn">..</span>-->
							</td>	
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalProceedsSalesPriceAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
									<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
								</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotReceivedGrp/TotAdjustmentsToGainOrLossAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS1120ScheduleD_MoneyCol" scope="row" style="border-right-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalGainOrLossAmt"/>
								</xsl:call-template>
							</td>
						</tr>
					</table>
					...
					<div class="IRS1120ScheduleD_styFormFooter">
						...
						<span style="width:42mm;text-align:right;float:right;">Schedule D (Form 1120) 2025</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
