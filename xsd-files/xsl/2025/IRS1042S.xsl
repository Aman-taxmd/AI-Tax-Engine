					...
					<div class="styNBB" style="width:187mm;height:16mm;">
						...
						<div class="styFTBox" style="width:131mm;float:left;height:16mm;">
							...
							<div class="styMainTitle" style="padding-top:1mm;width:130mm;padding-left:2mm;font-size:8pt;text-align:left;">
								...
								<span style="width:2mm;"/>
								<input aria-label="Amended indicator" type="checkbox" class="styCkbox" name="AmendedInd" style="height:3.5mm;width:3.5mm;">
								...
								<td style="width:93mm;border:1px solid black;border-right:0;">
									<table style="float-left;" cellpadding="0" cellspacing="0">
										<tr>
											<td class="styIRS1042STableCell" style="width:93mm;float:left;vertical-align:top;">
												...
												<span class="styIRS1042STableCellContent" style="padding-top:0;width:58mm;height:4mm;border-width:1px 1px 0px 1px;">
													...
													<span class="styIRS1042STableCellContent" style="padding-top:1mm;width:58mm;height:4mm;border-width:1px 1px 0px 1px;">
                                                         <span class="styIRS1042SBoxNumber" style="height:8mm;">3</span>
                                                             Chapter indicator.  Enter "3" or "4"   
                                                             <span style="float:right;Padding-right:1mm;">                                                                                          
                                                                 <xsl:call-template name="PopulateText">
                                                                     <xsl:with-param name="TargetNode" select="$FormData/ChapterTypeCd"/>
										...
										Check if federal tax withheld was not deposited with the IRS because 
													...
													<div style="float-right;width:5mm;">
														<span style="padding-top:1mm;">
															<input aria-label="Tax not deposit per escrow procedure indicator" type="checkbox" class="styCkbox" name="TaxNotDepositPerEscrowProcInd">
																<xsl:call-template name="PopulateCheckbox">
										...
										Check if withholding occurred in subsequent year with respect to a
													...
													<div style="float-right;width:5mm;">
														<span style="padding-top:1mm;">
															<input aria-label="Subsequent year withholding partnership interest indicator" type="checkbox" class="styCkbox" name="SubsqYrWithholdingPrtshpIntInd">
																<xsl:call-template name="PopulateCheckbox">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:93mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:93mm;height:9mm;border-width:0px 1px 0px 1px;">
													<span style="float-left;width:86mm;padding:0mm 0mm 0mm 0.5mm;">
														<span class="styIRS1042SBoxNumber">7d</span>
										Check if you are a Qualified Intermediary, Withholding Foreign 
														<span style="float:left;padding-left:4mm;">Partnership, or Withholding Foreign Trust revising its reporting on Form</span>
														<span style="float:left;padding-left:4mm;">1042-S to report to a Specific recipient</span>	
														<span class="styBoldText" style="float:right;padding-right:2mm;">
															<span class="styDotLn">.........</span>
														</span>
													</span>
													<div style="float-right;width:5mm;">
														<span style="padding-top:1mm;">
															<input aria-label="Qualified intermediary withholding foreign partnership" type="checkbox" class="styCkbox" name="QIOrWPOrWTRevisingReportingInd">
																<xsl:call-template name="PopulateCheckbox">
																	<xsl:with-param name="TargetNode" select="$FormData/QIOrWPOrWTRevisingReportingInd"/>
																	<xsl:with-param name="BackupName">Check if you are a Qualified Intermediary, Withholding Foreign Partnership, or Withholding Foreign Trust revising its reporting on Form 1042-S to report a specific recipient.</xsl:with-param>
																</xsl:call-template>
															</input>
															<label>
																<xsl:call-template name="PopulateLabel">
								...
								<td style="width:94mm;border:1px solid black;border-left:0;vertical-align:top;">
									...
									<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:94mm;height:9mm;border-width:1px 1px 0px 0px;">
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:49mm;height:8mm;border-width:0px 0px 0px 0px;">
										...
										Recipient's U.S. TIN, if any <br/>
												...
												<span class="styIRS1042STableCellContent" style="width:45mm;padding-top:1mm;height:4mm;border-width:0px 1px 1px 1px;">
...
-->
													...
													<span style="padding-left:4mm;padding-top:3mm;">
														<xsl:attribute name="id">
															<xsl:call-template name="PopulateID">
																<xsl:with-param name="TargetNode" select="$FormData/RecipientGrp/FTIN"/>
															</xsl:call-template>
														</xsl:attribute>													
														<xsl:call-template name="PopulateChgHistory">
															<xsl:with-param name="targetNode" select="$FormData/RecipientGrp/FTIN"/>
															<xsl:with-param name="subString">1,19</xsl:with-param>
														</xsl:call-template>
													</span>
												</span>
										...
										<tr>
											<td class="styIRS1042STableCell" style="width:94mm;height:10mm;float:left;">
												<span class="styIRS1042STableCellContent" style="width:94mm;height:9.7mm;border-width:0px 1px 0px 0px;">
...
-->
										...
										Check if pro-rata basis reporting
													...
													<span style="float:right;padding-right:3mm;">
														...
														<input aria-label="Pro rata basis indicator" type="checkbox" class="styCkbox" name="ProRataBasisInd">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" select="$FormData/ProRataBasisInd"/>
...
-->
										...
										<tr>
											...
											Payer’s state tax no.<br/>
												...
												<span class="styIRS1042STableCellContent" style="width:22mm;height:7.3mm;border-width:0px 1px 0px 1px;">
										...
										<!--<tr>
											<td class="styIRS1042STableCell" style="width:94mm;float:left;background-color:lightgrey;">
												<span class="styIRS1042STableCellContent" style="width:94mm;height:0.0mm;border-width:0px 1px 0px 0px;">
												</span>
											</td>
										</tr>-->
									</table>
					...
					<div class="styFormFooter" style="width:187mm;border-top-width: 1px;">
						<span style="width:98mm;" class="styGenericDiv">
						(keep for your records)
					    </span>
						<span style="width:58mm;font-weight:normal;text-align:center;" class="styGenericDiv">
						</span>
						<span style="float:right;" class="styGenericDiv">Form <span class="styBoldText">1042-S</span> (2025)</span>
					</div>
