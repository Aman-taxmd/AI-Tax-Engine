        ...
        <form name="Form1120ScheduleN">
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styTYBox" style="width:30mm;height:17mm;">
              ...
              <div class="styTY" style="height:8mm;padding-top:2mm">20<span class="styTYColor">25</span>
              </div>
            </div>
          </div>
          <!--Name Line -->
          ...
          <div style="width:187mm;">
            <div style="float:left; clear:none;">
              ...
              <div class="styLNDesc" style="width:159mm; height:16.5mm;">			    
				The owner of a Qualified Business Unit (QBU) as defined in section 989(a) with functional currency different than its owner
				(including a foreign disregarded entity, foreign branch, or foreign partnership) is required to file Form 8964 and related schedules.
				Enter the number of Forms 8964 attached to the corporation’s tax return:
				<br/>
				U.S.
				 <!--UnderLine-->
              <div class="styIRS1120ScheduleNUnderlineAmount" style="width:42.95mm; padding-left:2mm; padding-right:3.75mm; text-align:left;float:none;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="MaxSize" select="3"/>
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleN/Form8964USQBUCnt"/>
                </xsl:call-template>
              </div>
              ...
              <div class="styIRS1120ScheduleNUnderlineAmount" style="width:42.95mm; padding-left:2mm; padding-right:3.75mm; text-align:left;float:none;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="MaxSize" select="3"/>
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleN/Form8964CFCQBUCnt"/>
                </xsl:call-template>
              </div>
				, and Foreign Partnerships <!--UnderLine-->
              <div class="styIRS1120ScheduleNUnderlineAmount" style="width:42.95mm; padding-left:2mm; padding-right:3.75mm; text-align:left;float:none;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="MaxSize" select="3"/>
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleN/Form8964FPSQBUCnt"/>
                </xsl:call-template>
              </div>.         
            ...
            <div style="float:right; clear:none;">
              <div class="styShadingCell" style="height:16.5mm; width:10mm;"/>
              <div class="styShadingCell" style="height:16.5mm; width:10mm;"/>
            </div>
          </div>
          ...
          <div style="width:187mm;">
            <div style="float:left; clear:none;">
              ...
              <div class="styLNDesc" style="width:159mm; height:4.5mm;">
				At any time during the 2025 calendar year, did the corporation have an interest in or a signature or other authority
			  </div>
			</div>
            <div style="float:right; clear:none;">
              <div class="styShadingCell" style="height:4.5mm; width:10mm;"/>
          ...
          <!--Page footer -->
           <div style="width:187mm;">
            ...
            <div class="stySmallText" style="width:42mm;text-align:right;">
              <span class="styBoldText">Schedule N (Form 1120) 2025</span>
            </div>
          </div>
          <br/>
          <br/>
