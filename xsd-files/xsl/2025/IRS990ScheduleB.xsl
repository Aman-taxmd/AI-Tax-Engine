...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
  ...
  <head>
    ...
    <title>Schedule B (Form 990) (Rev. 1-2025)</title>      
    <!-- No Browser Caching -->
    ...
    <form style="font-family:arial; font-size:8.5pt" name="Form990ScheduleB">
      ...
      <div class="styTBB" style="width:187mm">
        ...
        <div class="styFTBox" style="width:125mm">
          ...
          <!--<img src="{$ImagePath}/990SchB_Bullet.gif" alt="right arrow"/> -->
            Attach to Form 990, 990-EZ, or 990-PF.<br/>
          <div style="text-align:center;"><!--<img src="{$ImagePath}/990SchB_Bullet.gif" alt="right arrow"/>--> Go to 
           <a href="http://www.irs.gov/form990" style="color:black" title="Link to IRS.gov"> <i>www.irs.gov/Form990</i></a> 
          ...
          <label>
            ...
            <xsl:choose>
              <xsl:when test="$Form990ScheduleBData/Organization501cInd/@organization501cTypeTxt">
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/
                 Organization501cInd/@organization501cTypeTxt"/></xsl:call-template>          
              </xsl:when> 
              <xsl:otherwise>
      ...
      <div style="width:187mm; padding-top:1mm">
        Check if your organization is covered by the <b>General Rule</b> or a <b>Special Rule.</b> &nbsp;<br/><b>Note:
        </b>&nbsp;Only a section 501(c)(7), (8), or (10) organization can check boxes for both the General Rule and a Special
      ...
      <div style="padding-left:5mm; width:187mm">
        ...
        <div style="float:right; width:175mm">
           For an organization filing Form 990, 990-EZ, or 990-PF that received, during the year, contributions totaling 
           $5,000 or more (in money or other property) from any one contributor. Complete Parts I and II. See instructions 
      ...
      <div style="padding-left:5mm; width:187mm">
        ...
        <div style="float:right;width:177mm;">
            ...
            support test of the regulations <br/>under sections 509(a)(1) and 170(b)(1)(A)(vi), that checked Schedule A (Form
            990 or 990-EZ), Part II, line 13, 16a, or 16b, and that received from any one contributor, during the year, total
            contributions of the greater of <b>(1)</b> $5,000 or <b>(2)</b> 2% of the amount on (i) Form 990, Part VIII, line
            1h, or (ii) Form 990-EZ, line 1. Complete Parts I and II. 
        </div>
      </div>
      ...
      <div style="padding-left:5mm; margin-top:5mm; width:187mm">
        ...
        <div style="float:right; width:177mm">
           For an organization described in section 501(c)(7), (8), or (10) filing Form 990 or 990-EZ that received from any 
           one contributor, <br />during the year, total contributions of more than $1,000 <i>exclusively</i> for religious, 
           charitable, scientific, literary, or educational purposes, or for the prevention of cruelty to children or 
      ...
      <div style="padding-left:5mm; margin-top:5mm; width:187mm">
        ...
        <div style="float:right; width:177mm">
            For an organization described in section 501(c)(7), (8), or (10) filing Form 990 or 990-EZ that received from any 
            one contributor,<br />during the year, contributions <i>exclusively</i> for religious, charitable, etc., 
            purposes, but no such contributions totaled more than $1,000. If this box is checked, enter here the total 
            contributions that were received during the year for an <i>exclusively</i> religious, charitable, etc., purpose. 
            Don't complete any of the parts unless the <b>General Rule</b> applies to this organization because it received 
            <i>nonexclusively</i> religious, charitable, etc., contributions totaling $5,000 or more during the year 
            <span class="styIRS990ScheduleBDotLn">      
             .........
			</span>          
          <!--<img src="{$ImagePath}/990SchB_Bullet.gif" alt="Right Arrow"/>--> <span style="width:1px;" /> $ 
      ...
      <div style="border-bottom:1px solid black; width:187mm; margin-top:5mm; padding-bottom:3mm">      
        <b>Caution:</b>&#160;An organization that isn't covered by the General Rule and/or the Special Rules doesn't file 
        Schedule B (Form 990,<br />990-EZ, or 990-PF), but it <b>must</b> answer “No” on Part IV, line 2, of its Form 990; or
        check the box on line H of its Form 990-EZ <br />or on its Form 990PF, Part I, line 2, to certify that it doesn't 
        meet the filing requirements of Schedule B (Form 990,<br/>990-EZ, or 990-PF).
      </div>      
   ...
   <xsl:choose>
    ...
    <!-- END Part III -->              
      ...
      <xsl:if test="($Print = $Separated) and (count($Form990ScheduleBData/ContributorInformationGrp) &gt; 6)">
        <span class="styRepeatingDataTitle">Form 990 Schedule B, Part I - Contributors (See Instructions) Use duplicate 
         copies of Part I if additional space is needed.</span>
      ...
      <xsl:if test="($Print = $Separated) and (count($Form990ScheduleBData/NonCashPropertyContributionGrp) &gt; 6)"> <br/>
        <span class="styRepeatingDataTitle">Form 990 Schedule B, Part II - Noncash Property (See Instructions) Use duplicate
         copies of Part II if additional space is needed</span>
  ...
  <xsl:if test="$index &lt;= $max">
    <xsl:if test="$index mod 6 = 1">
      ...
      <tr style="font-size:7.5pt; height:9mm; width:187mm" valign="top">
        ...
        <th  style="width:70mm; text-align:left; border-top:2px solid black; border-bottom:2px solid black;
         font-family:verdana;font-size:7pt; padding-left:1mm;" scope="col" colspan="2">
          <span class="styBoldText">Employer identification number</span>
          <br/>
      ...
      <tr style="width:187mm">
        <th style="width:10mm; border-bottom:1px solid black;" colspan="1">
          ...
          <div class="styPartName" style="width:17mm; background-color:white; color:black;font-size:8pt; padding-top:.5mm; 
           padding-left:0.5;">
          </div>   
        </th>  
        <th colspan="4" style="width:83mm; border-bottom:1px solid black; text-align:left; padding-left:5mm">            
      <div  style="width:120mm">Contributors <span style="font-weight:normal;font-size:7pt;">(see instructions).  Use 
       duplicate copies of Part I if additional space is needed.</span></div>
        </th>
      </tr>    
    </xsl:if>    
    ...
    <tr>          
        ...
        <div class="styIRS990ScheduleBDotBB" style="border-bottom:0px">  
          <xsl:choose>
            ...
            <xsl:when test="$Form990ScheduleBData/ContributorInformationGrp[$index]/ContributorForeignAddress">
              ...
              <xsl:otherwise>
                <xsl:call-template name="PopulateText"><xsl:with-param name="TargetNode" select="$Form990ScheduleBData/
                ContributorInformationGrp[$index]/AddressNotApplicableCd"/></xsl:call-template><br/> 
        ...
        <span style="border-bottom:1px solid black; float:left; width:30mm; ; font-size:7pt; height:auto;text-align:right;">$ 
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
             select="$Form990ScheduleBData/ContributorInformationGrp[$index]/TotalContributionsAmt"/>
          </xsl:call-template>          
        </span>  
      </td>    
      ...
      <label>
        <xsl:call-template name="PopulateLabel">
        <xsl:with-param name="TargetNode" 
         select="$Form990ScheduleBData/ContributorInformationGrp[$index]/PersonContributionInd"/>
      ...
      <xsl:call-template name="PopulateLabel">
      <xsl:with-param name="TargetNode" 
       select="$Form990ScheduleBData/ContributorInformationGrp[$index]/PayrollContributionInd"/>
    ...
    <xsl:if test="$index mod 6 = 0">
      <tr style="page-break-after:never">
  ...
  <xsl:if test="$index &lt;= $max">  
    <xsl:if test="$index mod 6 = 1">
      ...
      <tr style="font-size:7.5pt; height:9mm; width:187mm" valign="top">
        ...
        <th class="styIRS990ScheduleBTblCell" style="width:80mm;border-top:2px solid black; 
         border-bottom:2px solid black;font-family:verdana;font-size:7pt; text-align:left;" scope="col" colspan="3">
          <span class="styBoldText">Employer identification number</span>
          <br/><br/>
          <span style="font-weight:normal">
            <xsl:call-template name="PopulateReturnHeaderFiler">
      ...
      <tr>
        ...
        <th style="width:83mm; border-bottom:1px solid black">            
          <div class="styPartDesc" style="width:130mm">Noncash Property <span style="font-weight:normal;font-size:7pt;">
           (see instructions). Use duplicate copies of Part II if additional space is needed.</span></div>                
        </th>  
  ...
  <table class="styIRS990ScheduleBTable" cellspacing="0" cellpadding="0" border="0" style="width:187mm;">  
      ...
      <tr>
        <td style="width:187mm; border-bottom:2px solid black" scope="col" colspan="4">
			...
			<div class="styPartDesc" style="font-weight:normal;border-bottom:1px solid blackwidth:170mm; height:20mm;
			 padding-top:0.5mm; ">
			  <b><i>Exclusively</i> religious, charitable, etc., contributions to organizations described in section 501(c)
			  (7), (8), or (10) that total more than $1,000 for the year from any one contributor.</b> Complete columns 
			  <b>(a)</b> through <b>(e) and</b> the following line entry. For organizations completing Part III, enter the 
			  total of <i>exclusively</i> religious, charitable, etc., contributions of <b>$1,000 or less</b> for the year. 
			  (Enter this information once. See instructions.) 
                <!--<img src="{$ImagePath}/990SchB_Bullet.gif" alt="Arrow Bullet" />-->
...
<xsl:template name="IRS990BFooter">  
  ...
  <!--div style="width:187mm; font-size:7pt; border-top:1 solid black; page-break-after:always"-->   
    ...
    <div style="float:right; padding-top:0.5mm; padding-right:0.5mm">      
      ...
      <b>Schedule B (Form 990) (Rev. 1-2025)</b>
    </div>
   <!-- <div class="pageEnd"/>-->
  <!--/div-->    
</xsl:template>
