      ...
      <body class="styBodyClass">
        <form name="Form990">
          ...
          <div style="width:187mm;font-weight:bold;">
            <span class="styBoldText" style="width:4mm;">A</span> For the 2025 calendar year, or tax year beginning
        ...
        , and ending         
          ...
          <div style="width:187mm;">
            <div style="width:25mm;float:left;font-size:6pt;padding-top:2mm;border-style:solid;border-color:black;border-width: 1px 0px 0px 0px;">
              <span class="styBoldText" style="float:left;width:2.75mm;border-top-width:1px">B</span>Check if applicable:
...
<td class="styLNDesc" style="padding-left:1.5mm;width:142.5mm;height:4.5mm;">
Total number of individuals employed in calendar year 2025 (<span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part V</span>, line 2a) 
<span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">......</span>
</td>
...
<xsl:call-template name="PopulateAmount">
  ...
  <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">.....</span>
            ...
            <td class="styIRS990VTImageBox" rowspan="5" valign="middle" style="width:5mm;border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px">
              ...
              <tr>
                <td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;border-bottom-width:0px;">22</td>
                <td class="styLNDesc" style="padding-left:1.5mm;width:110mm;height:auto;border-bottom-width:0px;" colspan="2">
                <span style="float:left;border-botton-width:0px;">Net assets or fund balances. Subtract line 21 from line 20</span>
                <span style="clear:none;letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;border-bottom-width:0px;">.....</span>
                </td>
                <td class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0px;">
                  <xsl:call-template name="PopulateAmount">
          ...
          <!-- BEGIN Part II Signature Title -->
            <div class="styBB" style="width:187mm;clear:both;border-top-width:1px;display:table;display:inline;"> <!--change top to 1 when 22 fixed -->
...
<div class="styBB" style="width:187mm;"/>
            ...
            <tr>
              ...
              <td style="width:53mm;height:auto;border-bottom:0px solid black;vertical-align:bottom;padding-left:1mm;border-left:1px solid black;">
                <xsl:call-template name="PopulateReturnHeaderOfficer">
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990 </span> (2025)
  </div>
					</div>
					<div class="pageEnd"/>
				<!--	<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px"/>
          ...
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2025)</div>
      ...
      Section 501(c)(3) and 501(c)(4) organizations are required to report the amount of grants and allocations to others, the total expenses, and revenue, if any, for each program service reported.
        ...
        Other program services (Describe in Schedule O.)
          ...
          <span style="width:30mm;text-align:right;">
              ...
              <!-- 4e -->
              <tr style="font-size:7pt;">
                <td class="styLNLeftNumBox" style="font-size:7pt;font-style:bold;border-style:solid; border-color:black; border-left-width:0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px">4e</td>
                <td style="width:178mm;border-style:solid; border-color:black; border-left-width:0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px">
...
-->
          ...
          <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px" class="pageEnd">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">990</span> (2025)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2025)</div>
...
<i> If “Yes,” complete Schedule F, Parts III and IV</i>
    ...
    Did the organization report more than $5,000 of grants or other assistance to any domestic organization or domestic government on <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part IX</span>, column (A), line 1?
     <i>  If “Yes,” complete Schedule I, Parts I and II</i>
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:1.5mm;border-bottom-width:0px;">21</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;border-bottom-width:0px;">
              <xsl:call-template name="PopulateYesBoxText">
              <xsl:with-param name="TargetNode" select="$Form990Data/GrantsToOrganizationsInd"/>
              </xsl:call-template>
            </div>
...
<span class="styItalicText">  If "Yes," complete Schedule R, <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VI</span></span>
    ...
    Did the organization complete Schedule O and provide explanations on Schedule O for <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VI</span>, lines 11b and 19? <b>Note.</b> All Form 990 filers are required to complete Schedule O.
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;border-bottom:none">38</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:2.5mm;border-bottom:none">
              <xsl:call-template name="PopulateYesBoxText">
                <xsl:with-param name="TargetNode" select="$Form990Data/ScheduleORequiredInd"/>
              </xsl:call-template>
            </div>
...
if not applicable
        ...
        Did the organization comply with backup withholding rules for reportable payments to vendors and reportable gaming (gambling) winnings to prize winners?  
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;border-bottom:none;">1c</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;border-bottom:none;">
              <xsl:call-template name="PopulateYesBoxText">
          ...
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both; border-bottom-width: 0px;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2025)</div>
            <div style="width:55mm;text-align:center;" class="styGenericDiv"/>
...
of an excise tax under section 4951, 4952, or 4953?  
            ...
            <div class="styLNRightNumBox" style="height:9.5mm; padding-top: 1.5mm;border-bottom:none;">17</div>
            <div class="styIRS990LNYesNoBox" style="height:9.5mm;padding-top: 1.5mm;border-bottom:none;">
              <xsl:call-template name="PopulateYesBoxText">
      ...
      The governing body?
       ...
       Each committee with authority to act on behalf of the governing body?
        ...
        Is there any officer, director, trustee, or key employee listed in <span style="font-family: Arial, Helvetica, sans-serif; font-weight: 500; font-width: font-stretch: ultra-expanded; font-size:10.0px;">Part VII</span>, Section A, who cannot be reached at the organization’s mailing address? <i>If "Yes," provide the names and addresses in Schedule O</i>
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:3.5mm;border-bottom-width:0px;">9</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:3.5mm;border-bottom-width:0px;">
              <xsl:call-template name="PopulateYesBoxText">
...
If "Yes" to line 15a or 15b, describe the process on Schedule O. See instructions.</span>
       ...
       If "Yes," did the organization follow a written policy or procedure requiring the organization to evaluate its participation in joint venture arrangements under applicable federal tax law, and take steps to safeguard the organization’s exempt status with respect to such arrangements?
            ...
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:7.5mm;"/>
            <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0px;">16b</div>
            <div class="styIRS990LNYesNoBox" style="height:4.5mm;border-bottom-width:0px;">
              <xsl:call-template name="PopulateYesBoxText">
 ...
 List all of the organization’s <span class="styBoldText">former directors or trustees</span> that received, in the capacity as a former director or trustee of the <br/>organization, more than $10,000 of reportable compensation from the organization and any related organizations.</div>
    ...
    <xsl:call-template name="PopulateLabel">
        ...
        Check this box if neither the organization nor any related organization compensated any current officer, director, or trustee.
          ...
          <div class="styBB" style="width:187mm;float:none;display:table;border-bottom-width:0px">
            <!--  print logic -->
      ...
      <br/>
          ...
          <div style="width:187mm; border-style: solid; border-color:black; border-left-width: 0px; border-right-width: 0px; border-top-width:0px; border-bottom-width: 0px;" class="pageEnd">
            <div class="styGenericDiv" style="width:105mm;border-top-width: 0px;"/>
            <div class="styGenericDiv" style="width:25mm;border-top-width: 0px;"/>
            <div class="styGenericDiv" style="float:right;border-top-width: 0px;">Form <span class="styBoldText">990</span> (2025)</div>
          </div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Form 990 (2025)</div>
          ...
          <div class="styBB" style="width:187mm;float:none;border-bottom-width:0px">
                ...
                <xsl:for-each select="$Form990Data/Form990PartVIISectionAGrp">
                  <xsl:if test="position() &gt; 17">
                    ...
                    <!-- Added the ability to number each instance for 2010 -->
                      ...
                      <!-- Column F -->
                      <td class="styTableCell" scope="col" style="width:25mm;font-size:6pt;border-right-width:0px;border-style: solid; border-color: black;border-bottom-width:0px">
                        <xsl:call-template name="PopulateAmount">
                          <xsl:with-param name="TargetNode" select="OtherCompensationAmt"/>
                        </xsl:call-template>
                      </td>
          ...
          <table class="styTable" style="font-size:7pt;width:187mm;border-color:black" cellspacing="0">
            <tbody valign="top">
              <tr>
                ...
                <td class="styGenericDiv" colspan="4" style="width:107mm;height:auto;border-style: solid;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 1px;">
              ...
              <tr>
                ...
                <td class="styGenericDiv" colspan="4" style="width:107mm;height:auto;border-style: solid;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
...
the organization and related organizations greater than $150,000? <i>If "Yes," complete Schedule J for such <br></br>individual</i> 
          ...
          Did any person listed on line 1a receive or accrue compensation from any unrelated organization or individual for services rendered to the organization?<span class="styItalicText"> If "Yes," complete Schedule J for such person </span>
            ...
            <div class="styShadingCell" style="width:10mm;height:4.5mm;"/>
            <div class="styShadingCell" style="width:10mm;height:4.5mm;"/>
            <div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0px;">5</div>
            <div class="styIRS990LNYesNoBox" style="height:4.5mm;border-bottom-width:0px;">
              <xsl:call-template name="PopulateYesBoxText">
...
<td class="styLNAmountBox" style="height:7.5mm;width:22mm;font-size:6pt;padding-top:4mm;">
   ...
   <span class="styTableCellPad"/>
              ...
              <!-- 2g -->
               <tr>
                 <td class="styLNLeftNumBox" style="width:0.25mm;height:4.5mm;padding-top:0mm;padding-left:2mm;padding-right:0mm;border-color: black; border-bottom-width: 0px;">
                  g
    </td>
             <td class="styGenericDiv" colspan="3" style="width:52mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;padding-top:0.5mm;padding-right:0mm;">
                 <span style="width:2mm;padding-right:3mm;border-color: black; border-bottom-width: 0px;"/><b> Total. </b> 
                  <span class="styNormalText"> Add lines 2a–2f </span>
                  <span style="letter-spacing:2.5mm; font-weight:bold; font-size:7pt;border-color: black; border-bottom-width: 0px;">.....</span>
                  <!--<img src="{$ImagePath}/990_Bullet_Md.gif" alt="right arrow"/>-->
                  <span style="width:1mm;"/>
                </td>
                <td class="styTableCell" style="width:16mm;height:4.5mm;border-style: solid;border-color: black; border-bottom-width: 0px;">
                  <span class="styTableCellPad"/>
                  <span style="width:1mm;border-color: black; border-bottom-width: 0px;"/>
            ...
            <tbody valign="top">							
              ...
              <tr>
            <td class="styIRS990VTImageBox" style="width:5mm;padding-left:2mm;" rowspan="25" valign="middle">
                  <img src="{$ImagePath}/990_Other_Revenue.gif" alt=" OtherAmtRevenueAmt"/>
                </td>
               <td class="styLNDesc" colspan="3" style="width:81mm;height:4.5mm;border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;float:left;">
		...
		<!-- Line 6 table -->
		<tr>
			<td class="styLNDesc" colspan="1" style="width:5mm;height:auto;font-size:7pt;border-style: solid; border-color: black;border-width: 0px 0px 0px 0px;">
				<span style="padding-left:1mm;">
					</span>
			</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:auto;font-size:7pt;border-style: solid; border-color: black;border-width: 0px 0px 0px 0px;">
				<span style="padding-left:1mm;">
					</span>
			</td>
			<td class="styLNDesc" colspan="1" style="width:6mm;height:auto;font-size:7pt;border-style: solid; border-color: black;border-width: 1px 1px 0px 1px;">
				<span style="padding-left:1mm;">
					</span>
			</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:auto;font-size:7pt;text-align: center;border-style: solid; border-color: black;border-width: 1px 1px 1px 0px;">
				<span style="padding-left:1mm;">
					(i) Real</span>
			</td>
			<td class="styLNDesc" colspan="1" style="width:24mm;height:auto;font-size:7pt;text-align: center;border-style: solid; border-color: black;border-width: 1px 1px 1px 0px;">
				<span style="padding-left:1mm;">
					(ii) Personal</span>
			</td>
		...
		<!-- 6a -->
		<tr>
			<td class="styLNLeftNumBox" style="width:5mm;height:6mm;padding-top:.3mm;padding-left:1mm;">6a</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:6mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
				<span style="">
  Gross rents
				</span>
			</td>
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 6mm; padding-left: 1.5mm; font-size: 6.5pt;">6a</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;border-left-width:0px;float:left;padding-top:2mm;height:6mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GrossRentsGrp/RealAmt"/><!--  RealAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;border-left-width:0px;padding-top:2mm;height:6mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GrossRentsGrp/PersonalAmt"/><!-- PersonalAmt  -->
                  </xsl:call-template>
                </td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			</td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			...
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;border-style: solid;border-right-width: 0px;">
				<span class="styTableCellPad"/>
			</td>
		</tr>					
        <!-- 6b -->
		<tr>
			<td class="styLNLeftNumBox" style="width:5mm;height:6mm;padding-top:.3mm;padding-left:3mm;">b</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:6mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
				<span style="">
  Less: rental expenses
				</span>
			</td>
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 6mm; padding-left: 1.5mm; font-size: 6.5pt;">6b</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;border-left-width:0px;float:left;padding-top:2mm;height:6mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/LessRentalExpensesGrp/RealAmt"/><!--  RealAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;border-left-width:0px;padding-top:2mm;height:6mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/LessRentalExpensesGrp/PersonalAmt"/><!-- PersonalAmt  -->
                  </xsl:call-template>
                </td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
        ...
        <!-- 6c -->
		<tr>
			<td class="styLNLeftNumBox" style="width:5mm;height:6mm;padding-top:.3mm;padding-left:3mm;">c</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:6mm;border-style: solid; border-color: black;border-width: 0px 0px 0px 0px;">
				<span style="">
   Rental income or (loss)
				</span>
			</td>
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 6mm; padding-left: 1.5mm; font-size: 6.5pt;">6c</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;float:left;padding-top:2mm;height:6mm;border-style: solid; border-color: black;border-width: 0px 1px 1px 0px">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/RentalIncomeOrLossGrp/RealAmt"/><!--  RealAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;padding-top:2mm;height:6mm;border-style: solid; border-color: black;border-width: 0px 1px 1px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/RentalIncomeOrLossGrp/PersonalAmt"/><!-- PersonalAmt  -->
                  </xsl:call-template>
                </td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-color: black;border-width: 0px 1px 1px 0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			</td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-color: black;border-width: 0px 1px 1px 0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			...
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;background-color:lightgrey;border-style: solid;border-width: 0px 0px 1px 0px;">
				<span class="styTableCellPad"/>
			</td>
		</tr>
        <!-- 6d -->
              <tr>
                ...
                <td class="styGenericDiv" colspan="3" style="width:75mm;height:4.5mm;border-style: solid; border-color: black;border-width: 0px 1px 0px 0px;">
                ...
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;padding-top:0mm;border-style: solid; border-color: black;border-width: 0px 1px 0px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/NetRentalIncomeOrLossGrp/TotalRevenueColumnAmt"/>
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;border-style: solid; border-color: black;border-width: 0px 1px 0px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                ...
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;border-style: solid; border-color: black;border-width: 0px 1px 0px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/NetRentalIncomeOrLossGrp/UnrelatedRevenueAmt"/>
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt;border-style: solid;border-width: 0px 0px 0px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
		...
		<!-- 7a -->
		<tr>
			<td class="styLNLeftNumBox" style="width:5mm;height:13mm;padding-top:.3mm;padding-left:1mm;">7a</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:6mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
				<span style="">
  Gross amount from sales of assets other than inventory
				</span>
			</td>
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 13mm; padding-left: 1.5mm; font-size: 6.5pt;">7a</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;border-left-width:0px;float:left;padding-top:2mm;height:13mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GrossAmountSalesAssetsGrp/SecuritiesAmt"/><!--  SecuritiesAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;border-left-width:0px;padding-top:2mm;height:13mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GrossAmountSalesAssetsGrp/OtherAmt"/><!-- OtherAmt  -->
                  </xsl:call-template>
                </td>
			<td class="styTableCell" style="width:25mm;height:13mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			</td>
			<td class="styTableCell" style="width:25mm;height:13mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
			...
			<td class="styTableCell" style="width:25mm;height:13mm;font-size:6pt;border-bottom-width:0px;background-color:lightgrey;border-style: solid;border-right-width: 0px;">
				<span class="styTableCellPad"/>
			</td>
		</tr>					
        <!-- 7b -->
		<tr>
			<td class="styLNLeftNumBox" style="width:5mm;height:10mm;padding-top:.3mm;padding-left:3mm;">b</td>
			<td class="styLNDesc" colspan="1" style="width:23mm;height:10mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
				<span style="">
   Less: cost or other basis and sales expenses  
				</span>
			</td>
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 10mm; padding-left: 1.5mm; font-size: 6.5pt;">7b</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;border-left-width:0px;float:left;padding-top:2mm;height:10mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/LessCostOthBasisSalesExpnssGrp/SecuritiesAmt"/><!--  SecuritiesAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;border-left-width:0px;padding-top:2mm;height:10mm;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/LessCostOthBasisSalesExpnssGrp/OtherAmt"/><!-- OtherAmt  -->
                  </xsl:call-template>
                </td>
   ...
   Gain or (loss)
			...
			<td class="styLNLeftNumBox" style="border-width: 0px 1px 1px 1px; border-style: solid; width: 6mm; height: 6mm; padding-left: 1.5mm; font-size: 6.5pt;">7c</td>
                <td class="styTableCell" style="width:23mm;font-size:6pt;float:left;padding-top:2mm;height:6mm;border-style: solid; border-color: black;border-width: 0px 1px 1px 0px">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GainOrLossGrp/SecuritiesAmt"/><!--  SecuritiesAmt -->
                  </xsl:call-template>
                </td>
                <td class="styTableCell" style="width:24mm;font-size:6pt;float:left;padding-top:2mm;height:6mm;border-style: solid; border-color: black;border-width: 0px 1px 1px 0px;">
                  <span class="styTableCellPad"/>
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/GainOrLossGrp/OtherAmt"/><!-- OtherAmt  -->
                  </xsl:call-template>
                </td>
			<td class="styTableCell" style="width:25mm;height:6mm;font-size:6pt;border-color: black;border-width: 0px 1px 1px 0px;background-color:lightgrey;">
				<span class="styTableCellPad"/>
 ...
 <span class="styFixedUnderline" style="float:none;width:20mm;text-align:right;font-size:6pt;">
  ...
  <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">..</span>
              ...
              <tr>
                ...
                <td class="styTableCell" style="width:56mm;height:4.5mm;text-align:center;float:right;border-style: solid; border-color: black;border-top-width: 1px;border-bottom-width:0px;"></td>
...
<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">....</span>
              ...
              <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt; padding-top:3mm;border-left-width: 1px;border-bottom-width: 0px">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
                      <xsl:with-param name="TargetNode" select="$Form990Data/TotalRevenueGrp/TotalRevenueColumnAmt"/>
                    </xsl:call-template>
                  </td>
                <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt; padding-top:3mm;border-bottom-width: 0px">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
                  ...
                  <td class="styTableCell" style="width:25mm;height:4.5mm;font-size:6pt; padding-top:3mm;border-style: solid;border-right-width: 0px;border-bottom-width: 0px">
                    <span class="styTableCellPad"/>
                    <xsl:call-template name="PopulateAmount">
...
trustees, and key employees
 ...
 <xsl:call-template name="SetFormLinkInline">
							...
							<xsl:for-each select="$Form990Data/OtherExpensesGrp">
								<xsl:if test="($Print != $Separated) or (count($Form990Data/OtherExpensesGrp) &lt;= 6) ">
									<tr>
										...
										<td class="styIRS990LNAmountBoxNLB" style="width:77.7mm;height:4.5mm;text-align:left;padding-left:3mm;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="Desc"/>
											</xsl:call-template>
										</td>
              ...
              <tr>
                ...
                <td class="styIRS990LNDescBB" style="width:77mm;height:15mm;font-size:7pt;padding-bottom:0;border-bottom-width: 0px">
  ...
  if  following SOP 98-2 (ASC 958-720). 
                ...
                <td class="styLNAmountBoxSmall" style="width:25.8mm;height:15mm;vertical-align:bottom;padding-right:0.75mm;border-bottom-width: 0px">
                  <xsl:call-template name="PopulateAmount">
        ...
        <xsl:with-param name="BackupName">IRS990InfoInScheduleOPartXIInd</xsl:with-param>
         ...
         <!-- Dotted Line-->
           ...
           <!--  L10 -->
            ...
            <!-- Float the number box to the right so all number boxes wil align for both the screen and the print versions -->
              <div style="float:right">
                <div class="styLNRightNumBox" style="height:4.5mm; padding-top=3.5mm;border-bottom-width: 0px">10</div>
                <div class="styLNAmountBox" style="height:4.5mm; padding-top=3.5mm;border-bottom-width: 0px">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" select="$Form990Data/TotalNetAssetsFundBalanceGrp/EOYAmt"/>
                  </xsl:call-template>
                </div>
...
<!-- Attempting to fix 508 error I removed "IRS990" from the BackupNames in this section to avoid duplicate with PRIOR Section since they both use same element-->
      ...
      <div class="styLNLeftNumBox" style="height:auto;padding-left:3mm;"/>
            <div class="styLNDesc" style="width:150mm;height:auto;">
        <span style="width:2mm;padding-left:0mm;"/>
              <input type="checkbox" class="styCkbox" alt="audited by accountant separate basis">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/FSAuditedBasisGrp/SeparateBasisFinclStmtInd"/>
                  <xsl:with-param name="BackupName">AuditSeparateBasisFinclStmtInd</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
          ...
          <span style="width:2mm;padding-left:8mm;"/>
              <input type="checkbox" class="styCkbox" alt="audited by accountant consolidated basis">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/FSAuditedBasisGrp/ConsolidatedBasisFinclStmtInd"/>
                  <xsl:with-param name="BackupName">AuditConsolidatedBasisFinclStmtInd
                  </xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
          ...
          <span style="width:2mm;padding-left:8mm;"/>
              <input type="checkbox" class="styCkbox" alt="audited by accountant both consolidated and separate basis">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form990Data/FSAuditedBasisGrp/ConsolAndSepBasisFinclStmtInd"/>
                  <xsl:with-param name="BackupName">AuditConsolAndSepBasisFinclStmtInd</xsl:with-param>
                </xsl:call-template>
              </input>
              <label>
                <xsl:call-template name="PopulateLabel">
...
the Uniform Guidance, 2 C.F.R. Part 200, Subpart F?
        ...
        If the organization did not undergo the required audit or audits, explain why in Schedule O and describe any steps taken to undergo such audits.
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;padding-top:4mm;border-bottom-width: 0px">3b</div>
            <div class="styIRS990LNYesNoBox" style="height:7.5mm;padding-top:4mm;border-bottom-width: 0px">
              <xsl:call-template name="PopulateYesBoxText">
