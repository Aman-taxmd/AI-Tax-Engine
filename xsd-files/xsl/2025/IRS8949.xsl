...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="p1Lines" select="11"/>
	<xsl:variable name="p2Lines" select="11"/>
	...
	<div style="width:187mm;">
		...
		<div class="styIRS8949LineItem" style="padding-top:0mm;padding-bottom:1.5mm;border-bottom:1px solid;border-top:1px solid;clear:all;height:18mm;">
			...
			<b>Short-Term.</b> Transactions involving capital assets you held 1 year or less are generally short term (see instructions). For long-term transactions, see page 2. <br/>
					<b>Note:</b> You may aggregate all short-term transactions reported on Form(s) 1099-B, and Form(s) 1099-DA showing basis was reported to the IRS and for which no adjustments or codes are required. Enter the totals directly on Schedule D, line 1a; you aren't required to report these transactions on Form 8949 (see instructions).
			</div>
		</div>
		<div class="styIRS8949LineItem" style="padding-bottom:2mm;height:10mm;">
			<b>You <i>must</i> check Box A, B, C, G, H, <i>or</i> I below. Check only one box.</b> If more than one box applies for your short-term transactions, complete a separate Form 8949, page 1, for each applicable box. If you have more short-term transactions than will fit on this page for one or more of the boxes, complete as many forms with the same box checked as you need.
		</div>
		<!-- END: Part I (Header)-->
		<!-- BEGIN: Part I (Body) -->
		<!-- ################################################################################# -->
		...
		<div class="styBB" style="width:187mm;padding-bottom:.5mm;">
			<div class="styIRS8949LNDesc" style="width:187mm;">
				...
				<div style="width:182mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Short-term transactions reported on <b>Form(s) 1099-B</b> showing basis was reported to the IRS (see <b>
						Note</b> above)
				</label>
				</div>
			</div>
			<div class="styIRS8949LNDesc" style="width:187mm;">
				...
				<div style="width:182mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Short-term transactions reported on <b>Form(s) 1099-B</b> showing basis <b>wasn't</b> reported to the IRS
				</label>
				</div>
			</div>
			<div class="styIRS8949LNDesc" style="width:180mm;">
				<div style="width:3mm;float:left;">
					<input type="Checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="$NodeData/NonDATransNotRptOn1099BOrDAInd"/>
							<xsl:with-param name="BackupName">ShortTerm<xsl:number value="position()"/>NonDATransNotRptOn1099BOrDAInd</xsl:with-param>
						</xsl:call-template>
					</input>
				</div>
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Short-term transactions, other than digital asset transactions not reported to you on <b>Form 1099-B</b> or <b>Form 1099-DA</b>
					</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				<div style="width:3mm;float:left;">
					<input type="Checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="$NodeData/TransRptOn1099DAThatShowBssInd"/>
							<xsl:with-param name="BackupName">ShortTerm<xsl:number value="position()"/>TransRptOn1099DAThatShowBssInd</xsl:with-param>
						</xsl:call-template>
					</input>
				</div>
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(G)</span>
						</b> Short-term transactions reported on <b>Form(s) 1099-DA</b> showing basis was reported to the IRS (see <b>
						Note</b> above)
					</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				<div style="width:3mm;float:left;">
					<input type="Checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="$NodeData/TransRptOn1099DANotShowBssInd"/>
							<xsl:with-param name="BackupName">ShortTerm<xsl:number value="position()"/>TransRptOn1099DANotShowBssInd</xsl:with-param>
						</xsl:call-template>
					</input>
				</div>
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(H)</span>
						</b> Short-term transactions reported on <b>Form(s) 1099-DA</b> showing basis <b>wasn't</b> reported to the IRS
					</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				<div style="width:3mm;float:left;">
					<input type="Checkbox" class="styCkbox">
						<xsl:call-template name="PopulateCheckbox">
							<xsl:with-param name="TargetNode" select="$NodeData/DATransNotRptOn1099DAOrBInd"/>
							<xsl:with-param name="BackupName">ShortTerm<xsl:number value="position()"/>DATransNotRptOn1099DAOrBInd</xsl:with-param>
						</xsl:call-template>
					</input>
				</div>
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(I)</span>
						</b> Short-term digital asset transactions not reported to you on <b>Form 1099-DA</b> or <b>Form 1099-B</b>
					</label>
				</div>
			</div>
		...
		<div class="styIRS8949LineItem" style="clear:both;height:auto;">
						...
						<tr style="border-top:1px solid;border-color:black;height:18.5mm;">
							<td colspan="3" style="border-bottom:1px solid black;border-right:1px solid black;">
								<div class="styIRS8949LNDesc" style="width:80mm;padding-left:0mm;height:auto;padding-top:3mm;">
									...
									(subtract negative amounts). Enter each total here and include on your Schedule D, <b>line 1b</b> (if <b>Box A</b> or <b>Box G</b>  above is checked), <b>line 2</b> 
									(if <b>Box B</b> or <b>Box H</b> above is checked), or <b>line 3</b> (if <b>Box C</b> or <b>Box I</b> above is checked)
									<!--Dotted Line-->
							...
							<td class="styIRS8949TableCell" valign="top" style="width:45mm;padding-bottom:1mm;font-size: 6pt; text-align:right; border-bottom:1px solid black;border-right:1px solid black;">
								<xsl:call-template name="PopulateNegativeNumber">
			...
			<b>Note:</b> If you checked Box A or Box G above but the basis reported to the IRS was incorrect, enter in column (e) the basis as reported to the IRS, and enter an adjustment in column (g) to correct the basis. See <i>Column</i> (g) in the separate instructions for how to figure the amount of the adjustment.
				</div>
			</div>
	...
	<div style="width:187mm;">
		...
		<div class="styIRS8949LineItem" style="padding-top:0mm;padding-bottom:1.5mm;border-bottom:1px solid;border-top:1px solid;clear:all;height:18mm;">
			...
			<b>Long-Term.</b>  Transactions involving capital assets you held more than 1 year are generally long term (see instructions). For short-term transactions, see page 1. 
					<br/><b>Note:</b> You may aggregate all long-term transactions reported on Form(s) 1099-B and Form(s) 1099-DA showing basis was reported to the IRS and for which no adjustments or codes are required. Enter the totals directly on Schedule D, line 8a; you aren't required to report these transactions on Form 8949 (see instructions).
			</div>
		</div>
		<div class="styIRS8949LineItem" style="padding-bottom:2mm;height:10mm;">
			<b>You <i>must</i> check Box D, E, F, J, K, <i>or</i> L below. Check only one box.</b> If more than one box applies for your long-term transactions, complete a separate Form 8949, page 2, for each applicable box. If you have more long-term transactions than will fit on this page for one or more of the boxes, complete as many forms with the same box checked as you need.
		</div>
		<!-- END: Part I (Header)-->
		<!-- BEGIN: Part I (Body) -->
		<!-- ################################################################################# -->
			...
			<div class="styIRS8949LNDesc" style="width:187mm;">
				...
				<div style="width:182mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Long-term transactions reported on <b>Form(s) 1099-B</b> showing basis was reported to the IRS (see <b>
							Note</b> above)
				</label>
				</div>
			</div>
			<div class="styIRS8949LNDesc" style="width:187mm;">
				...
				<div style="width:182mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Long-term transactions reported on <b>Form(s) 1099-B</b> showing basis <b>wasn't</b> reported to the IRS
				</label>
				</div>
			</div>
			<div class="styIRS8949LNDesc" style="width:180mm;">
				...
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						</b> Long-term transactions, other than digital asset transactions, not reported to you on <b>Form 1099-B</b> or <b>Form 1099-DA</b>
				</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				...
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(J)</span>
						</b> Long-term transactions reported on <b>Form(s) 1099-DA</b> showing basis was reported to the IRS (see <b>
						Note</b> above)
					</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				...
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(K)</span>
						</b> Long-term transactions reported on <b>Form(s) 1099-DA</b> showing basis <b>wasn't</b> reported to the IRS
					</label>
				</div>
			</div>
			...
			<div class="styIRS8949LNDesc" style="width:180mm;">
				...
				<div style="width:160mm;padding-left:0.5mm;clear:none;float:left;">
					<label>
						...
						<b>
							<span style="font-size:8pt;width:6mm;padding-left:1mm;">(L)</span>
						</b> Long-term digital asset transactions not reported to you on <b>Form 1099-DA</b> or <b>Form 1099-B</b>
					</label>
				</div>
			</div>
			...
			<div class="styTableContainerNBB">
				...
				<table class="styTable" cellspacing="0" style="width:100%;">
					...
					<tr>
						<tr style="border-top:1px solid;border-color:black;height:18.5mm;">
							<td colspan="3" style="border-bottom:1px solid black;border-right:1px solid black;">
								<div class="styIRS8949LNDesc" style="width:77mm;padding-left:0mm;height:auto;padding-top:3mm;">
									<span class=""><b>2 Totals</b>. Add the amounts in columns (d), (e), (g), and (h)</span>
									<span style="padding-left:3mm;">(subtract negative amounts). Enter each total here and include on your Schedule D, <b>line 8b</b> (if <b>Box D</b> or <b>Box J</b> above is checked), <b>line 9</b> (if <b>Box E</b> or <b>Box K</b> above is checked), or <b>line 10</b> (if <b>Box F</b> or <b>Box L</b> above is checked) 
								<!--Dotted Line-->
									<!--<span style="font-weight:bold;letter-spacing:3mm;text-align:right;padding-left:3mm;padding-right:2px;">........</span>
									<img alt="Small Right Arrow Image" src="{$ImagePath}/8949_Bullet_Sm.gif" width="8" height="8"/> -->
									</span>
								</div>
							</td>
							<td class="styIRS8949TableCell" valign="top" style="width:30mm;padding-bottom:1mm;font-size: 6pt; text-align:right; border-bottom:1px solid black;border-right:1px solid black;">
							...
							<td class="styIRS8949TableCell" valign="top" style="width:60mm;padding-bottom:1mm;font-size: 6pt; text-align:right; border-bottom:1px solid black;border-right:1px solid black;">
								<xsl:call-template name="PopulateNegativeNumber">
									<xsl:with-param name="TargetNode" select="$NodeData/TotalCostOrOtherBasisAmt"/>
								</xsl:call-template>
							</td>
				...
				<div class="styGenericDiv" style="width:187mm;padding-top:0.5mm;padding-bottom:0.5mm;">
			<b>Note:</b> If you checked Box D or Box J above but the basis reported to the IRS was incorrect, enter in column (e) the basis as reported to the IRS, and enter an adjustment in column (g) to correct the basis. See <i>Column</i> (g) in the separate instructions for how to figure the amount of the adjustment.
				</div>
			</div>
			<!-- Set Initial Height of Above Table -->
			<xsl:call-template name="SetInitialDynamicTableHeight">
	...
	<xsl:template name="SetPageEndFooter">
		...
		<div class="pageEnd" style="width:187mm;padding-top:.5mm;padding-bottom:2mm;float:none;clear:both;border: black solid 0px;border-top-width:2px;">
			...
			<div style="float:right;">
				Form <span class="styBoldText" style="font-size:8pt;">8949</span> (2025)
			</div>
		</div>
	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			<span class="styBoldText" style="font-size:6.7pt;">File with your Schedule D to list your transactions for lines 1b, 2, 3, 8b, 9, and 10 of  Schedule D.</span> <br/>
									<span class="styBoldText">Go to
										<a href="http://www.irs.gov/form8949" title="Link to IRS.gov"><i>www.irs.gov/Form8949</i></a> for instructions and the latest information.
									</span>
									<br/>
									<!--<img src="{$ImagePath}/8949_Bullet_Sm.gif" alt="Small Right Arrow Image"/>
									<span style="width:3px;"/>-->
					...
					<div class="styGenericDiv" style="width:187mm;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;clear:all;">
						Before you check Box A, B, C, G, H, or I below, see whether you received any Form(s) 1099-B, Form(s) 1099-DA or substitute statement(s) from your broker.
						A substitute statement 	will have the same information as Form 1099-B or Form 1099-DA. They will show whether your basis (usually your cost) was reported to
					...
					<!-- End Names and Identifying number section -->
					<div class="styGenericDiv" style="width:187mm;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;clear:all;">
						Before you check Box D, E, F, J, K, or L below, see whether you received any Form(s) 1099-B, Form(s) 1099-DA, or substitute statement(s) from your broker. A substitute
						statement will have the same information as Form 1099-B or Form 1099-DA. They will show whether your basis (usually your cost) was reported to
						the IRS by your broker and may even tell you which box to check.
					</div>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;border:black solid 0px;border-top-width:2px;clear:all;">
						<div style="float:right;clear:all;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8949</span> (2025)
						</div>
					</div>
