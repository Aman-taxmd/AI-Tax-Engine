				...
				<form style="font-family:arial; font-size:9pt" name="Form8050">
					...
					<div class="styTBB" style="width:187mm">
						...
						<div class="styFTBox" style="width:125mm">
							...
							<div class="styFBT" style="margin-top:0mm; font-size:8pt">
								<!--<img src="{$ImagePath}/8050_Bullet.gif" alt="Arrow Bullet"/> -->
								Attach to Form 990-PF, 990-T, 1120-POL, or 4720.
							</div>
							<br/>
					...
					<div class="styBB" style="width:187mm; height:10mm;font-size:8pt;">
						<div class="styNameBox" style="width:137mm;">
							<div style="height:3mm;width:137mm;font-size:8pt">Name of filer (as shown on tax return)</div>
						...
						<div style="width:50mm; border-left-width:1px;float:right;padding-left:2mm; height:10mm;">
							<div style="font-weight:bold; padding-bottom:1mm">EIN </div>
							<span style="padding: 0 1mm 1mm;">or</span>
							<div style="font-weight:bold; padding-bottom:1mm">SSN</div>
					...
					<div style="width:187mm">
						<div style="float:right; font-size:7pt">
							...
							Form <b style="font-size:9pt">8050</b> (12-2025)
						</div>
					</div>
					<div class="pageEnd"/>
