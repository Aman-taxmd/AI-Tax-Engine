					...
					<div class="styBB" style="width:187mm;float:left;clear:left;border-bottom-width:1px;">
						...
						<div style="width:154mm;height:29mm;float:left;">
							<!-- return header address box -->
								...
								<div class="styNameAddr" style="border-bottom-width:0px;width:32mm;height:10.5mm;border-left-width:1px;">
								 Zip or foreign postal code<br/>
									<span class="stySmallText" style="width:32mm;padding-left:2mm;">
										<xsl:call-template name="PopulateReturnHeaderFiler">
				...
				<!--  Schedule J, Line 5f  -->
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:99mm;">Completed long&#8208;term contract look&#8208;back Interest due (attach Form 8697)
							     <span style="width:2px;"/>
									<!-- Form to Form Link -->
									<xsl:call-template name="SetFormLinkInline">
...
<span style="float:left;">adjustment, as described in the instructions, of $10 million or more?
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
							Form 1120, Page 3, Schedule J Line 6 - Section 8978 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TotalCreditAmt/@form8978Cd"/>
							<xsl:with-param name="DescWidth" select="300"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">
							Form 1120, Page 3, Schedule J Line 6 - Section 8978 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/TotalCreditAmt/@form8978Amt"/>
							<xsl:with-param name="DescWidth" select="300"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Page 3, Schedule J, Part I, Line 9b - Form 8693 Approval Date</xsl:with-param>
