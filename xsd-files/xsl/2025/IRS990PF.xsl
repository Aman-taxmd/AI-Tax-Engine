...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<xsl:if test="$RowCount &lt; 6">
			<tr>
				<td class="styLNLeftLtrBox">
					<xsl:if test="(count($FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp)=0) or 
					 ((count($FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp) &gt;5) and ($Print = $Separated))">
						<xsl:if test="$RowCount = 1">
							<xsl:attribute name="style">width: 8mm; border-color: black; border-style: solid; border-right-width: 0px;
							 border-left-width: 0px; border-top-width: 0px; border-bottom-width: 1px; padding-left: 5mm</xsl:attribute>1a
					</xsl:if>
						<xsl:if test="($RowCount != 1) and ($Print != $Separated)">
							<xsl:attribute name="style">width: 8mm; border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px;
							 border-top-width: 0px; border-bottom-width: 1px; padding-left: 7mm</xsl:attribute>
					...
					<xsl:if test="count($FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp)!=0 and $RowCount != 1">
						<xsl:attribute name="style">border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px; border-top-width: 0px;
						 border-bottom-width: 1px; padding-left: 5mm</xsl:attribute>
						<xsl:call-template name="GenerateLetter2">
							<xsl:with-param name="RowCount" select="$RowCount"/>
						</xsl:call-template>
					</xsl:if>
	...
	<xsl:template name="AdditionalRowsCapitalGains2">
		...
		<xsl:if test="$RowCount &lt;6">
			<tr>
				<td class="styLNLeftLtrBox" style="border-color: black; border-style: solid; border-right-width: 0px; border-left-width: 0px;
	...
	<xsl:template match="/">
				...
				<form name="IRS990PF">
					...
					<div class="styBB" style="width:187mm; height:24mm;">
						...
						<div class="styFTBox" style="width:124mm;height:24mm;padding-top: 1.5mm">
							...
							<div class="styFBT" style="font-size: 8pt; margin-top: 0px">or Section 4947(a)(1) Trust Treated
							 as Private Foundation</div>
							<div class="styFBT" style="font-size: 7pt; font-weight: normal; margin-top: 0px;
							 padding-top: 1mm">
								<span class="styBoldText">Do not enter social security numbers on this form as it may be
								 made public.
								</span>
								<br/>					
								<span class="styBoldText">Go to <a href="http://www.irs.gov/form990pf" 
								 style="color:black" title="Link to IRS.gov"><i>www.irs.gov/Form990PF</i></a> for 
						...
						<div class="styTYBox" style="width:29mm;height:24mm;">							
							...
							<div class="styTaxYear" style="padding-top: 1.5mm">20<span class="styTYColor">25</span>
							</div>
					...
					<div class="styComType" style="width:187mm; font-size: 8pt; padding-top: 1.5mm; padding-bottom:1.5mm">
						<div class="styBoldText" style="height:3mm;width:182mm;">
						  For calendar year 2025, or tax year beginning
							<span class="styIRS990PFUnderlinedText" style="float:none;text-align:left;width:12mm">
							...
							<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:4mm">
								<xsl:value-of select="substring($RtnHdrData/TaxPeriodEndDt,3,2)"/>
							</span>
						</div>
					</div>
					<div style="width:187mm;float:left;clear:left;">
						<div class="styLblNameAddr" style="width:122mm;height:30mm;border-left-width:0px;border-top-width:1px;
						 border-right-width:1px;
							...
							<div class="styNameAddr" style="width:122mm;height:10mm;">
								<span style="width: 93mm;vertical-align:top; ">
							...
							<!-- City or Town -->
							<div class="styNBB" style="width:116.5mm;">
								<div class="styNameBox" style="width:40mm;height:9mm;font-size:7pt;border-style:solid;
								...
								<!-- State or Province -->
								<div class="styNameBox" style="width:25mm;height:9mm;font-size:7pt;border-style:solid;
								...
								<!-- Country -->
								<div class="styNameBox" style="width:12mm;height:9mm;font-size:7pt;border-style:solid;
								 border-top-width:0px;border-left-width:0px; border-bottom-width:0px;
						...
						<div class="styEINDateAssets" style="width:65mm;height:10.9mm;border-top-width: 1px;">
					...
					<!-- This is section G start -->
						...
						<div class="styEINDateAssets" style="width:65mm;height:5mm;border-bottom-width: 0px; 
						 padding-top: 1.5mm">
							...
							<span style="float: right; ">
								...
								<input type="checkbox" alt="ForeignOrganizationIndicator" class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/ForeignOrganizationInd"/>
										<xsl:with-param name="BackupName">IRS990PFPFForeignOrganizationIndicator
										</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
						</div>						
						<span class="styEINDateAssets" style="width:65mm;height:5mm;border-bottom-width: 0px; float:right;
						 padding-top: 1mm">
							<span style="float: left; padding-left: 3mm"><b>2</b>. Foreign organizations meeting the 85%
							 <br/>
							...
							<span style="float: right; ">
								...
								<input type="checkbox" alt="ForeignOrgMeeting85PctTestIndicator" class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/ForeignOrgMeeting85PctTestInd"/>
										<xsl:with-param name="BackupName">ForeignOrgMeeting85PctTestIndcator</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
						</span>										
					...
					<div style="width: 187mm;">
						...
						<span style="width: 55mm; float: left; border-style: solid; border-left-width: 0px; 
						  border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px;padding-top:1mm;
						   height: 15mm">
						...
						<span style="width: 67mm; float: left; border-style: solid; border-left-width: 0px;
						 border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; height: 15mm;
						  padding-left: 2mm">
							...
							<span class="styIRS990PFUnderlinedText" style="width:27mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									 select="$FormData/MethodOfAccountingOtherInd/@methodOfAccountingOtherDesc"/>
								</xsl:call-template>
							</span>
							<br/>
					...
					<table class="styTable" style="font-size: 7pt; border-color:black; width: 187mm;clear:none;" cellspacing="0">
						...
						<tbody valign="top">
							...
							<tr>
								...
								<td class="styIRS990PFLNAmountBox" colspan="2" style="border-right-width:1px;
								 boder-bottom-width:1px; float:none; width: 29mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
				...
				<tr>					
					...
					<td class="styIRS990PFShadingCell" style="border-right-width:0px; float:none">
						<span class="styTableCellPad"/>
							...
							<tr>
								<td class="styLNLeftLtrBox" style="padding-left: 2mm;padding-top:1mm; width: 4mm">6a</td>
								<td class="styIRS990PFLNDesc" colspan="2" style="padding-top:1mm">Net gain or (loss) from sale of assets not on line
								 10</td>
								<td class="styIRS990PFFormLinkBox">
									<!--<span style="width:2px;"/>-->
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/AnalysisOfRevenueAndExpenses/NetGainSaleAstRevAndExpnssAmt"/>
										<xsl:with-param name="TabOrder" select="2"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFLNAmountBox" style="border-right-width:1px; border-left-width: 0px;padding-top:1.5mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/AnalysisOfRevenueAndExpenses/NetGainSaleAstRevAndExpnssAmt"/>
									</xsl:call-template>
							...
							<tr>
								...
								<td class="styIRS990PFLNDesc" colspan="2" style="font-size: 7pt; padding-top: 1mm">Gross 
								 sales price for all assets on line 6a 
								<span class="styIRS990PFUnderlinedText" style="font-size: 6pt; text-align: right; 
								 width:22mm; float:right">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/AnalysisOfRevenueAndExpenses/GrossSalesPriceAmt"/>
										</xsl:call-template>
									</span>
								</td>
							...
							<tr>
								...
								<td class="styLNAmountBox" style="height:4.5mm;font-size: 6pt; border-right-width:1px; border-left-width: 0px; width: 22mm;vertical-align:bottom;
								 padding-top:1.5mm">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								...
								<td class="styLNAmountBox" style="height:4.5mm;font-size: 6pt; border-right-width:1px; border-left-width: 0px; width: 22mm;
								 padding-top:1.5mm">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styLNLeftNumBox" style="padding-left: 2mm; width: 7mm; height:5mm; border-style: solid; border-color: black;
								 border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom: 1px solid black;
								 padding-top:.5mm">12</td>
					...
					<div style="width:187mm; float: none; clear: none">
						...
						<div style="float:right">Cat. No. 11289X 
							<span style="width:60px"/>
								Form <span class="styBoldText" style="font-size: 8pt">990-PF</span> (2025)
						</div>
					</div>
					<div class="pageEnd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 990-PF (2025)</div>
						<div style="float:right">
							Page <span class="styBoldText" style="font-size: 8pt">2</span>
						</div>
					</div>
					<!--END HEADER-->
					<div class="styTableContainerNBB" style="border-top-width: 1px; width: 187mm; 
					 height: auto">
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead style="font-size: 6pt">
								<tr scope="col">
									<th scope="col" class="styTableCellHeader" rowspan="2" colspan="2" style="height: 4mm;
									 width: 12mm; border-right-width: 0px">
										<span class="styPartName" style="width: 12mm; height:5mm">Part II</span>
									</th>
									<th scope="col" class="styTableCellHeader" rowspan="2" style="text-align: left; width: 
									 25mm; border-right-width: 0px">
									...
									<th scope="col" class="styTableCellHeader" colspan="2" style="width: 60mm; 
									 border-right-width: 0px">
										<span class="styNormalText">
										  End of year
										</span>
								...
								<tr>
									...
									<th scope="col" class="styTableCellHeader" style="width: 26mm;
									 border-right-width: 0px;">(c)
										<span class="styNormalText">
											  Fair Market Value
										</span>
									</th>
							...
							<tbody valign="top">
								...
								<tr>
									<td class="styIRS990VTImageBox" style="width: 4mm;border-style: solid;
								...
								<tr>
									...
									<td class="styLNAmountBoxSmall" style="border-right-width:1px; border-left-width: 0px; float:none">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/Form990PFBalanceSheetsGrp/TotNetAstOrFundBalancesEOYAmt"/>
										</xsl:call-template>
									</td>
									<td class="styShadingCellSmall"
									 style="border-left-width: 0px; border-right-width: 0px; float:none">
										<span class="styTableCellPad"/>
									</td>
								</tr>
								<tr>
									...
									<td class="styIRS990PFLNDesc" colspan="2" style="width: 94mm">
										<span style="float:left; clear: none">
											<span class="styBoldText">Total liabilities and net assets/fund balances </span>
											 (see instructions)</span>
										<span class="styDotLn" style="float:right">.</span>
									</td>
									<td class="styLNAmountBoxSmallNBB" style="border-left-width:0px; 
									 border-right-width: 1px;float:none">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/Form990PFBalanceSheetsGrp/TotalLiabilitiesNetAstBOYAmt"/>
										</xsl:call-template>
									</td>
									<td class="styLNAmountBoxSmallNBB" style="border-right-width:1px; 
									 border-left-width: 0px;float:none">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/Form990PFBalanceSheetsGrp/TotalLiabilitiesNetAstEOYAmt"/>
										</xsl:call-template>
									</td>
									<td class="styShadingCellSmall" style="border-left-width: 0px; 
									 border-right-width: 0px;float:none">
										<span class="styTableCellPad"/>
									</td>
								</tr>
							</tbody>
					...
					<div class="styTableContainer" style="width:187mm;height:auto;border-bottom-width:0px;" id="AthruDctn" >
						...
						<table class="styTable" style="font-size: 7pt;border-color:black;" cellspacing="0">
							<thead class="styTableThead">
								<tr scope="col">
									<th scope="col" class="styTableCellHeader" style="width: 113mm" colspan="2">
									  <span class="styNormalText"><b>(a) </b>List and describe the kind(s) of property sold
									   (e.g., real estate,<br/>
									  <span style="width: 4mm"/>2-story brick warehouse; or common stock, 200 shs. MLC
									   Co.)</span>
									</th>
							...
							<tfoot/>
							<tbody valign="top">
								<xsl:if test="($Print != $Separated) or (count($FormData/CapGainsLossTxInvstIncmDetail/
								 CapGainsLossTxInvstIncmGrp) &lt; 6)">
									<xsl:for-each select="$FormData/CapGainsLossTxInvstIncmDetail/
									CapGainsLossTxInvstIncmGrp">
										<tr>
											<td  style="width: 8mm;font-weight:bold; border-color: black; 
											 border-style: solid; border-right-width: 0px; border-left-width: 0px; 
											 border-top-width: 0px; border-bottom-width: 1px; padding-left: 5mm;">
												<xsl:if test="position()=1">
													<xsl:attribute name="style">width: 8mm;font-weight:bold; 
													 border-color: black; border-style: solid; border-right-width: 0px; 
													 border-left-width: 0px; border-top-width: 0px; 
													 border-bottom-width: 1px; padding-left: 3mm</xsl:attribute>1
											   </xsl:if>
					...
					<div class="styTableContainer" style="border-bottom: 0px solid black; border-top:0px solid black; width: 187mm; height:auto "><!--24mm-->
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							...
							<tbody valign="top">
								<tr>
									<td class="styLNLeftNumBox"  style="padding-left: 5mm; padding-top:0mm;">2</td>
									<td class="styTableCell" valign="bottom" style="text-align: left;float:none;
									 padding-left:2mm; width: 72mm; border-bottom-width: 0px; padding-bottom:1.5mm; 
									 border-right-width: 0px">Capital gain net income or (net capital loss)</td>
									<td class="styTableCell" style="width: 4mm; border-bottom-width: 0px; 
									 border-right-width: 0px; text-align: left">
								...
								<tr>
									...
									style="text-align: left; padding-left:2mm; width: 124.25mm; border-bottom-width: 0px;
									 border-right-width: 0px; ">
										If gain, also enter in Part I, line 8, column (c) (see instructions).  If (loss),
										 enter -0- <br/>
										in Part I, line 8 
										<span class="styDotLn" style="float:right">.........................</span>
									</td>
									<td class="styTableCell" style="width: 4mm; text-align:left; border-right-width:0px;
									 border-bottom-width: 0px">
										<img src="{$ImagePath}/990PF_Bracket_Small.gif" alt="Bracket"/>
									</td>
									<td class="styLNRightNumBox" style="width: 8mm; border-bottom-width: 1px;
									 height:auto;padding-top:3mm">3</td>
									<td class="styLNAmountBox" style="width: 41.5mm; border-bottom-width: 1px;height:auto;
									 padding-top: 3mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
					...
					<table class="styTable" style="font-size: 7pt; border-color:black;width:187mm" cellspacing="0">
						...
						<tbody valign="top">
									...
									<span style="font-size:7pt">
										<label>
											<xsl:call-template name="PopulateLabel">
												...
												<xsl:with-param name="BackupName">IRS990PFExemptOperatingFoundations
												</xsl:with-param>
											</xsl:call-template>
							...
							<tr>
								<td class="styLNLeftLtrBox" style="; width: 5mm"/>
								<td class="styTableCell" colspan="3" style="text-align: left; width: 136mm; 
								 border-bottom-width: 0px; border-right-width: 0px">
								...
								<td class="styLNAmountBox" style="width: 30mm">
									<xsl:choose>
										<xsl:when test="$FormData/ExciseTaxBasedOnInvstIncmGrp/
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" 
									style="padding-top: 1mm; text-align: left; width: 136mm; border-bottom-width: 0px; 
										border-right-width: 0px">
									<span style="font-size: 7pt; ">All other domestic foundations enter 1.39% (0.0139) of
									 line 27b. Exempt foreign organizations enter 4% (0.04) of Part I, line 12, col. (b)
									</span>
								</td>
								<td class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px;
								 height:7mm">
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" style="text-align: left; width: 140mm; 
								 border-bottom-width: 0px; border-right-width: 0px; font-size: 7pt">
									Tax under section 511 (domestic section 4947(a)(1) trusts and taxable foundations only.
									 Others enter -0-)
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode"
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/TaxUnderSection511Amt"/>
										<xsl:with-param name="TabOrder" select="2"/>
									</xsl:call-template>
								</td>
							...
							<tr>
								...
								<td class="styLNAmountBox" style="width: 30mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/SubtotalAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<!-- End Line 3  -->
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" style="text-align: left; width: 140mm;
								 border-bottom-width: 0px; border-right-width: 0px">
									<span >Subtitle A (income) tax (domestic section 4947(a)(1) trusts and taxable
									 foundations only. Others enter -0-)</span><!--style="font-size: 7pt"-->
								</td>
								<td class="styLNRightNumBox">4</td>
								<td class="styLNAmountBox" style="width: 30mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/SubtitleATaxAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<!-- End Line 4  -->
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" style="text-align: left; width: 140mm;
								 border-bottom-width: 0px;border-right-width: 0px">
									<span style="float: left; clear: none">
										<span class="styBoldText">Tax based on investment income. </span> Subtract line 4
										 from line 3. If zero or less, enter -0-
								...
								<td class="styLNAmountBox" style="width: 30mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/TaxBasedOnInvestmentIncomeAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<!-- End Line 5  -->
					...
					<table class="styTable" style="font-size: 7pt; border-color:black; width: 187mm" cellspacing="0">
						...
						<tbody valign="top">
							...
							<tr>
								...
								<td class="styTableCell" style="padding-left:3mm;text-align: left; width: 99mm; 
								 border-bottom-width: 0px; border-right-width: 0px">
									<span style="float: left; clear: none">Exempt foreign organizations—tax withheld at
									 source</span>
									<span class="styDotLn" style="float: right">......</span>
								</td>
								...
								<td class="styLNAmountBox" colspan="2" style="width: 36mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/ExemptFrgnOrgTaxWthldAtSrceAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px">
									<span style="width: 1px"/>
							...
							<tr>
								...
								<td class="styTableCell" style="padding-left:3mm;text-align: left; width: 99mm; 
								 border-bottom-width: 0px; border-right-width: 0px">
									<span style="float: left; clear: none">Tax paid with application for extension of time
									 to file (Form 8868)</span>
									 <span class="styDotLn" style="float: right">...</span>
								 </td>
								...
								<td class="styLNAmountBox" colspan="2" style="width: 36mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/ExtsnRequestIncomeTaxPaidAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px">
									<span style="width: 1px"/>
						...
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							...
							<tbody valign="top">
								<tr>
									...
									<td class="styTableCell" colspan="2" style="padding-left:3mm;text-align: left; 
									 width: 143mm; border-bottom-width: 0px; border-right-width: 0px">
										<span style="float: left; clear: none">Total credits and payments. Add lines 6a
										 through 6d</span>
										<span class="styDotLn">..............									
											<xsl:choose>
												<xsl:when 
												 test="$FormData/ExciseTaxBasedOnInvstIncmGrp/OriginalReturnTaxPaidAmt">
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">Part VI Line 7 - Tax Paid with the
														 Original Return</xsl:with-param>
														<xsl:with-param name="TargetNode" 
														 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/
												...
												<xsl:when 
												 test="$FormData/ExciseTaxBasedOnInvstIncmGrp/OriginalReturnOverpaymentAmt">
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">Part VI Line 7 - Original Return
														 Overpayment
														</xsl:with-param>
														<xsl:with-param name="TargetNode" 
														select="$FormData/ExciseTaxBasedOnInvstIncmGrp/
								...
								<tr>
									<td class="styLNLeftNumBox" style="padding-top:1.5mm;padding-left: 3mm; width: 5mm">8</td>
									<td class="styTableCell" colspan="2" style="padding-left:3mm;text-align: left; 
									 width: 134mm; border-bottom-width: 0px; border-right-width: 0px">
											Enter any <span class="styBoldText">penalty</span> for underpayment of estimated
											 tax. 
										<label>
											<xsl:call-template name="PopulateLabel">
												<xsl:with-param name="TargetNode" 
												select="$FormData/ExciseTaxBasedOnInvstIncmGrp/Form2221AttachedInd"/>
												<xsl:with-param name="BackupName">IRS990PFForm2221Attached</xsl:with-param>
											</xsl:call-template>
										</label> Check here
										<span style="width: 1mm"/>
									...
									<td class="styLNRightNumBox" style="height:5.7mm; padding-top:2mm">8</td>
									<td class="styLNAmountBox" style="width: 30mm; height:5.7mm;padding-top:2mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
								...
								<tr>
									...
									<td class="styTableCell" colspan="2" style="padding-left:3mm; text-align: left; 
									 width: 134mm; border-bottom-width: 0px; border-right-width: 0px">
										<span class="styBoldText">Tax due. </span> If the total of lines 5 and 8 is more 
										 than line 7, enter
										 <span class="styBoldText">amount owed</span>
										<span class="styDotLn" style="float:none; clear:none; 
										 padding-left: 1.25mm">.......</span>
									...
									<td class="styLNAmountBox" style="width: 30mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/TaxDueAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
									...
									<td class="styTableCell" colspan="2" style="padding-left:3mm; text-align: left; 
									 width: 134mm; border-bottom-width: 0px; border-right-width: 0px">
										<span class="styBoldText">Overpayment. </span> If line 7 is more than the total of
										 lines 5 and 8, enter the 
									...
									<td class="styLNAmountBox" style="width: 30mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/OverpaymentAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
									<td class="styLNLeftNumBox" style="width: 5mm">11</td>
									<td class="styTableCell" style="padding-left:3mm; text-align: left; width: 50mm; 
									 border-bottom-width: 0px; border-right-width: 0px;">
									    Enter the amount of line 10 to be: <span class="styBoldText" 
									    style="font-size:6pt;">Credited to 2026 estimated tax</span>
										<span style="width: 1mm"/>
										<span style="width: 1mm"/>
										<span class="styIRS990PFUnderlinedText" style="text-align: left; width: 20mm;
										 vertical-align:bottom;font-size:6pt;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/AppliedToESTaxAmt"/>
											</xsl:call-template>
										</span>
									</td>
									...
									<td class="styLNAmountBox" style="width: 30mm; border-bottom:0;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/RefundAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
								<td class="styLNLeftNumBox" style="width:5mm"></td>
									<td class="styTableCell" style="padding-left:3mm; text-align: left; width: 90mm; 
									 border-bottom-width: 0px; border-right-width: 0px;">
									 For Refunded amount, also complete and attach Form 8050. See instructions.
									</td>
									<td class="styBoldText" style="border:none; width: 18mm;">
										<span style="width: 6.25mm;float:left;"></span>
										<span style="padding-left:9mm;">
										</span>
									</td>
									<td class="styLNRightNumBox" style="border-bottom:0;background-color:lightgrey"></td>
									<td class="styLNAmountBox" style="width: 30mm; border-bottom:0;vertical-align:bottom;
					...
					<!--BEGIN FOOTER-->
					<div style="width:187mm; border-color: black; border-style:solid; border-bottom-width: 0px; 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						    During the tax year, did the foundation attempt to influence any national, state, or local
						     legislation or did
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
                           ...
                           <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							Did it spend more than $100 during the year (either directly or indirectly) for political
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="padding-left: 2mm; width: 155mm">
							<span class="styItalicText">
								If the answer is "Yes" to <span class="styBoldText">1a</span> or 
								<span class="styBoldText">1b,</span> attach a detailed description of the activities and
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="padding-left: 2mm; width: 155mm">
							<span class="styItalicText">published or distributed by the foundation in connection with the
							 activities.
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> Did the foundation file <span class="styBoldText">Form
							 1120-POL</span> for this year?</span>
							<span class="styDotLn">.....................</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActyGrp/Form1120POLFiledInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							...
							<span class="styIRS990PFUnderlinedText" style="text-align: right">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									 select="$FormData/StatementsRegardingActyGrp/Section4955OrganizationTaxAmt"/>
								</xsl:call-template>
							</span>
							<span style="width: 2mm"/>
							...
							<span class="styIRS990PFUnderlinedText" style="text-align: right">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									 select="$FormData/StatementsRegardingActyGrp/Section4955ManagersTaxAmt"/>
								</xsl:call-template>
							</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						  Enter the reimbursement (if any) paid by the foundation during the year for political expenditure
						   tax imposed
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						...
						<div class="styLNDesc" style="width: 155mm">
						   on foundation managers.<span style="width: 1mm"/>
							...
							<span class="styIRS990PFUnderlinedText" style="text-align: right">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
									 select="$FormData/StatementsRegardingActyGrp/TaxReimbursedAmt"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styLNRightNumBox" style="height: 4.5mm; background-color: lightgrey;
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">Has the foundation engaged in any activities that have
							 not previously been reported to the IRS?</span>
							<span class="styDotLn" style="float: right; clear: none">.......</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActyGrp/ActivitiesNotPreviouslyRptInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						  Has the foundation made any changes, not previously reported to the IRS, in its governing 
						  instrument, articles
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/ChangesToArticlesOrBylawsInd"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn" style="float: right; clear: none">....</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">Did the foundation have unrelated business gross income
							 of $1,000 or more during the year?</span>
							<span class="styDotLn">.........</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/UnrelatedBusIncmOverLimitInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">If "Yes," has it filed a tax return on 
							<span class="styBoldText">Form 990-T</span> for this year?</span>
							<span class="styDotLn">...................</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/Form990TFiledInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">Was there a liquidation, termination, dissolution, or
							 substantial contraction during the year?</span>
							<span class="styDotLn" style="float: right; clear: none">.........</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/OrganizationDissolvedEtcInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span class="styItalicText">If "Yes," attach the statement required by General Instruction T.
							</span>
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/OrganizationDissolvedEtcInd"/>
					...
					<div style="width: 187mm; padding-left: 8mm;">
						<div class="styLNDesc" style="width: 155mm">						
							<img src="{$ImagePath}/T_Bullet_Round.gif" alt="round bullet"/>
							By state legislation that effectively amends the governing instrument so that no mandatory
							 directions
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm padding-left: 8mm;">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/Section508eRqrSatisfiedInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm;">
						...
						<div class="styLNDesc" style="width: 155mm">
							  Enter the states to which the foundation reports or with which it is registered (see
							   instructions)
						</div>
   				     	<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px; "/> 
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px; "/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							If the answer is "Yes" to line 7, has the foundation furnished a copy of Form 990-PF to the
							 Attorney
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						  ...
						  <span class="styItalicText">If "No," attach explanation <span class="styBoldText">.</span>
							...
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/Form990PFFiledWithAttyGenInd"/>
								<xsl:with-param name="TabOrder" select="2"/>
							</xsl:call-template>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">Is the foundation claiming status as a private operating
							 foundation within the meaning of section 4942(j)(3)</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm">
						   or 4942(j)(5) for calendar year 2025 or the taxable year beginning in 2025?  See the instructions
						   for Part XIII.
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/PrivateOperatingFoundationInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<td class="styTableCell" colspan="2" style="text-align: left;  border-bottom-width: 0px; 
							...
							<span class="styItalicText" style="float:left">and addresses.
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/NewSubstantialContributorsInd"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>						
							<span class="styDotLn" style="float:right;clear: none">...............................</span> 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
							    ...
							    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/OwnControlledEntityInd"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
							  Did the foundation make a distribution to a donor advised fund over which the foundation or a
							  disqualified person had
							</span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">advisory privileges? If "Yes," attach statement. See 
							 instructions</span>
							    <xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/DonorAdvisedFundInd"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template> 
							<span class="styDotLn" style="float: right; clear: none">.................</span>
						</div>						
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						  Did the foundation comply with the public inspection requirements for its annual returns and
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/ComplyWithPublicInspRqrInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
						...
						<div class="styLNDesc" style="width: 179mm">
						  Website address<span style="width: 1mm"/>
							<span class="styIRS990PFUnderlinedText" style="width: 153mm">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/WebsiteAddressTxt"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
						...
						<div class="styLNDesc" style="width: 170mm" >
							...
							<span class="styIRS990PFUnderlinedText" style="width: 90mm; font-size:6pt">
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActyGrp/PersonsWithBooksName !=''">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											 select="$FormData/StatementsRegardingActyGrp/PersonsWithBooksName/
											 BusinessNameLine1Txt"/>
										</xsl:call-template>
										<xsl:if test="$FormData/StatementsRegardingActyGrp/PersonsWithBooksName/
							...
							<span class="styIRS990PFUnderlinedText" style="width: 22mm">
								<xsl:call-template name="PopulatePhoneNumber">
									<xsl:with-param name="TargetNode"
									 select="$FormData/StatementsRegardingActyGrp/PhoneNum"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
						  ...
						  Located at<span style="width: 1mm"/>
							<span class="styIRS990PFUnderlinedText" style="width: 121mm; font-size: 6pt">
								<xsl:if test="count($FormData/StatementsRegardingActyGrp/LocationOfBooksUSAddress) &gt;0">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode"
										 select="$FormData/StatementsRegardingActyGrp/LocationOfBooksUSAddress/
										 AddressLine1Txt"/>
									</xsl:call-template>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksUSAddress/
									AddressLine2Txt != ''">
										<span style="width: 6px"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksUSAddress/AddressLine2Txt"/>
										</xsl:call-template>
									</xsl:if>
									...
									!= ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											 select="$FormData/StatementsRegardingActyGrp/LocationOfBooksUSAddress/CityNm"/>
										</xsl:call-template>
									</xsl:if>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksUSAddress/
									StateAbbreviationCd != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksUSAddress/StateAbbreviationCd"/>
										</xsl:call-template>
									</xsl:if>
								</xsl:if>
								<xsl:if test="count($FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress)
								 &gt;0">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
										LocationOfBooksForeignAddress/AddressLine1Txt"/>
									</xsl:call-template>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress/
									AddressLine2Txt != ''">
										<span style="width: 6px"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksForeignAddress/AddressLine2Txt"/>
										</xsl:call-template>
									</xsl:if>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress/
									CityNm != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksForeignAddress/CityNm"/>
										</xsl:call-template>
									</xsl:if>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress/
									ProvinceOrStateNm != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
											select="$FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress/
											ProvinceOrStateNm"/>
										</xsl:call-template>
									</xsl:if>
									<xsl:if test="$FormData/StatementsRegardingActyGrp/LocationOfBooksForeignAddress/
									CountryCd != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksForeignAddress/CountryCd"/>
										</xsl:call-template>
									</xsl:if>
								</xsl:if>
							</span>
							...
							<span class="styIRS990PFUnderlinedText" style="width: 28mm">
								<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/StatementsRegardingActyGrp/
											LocationOfBooksForeignAddress/ForeignPostalCd"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
							</span>
					...
					<div style="width: 187mm;padding-bottom:1mm" >
						...
						<div class="styLNDesc" style="width: 179mm">
							<span style="float:left; clear: none"> Section 4947(a)(1) nonexempt charitable trusts filing
							 Form 990-PF in lieu of <b>Form 1041</b> —check here
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode"
										 select="$FormData/StatementsRegardingActyGrp/NECTFilingInLieuOFForm1041Ind"/>
										<xsl:with-param name="BackupName">IRS990PFNECTFilingInLieuOFForm1041
										</xsl:with-param>
									</xsl:call-template> 
								</label>
										<span class="styDotLn" style="float: none; clear: none">.........</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">and enter the amount of tax-exempt interest received or
						...
						<div class="styLNAmountBox" style="">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/StatementsRegardingActyGrp/TaxExemptInterestAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!--  Line 15  -->
					...
					<span style="float:left;">
						...
						<span class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
								At any time during calendar year 2025, did the foundation have an interest in or a signature
								or other authority over
							</span></span>
						<span style="float:right;">
						<span class="styLNRightNumBox" style="border-left-width:0px;border-bottom-width:1px;"/>
					...
					<div class="styBB" style="width: 187mm;padding-top:0mm;">
						...
						<div style="width: 187mm;">
						    <span style="float:right;">
						    <span class="styLNRightNumBox" style="height:7mm;background-color: lightgrey; 
						     border-bottom-width: 0px;"/>
						<span class="styLNRightNumBox" style="height:7mm;background-color:lightgrey; 
						...
						<span class="styLNRightNumBox" style="height:7mm;background-color:lightgrey; 
						 border-bottom-width:0px;"/>
							...
							<span class="styLNDesc" style="width: 155mm">
								<span style="float: left; clear: none">
										See the instructions for exceptions and filing requirements for FinCEN Form 114.  If
										 "Yes", enter the name of the foreign 
										<br/>country
									<span style="width: 2mm"/>
					...
					<!--BEGIN HEADER-->
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 990-PF (2025)
						</div>
						<div style="float:right">
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span class="styBoldText">File Form 4720 if any item is checked in the "Yes" column, unless an
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActy4720Grp/TransferAstDisqualifiedPrsnInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActy4720Grp/PaymentToGovernmentOfficialInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If any answer is "Yes" to 1a(1)–(6), did <span class="styBoldText">any </span> of the acts 
								 fail to qualify under the exceptions described in Regulations
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActy4720Grp/ActsFailToQlfyAsExceptionsInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
							...
							<span style="float: right; clear:none; padding-right: 6.25mm">
								<input type="checkbox" alt="RelyingCurrNoticeDisasterAsst1" class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										...
										<xsl:with-param name="BackupName">IRS990PFRelyingCurrNoticeDisasterAsst1
										</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
							 Did the foundation engage in a prior year in any of the acts described in 1a, other than
							 excepted acts,
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 At the end of tax year 2025, did the foundation have any undistributed income (Part XII, 
								 lines 6d
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 and 6e) for tax year(s) beginning before 2025?<span class="styDotLn" 
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY1Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
										 style="width: 6mm"/>
									</xsl:otherwise>
								</xsl:choose>
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY2Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY3Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:4mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY4Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 (relating to incorrect valuation of assets) to the year’s undistributed income? (If 
								 applying section 4942(a)(2)
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If the provisions of section 4942(a)(2) are being applied to <b>any</b> of the years listed
								 in 2a, list the years here.
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr1Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr2Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr3Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
								...
								<xsl:choose>
									...
									!= ''">20
										<span class="styIRS990PFUnderlinedText" style="float:none;text-align:top;width:3mm">
											<xsl:value-of select="substring($FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr4Yr,3,2)"/>
										</span>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 ...
								 bequest; or <span class="styBoldText">(3)</span>
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 ...
								 (Use Form 4720, Schedule C, to determine
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span>if the foundation had excess business holdings in 2025.)</span>
							<span class="styDotLn" style="float:right;">.....................</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								Did the foundation invest during the year any amount in a manner that would jeopardize its 
								charitable purposes?
							</span>
						</div>
						<div class="styLNRightNumBox">4a</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 Did the foundation make any investment in a prior year (but after December 31, 1969) that
					...
					<div style="width: 187mm" class="styBB">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 charitable purpose that had not been removed from jeopardy before the first day of the tax 
        ...
        <span class="styNormalText">
          Compensation
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Total</span> (add lines 1a, 1b, and 1c)</span>
							<span class="styDotLn">.......................</span>
						</div>
						<div class="styLNRightNumBox">1d</div>
						<div class="styLNAmountBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Minimum investment return. </span> Enter 5% (0.05) of line 5
								</span>
							<span class="styDotLn">................</span>
						</div>
					...
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						...
						<div class="styPartDesc" style="height:auto; font-size:7pt; font-weight:normal; padding-top:0mm;">
							...
							</label> (see instructions) (Section 4942(j)(3) and (j)(5) private operating foundations and 
							 certain foreign organizations check here
								<span style="width: 2mm"/>
								<input type="checkbox" alt="Section 4942(j)(3) and (j)(5) and do not complete this part" 
								  class="styIRS990PFCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/DistributableAmountGrp/
										  Sect4942j3j5FndtnAndFrgnOrgInd"/>
										<xsl:with-param name="BackupName">IRS990PFSect4942j3j5FndtnAndFrgnOrg
										</xsl:with-param>
									</xsl:call-template>
								</input> 
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/MinimumInvestmentReturnAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 99mm">
							<span style="float:left; clear: none">Tax on investment income for 2025 from Part V, line 5
							</span>
							<span class="styDotLn">.......</span>
						</div>
						<div class="styLNRightNumBox">2a</div>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox">b</div>
						<div class="styLNDesc" style="width: 99mm">
							<span style="float:left; clear: none">Income tax for 2025. (This does not include the tax from
							 Part V.)
							</span>
							<span class="styDotLn">...</span>
						</div>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">3</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Distributable amount before adjustments. Subtract line 2c
							 from line 1</span>
							<span class="styDotLn">............</span>
						</div>
						<div class="styLNRightNumBox">3</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/DistributableBeforeAdjAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3  -->
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">4</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Recoveries of amounts treated as qualifying 
							 distributions</span>
							<span class="styDotLn">................</span>
						</div>
						<div class="styLNRightNumBox">4</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/RecoveriesQualfiedDistriAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 4  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/DistributableBeforeDedAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 5  -->
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">6</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Deduction from distributable amount (see instructions)
							</span>
							<span class="styDotLn">.................</span>
						</div>
						<div class="styLNRightNumBox">6</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/DeductionFromDistributableAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 6  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Distributable amount </span> as adjusted. Subtract line 6 from
								 line 5. Enter here and on Part XII, line 1  
							</span>
							<span class="styDotLn">...</span>
						</div>
						...
						<div class="styLNAmountBox" style="border-bottom-width: 0px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/DistributableAsAdjustedAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 7 -->
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">1</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Amounts paid (including administrative expenses) to
							 accomplish charitable, etc., purposes:</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px;
						 height: 4.5mm"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px; height: 4.5mm"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox">a</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Expenses, contributions, gifts, etc.—total from Part I,
							 line 26, column (d)								
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">2</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Amounts paid to acquire assets used (or held for use)
							 directly in carrying out charitable, etc.,</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/PFQualifyingDistributionsGrp/CharitableAssetsAcquisPaidAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 2 -->
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">3</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Amounts set aside for specific charitable projects that
							 satisfy the:</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px; 
							height: 4.5mm"/>
					...
					<div class="styBB" style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Qualifying distributions. </span> Add lines 1a through 3b. Enter
								 here and on Part XII, line 4.
								</span>
							<span class="styDotLn">.......</span>
						</div>
						...
						<div class="styLNAmountBox" style="border-bottom:0px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/PFQualifyingDistributionsGrp/QualifyingDistributionsAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 4  -->
					...
					<div class="styTableContainer" style="border-top-width: 1px; width: 187mm; height: 100%">
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead>
								<tr scope="col">
									<th scope="col" class="styTableCellHeader" colspan="2" 
									style="width: 75mm; border-bottom-width: 0px; border-left-width: 0px; 
									...
									<th scope="col" class="styTableCellHeader" style="width: 28mm">
									    (b)<br/>
										<span class="styNormalText">Years prior to 2024</span>
									</th>
									<th scope="col" class="styTableCellHeader" style="width: 28mm">
									    (c)<br/>
										<span class="styNormalText">2024</span>
									</th>
									<th scope="col" class="styTableCellHeader" style="width: 28mm; border-right-width: 0px">
									    (d)<br/>
										<span class="styNormalText">2025</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody valign="top">
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; border-right-width:0px; 
									 font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1.5mm"/>
										    Enter amount for 2024 only<span class="styDotLn" style="float:none;
										     clear:none">.......
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
								...
								<tr>
									<td class="styTableCell" 
										...
										<xsl:choose>
											...
											<xsl:otherwise>
												<span style="width: 2mm"/>20
												<span class="styIRS990PFUnderlinedText" style="width: 5mm"/>
											</xsl:otherwise>
										</xsl:choose>
										<span style="width: 1mm"/>,
										<xsl:choose>
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; 
										...
										<span style="width: 1.5mm"/>
										    From 2022<span class="styDotLn" style="float:none; clear:none">......</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px;
									 border-left-width: 0px; 
										...
										<span style="width: 1.5mm"/>
										    From 2023<span class="styDotLn" style="float:none; clear:none">......</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px;
									 border-left-width: 0px; 
										...
										<span style="width: 1.5mm"/>
										    From 2024<span class="styDotLn" style="float:none; clear:none">......</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 2mm"/>Qualifying distributions for 2025 from Part</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
									  border-bottom-width: 0px">
										<span class="styTableCellPad"/>
									</td>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Applied to 2024, but not more than line 2a</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/AppliedToYear1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey;
									 border-right-width:0px">
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    ...
										    <br/>
										<span style="width: 5.5mm"/>(Election required—see instructions)
										<span class="styDotLn" style="float:none; clear:none">.....
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
									...
									<td class="styTableCellSmall" style="width: 28mm;  font-size: 6pt"> 
										<span style="padding-right: 4mm">
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode"
												 select="$FormData/UndistributedIncomeGrp/AppliedToPriorYearsAmt"/>
												<xsl:with-param name="TabOrder" select="2"/>
											</xsl:call-template>
										</span>
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
									 border-top-width: 0px; width: 75mm" colspan="2">
										...
										<span style="width: 6mm"/>required—see instructions)
										<span class="styDotLn" style="float:none; clear:none">........
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm;  font-size: 6pt"> 
										<span style="padding-right: 4mm">
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode"
												 select="$FormData/UndistributedIncomeGrp/TreatedAsDistriFromCorpusAmt"/>
												<xsl:with-param name="TabOrder" select="2"/>
											</xsl:call-template>
										</span>
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Applied to 2025 distributable amount<span class="styDotLn" 
									...
									<td class="styTableCellSmall" style="width: 28mm; border-right-width:0p;
									 font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/UndistributedIncomeGrp/
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
										 border-top-width: 0px;
										  width: 75mm" colspan="2">
										<span style="padding-left: 6mm">(If an amount appears in
										 column (d), the
										 <br/>
											<span style="width: 6mm"/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/TotalCorpusAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/PriorYearUndistributedIncmAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 5.5mm"/>
										    tax has been previously assessed<span class="styDotLn" 
										    style="float:none; clear:none">......
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 9mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/UndistributedIncomeGrp/PriorYearDeficiencyOrTaxAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/Taxable1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Undistributed income for 2024. Subtract line<br/>
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/Taxable2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey;
									 border-right-width:0px">
								...
								<tr>
									...
									style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
									 border-top-width: 0px; 
									  width: 75mm" colspan="2">
										...
										<span style="width: 1mm"/>
										    Undistributed income for 2025. Subtract<br/>
										<span style="width: 5.5mm"/>lines 4d and 5 from line 1. This amount must
										    <br/>
										<span style="width: 5.5mm"/>be distributed in 2026
										    <span class="styDotLn" style="float:none; clear:none">..........
										    </span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
									...
									<td class="styTableCellSmall" style="width: 28mm; border-right-width:0px;
									 padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/UndistributedIncomeCYAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<!-- End Line 6f -->
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px;
									 border-left-width: 0px; border-top-width: 0px; width: 75mm" colspan="2">
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 9mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/CorpusDistri170b1EOr4942g3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 2mm"/>Excess distributions carryover from 2020 not
										    <br/>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 2mm"/>Excess distributions carryover to 2026.
										</span>
										<br/>
									...
									<td class="styTableCellSmall" style="width: 28mm; padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/ExcessDistriCyovToNextYrAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; border-bottom-width:0px;
									 font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/UndistributedIncomeGrp/ExcessFromCurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
									  border-bottom-width:0px">
					...
					<div style="width: 187mm">
						<div class="styLNDesc" style="text-align:left; width: 131mm">
							...
							<span style="width: 2mm"/>
							     If the foundation has received a ruling or determination letter that it is a private
							      operating<br/>
							<span style="width: 6mm"/>
						...
						<div class="styLNAmountBox" style="width: 56mm; border-right-width: 0px; height: 6mm;
						 padding-top: 2mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
						...
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							...
							<tbody valign="top">
								...
								<tr>	
									...
									<td class="styTableCellSmall" style="text-align: center; border-top-width: 1px">
									 Tax year</td>
									<td class="styTableCellSmall" colspan="3" style="text-align: center;
									 border-top-width:1px; 
										width: 75mm">Prior 3 years
									</td>
									<td class="styTableCellSmall" rowspan="2" 
										style="text-align: center; border-top-width: 1px; border-right-width: 0px;
										 padding-top: 2mm">
								...
								<tr>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(a)</span> 2025</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(b)</span> 2024</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(c)</span> 2023</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(d)</span> 2022
										</td>
								</tr>
								<tr>
									...
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/
												LessorAdjNetIncmMinInvstRetGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/
												LessorAdjNetIncmMinInvstRetGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/
												LessorAdjNetIncmMinInvstRetGrp/Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/
												LessorAdjNetIncmMinInvstRetGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<!-- End Line 2a -->
								...
								<!-- Line 3 -->
									<td class="styTableCellSmall" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 62mm">
										<span class="styBoldText">3</span>
										<span style="width: 2mm"/>
											Complete 3a, 3b, or 3c for the<br/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="border-bottom-width: 0px; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/PrivateOperatingFoundationsGrp/GrossInvestmentIncomeGrp/
											 Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; border-bottom-width: 0px;
									 font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/PrivateOperatingFoundationsGrp/GrossInvestmentIncomeGrp/
									...
									<tr>
										<td class="styBB" style="float:none;width: 187mm; padding-left: 6mm;
										 border-bottom-width: 0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode"
												 select="$FormData/SupplementaryInformationGrp/ShareholderManagerNm"/>
											</xsl:call-template>
										</td>
									</tr>
								</xsl:if>
					...
					<div style="text-align:left; width: 187mm; padding-bottom:1mm">
						<span class="styBoldText">2</span>
						<span style="width: 4.5mm"/>
						<span class="styBoldText">Information Regarding Contribution, Grant, Gift, Loan, Scholarship, etc., 
						 Programs:
						</span>
					</div>
					<div class="styBB" style="text-align:left; width: 187mm; padding-bottom:1.5mm">
						<span style="width: 6mm"/>Check here 
						<input type="checkbox" alt="Only makes contributions to preselected charitable organizations"
						 class="styIRS990PFCkBox">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/SupplementaryInformationGrp/
						...
						<label>
							<xsl:call-template name="PopulateLabel">
							   ...
							   if the foundation only makes contributions to preselected charitable organizations and does 
							   not accept<br/>
							<span style="width: 6mm"/>
								unsolicited requests for funds. If the foundation makes gifts, grants, etc. to individuals
								or organizations under<br/>
							<span style="width: 6mm"/>
					...
					<div class="styGenericDiv" style="float:none;clear:both;width:187mm">
						<div style="float:right">
							<xsl:call-template name="SetTableToggleButton">
								<xsl:with-param name="TargetNode"
								 select="$FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp"/>
								<xsl:with-param name="containerHeight" select="1"/>
						...
						<table class="styTable" style="font-size: 7pt">
							<tbody>
								<xsl:if test="($Print != $Separated) or
								 (count($FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp) &lt;2)">
									<xsl:for-each
									 select="$FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp">
										<tr>
											<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
											 border-top-width: 0px; width: 187mm">
												<span class="styBoldText" style="padding-left:2mm">a</span>
												<span style="width: 2mm"/>The name, address, and telephone number or e-mail
												 address of the person to whom applications should be addressed:</td>
										</tr>
										<tr>
											<td class="styBB" style="width: 187mm; padding-left: 6mm">
												...
												<xsl:if test="count(RecipientEmailAddressTxt) &gt;0">
													...
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode"
														 select="RecipientEmailAddressTxt"/>
													</xsl:call-template>
												</xsl:if>												
											</td>
										</tr>
										...
										<tr>
											<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
											 border-top-width: 0px">
												<span class="styBoldText" style="padding-left:2mm">b</span>
												<span style="width: 2mm"/>The form in which applications should be submitted
												 and information and materials they should 
													include:</td>
										</tr>
										<tr>
											<td class="styBB" style="width: 187mm; padding-left: 6mm">
										...
										<tr>
											<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
											 border-top-width: 0px; width: 187mm">
												...
												<span style="width: 2mm"/>Any restrictions or limitations on awards, such as
												 by geographical areas, charitable fields, kinds of institutions, or
												 other<br/>
								...
								<xsl:if test="(count($FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp)=0)
								 or (($Print = $Separated) and 
									...
									<tr>
										<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
										 border-top-width: 0px; width: 187mm">
											<span class="styBoldText" style="padding-left:2mm">a</span>
											<span style="width: 2mm"/>The name, address, and telephone number or email 
											 address of the person to whom applications should be addressed:
										</td>
									</tr>
									<tr>
					...
					<div style="width:187mm;border-top-width: 1px;float:none;clear:both;" class="styBB">
						<div class="styPartName">Part XIV</div>
						<div class="styPartDesc" style="width: 160mm">
							<b>Supplementary Information</b> (continued)
						</div>
					<!--  Part XV-A  -->
					<!--<div style="width:187mm;border-top-width: 1px; float: none; clear:both" class="styBB">
					...
					<table class="styTable" style="width:187mm;font-size: 7pt; border-color:black" cellspacing="0">
						<thead>
							<tr>
								<th scope="col" class="styTableCellHeader" style="border-bottom-width: 0px; height: 4mm; 
								 width: 71mm; text-align:left">
									<span style="width:8mm"/>
									<span class="styNormalText" style="text-align:left;width:70mm;height:4mm;font-size:7pt">
								...
								<th scope="col" class="styTableCellHeader" rowspan="2" style="height: 4mm; width: 25mm; 
								 border-right-width: 0px">(e)<br/>
									<span class="styNormalText"> Related or exempt<br/>  function income<br/>
									  (See instructions.)          
									</span>
								</th>
							</tr>
							<tr>
								<th scope="col" class="styTableCellHeader" style="height: 4mm; width: 71mm; 
								 border-bottom-width: 0px; text-align: left; padding-top: 3mm">
						...
						<tfoot/>
						<tbody valign="top">
							<xsl:if test="(count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &gt;0 	
							 and ($Print != $Separated)) or
							 (($Print = $Separated) and 
							 (count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &lt;7))">
								<xsl:for-each select="$FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl">
									<tr>
										<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; 
										 border-left-width: 0px; border-top-width: 0px; width: 71mm">
										<span style="vertical-align:top;">
											...
											<span style="width: 1mm"/>
											<span class="styIRS990PFUnderlinedText" style="font-size: 6pt; width: 61mm; 
											 float:right">
												<xsl:call-template name="PopulateText">
										...
										<td class="styTableCellSmall" style="font-size: 6pt; width: 20mm; 
										...
										<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px; 
										 width: 25mm;vertical-align:bottom;">
											<xsl:call-template name="PopulateAmount">
							...
							<xsl:if test="(count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &lt;7)">
								<xsl:call-template name="RowsAtoF">
									<xsl:with-param name="RowCount" 
									 select="count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) + 1"/>
									<xsl:with-param name="Letters" select="7"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="(($Print = $Separated) and 
							 (count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &gt;6))"><tr>
									<td class="styTableCell" style="width: 71mm; border-bottom-width: 0px; 
									 text-align: left">
										<!--<span class="styBoldText">1</span>
										<span style="width: 1mm"/>
											Other revenue:  <br/>-->
										...
										<span style="width: 1mm"/>
										<span class="styIRS990PFUnderlinedText" style="width: 53mm; font-size: 6pt">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" 
												select="$FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl"/>
											</xsl:call-template>
											<span style="width: 1px"/>
										</span>
									</td>
							...
							<xsl:if test="(($Print=$Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/
							 ProgramServiceRevenueDtl) &gt;5))">
								<xsl:call-template name="RowsAtoF">
							...
							<tr>
								...
								<td class="styTableCellSmall" style="font-size: 6pt; width: 20mm; text-align: center">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/AnalysisIncomeProducingActyGrp/FeesContractsFromGovtAgGrp/
										  BusinessCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 FeesContractsFromGovtAgGrp/UnrelatedBusinessTaxblIncmAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm; text-align: center">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 FeesContractsFromGovtAgGrp/ExclusionCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 FeesContractsFromGovtAgGrp/ExclusionAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px; width: 25mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 FeesContractsFromGovtAgGrp/RelatedOrExemptFunctionIncmAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="styTableCellSmall" style="font-size: 6pt; width: 20mm; text-align: center;
								 vertical-align:bottom;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/AnalysisIncomeProducingActyGrp/MembershipDuesAndAssmntGrp/
										  BusinessCd"/>
									</xsl:call-template>
								</td>
							...
							<tr>
								...
								<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px; width: 25mm; vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 GrossProfitLossSlsOfInvntryGrp/RelatedOrExemptFunctionIncmAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<xsl:if test="(($Print!=$Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/
							 OtherRevenueDescribedGrp) &gt;0)) or (($Print=$Separated) and 
							 (count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) &lt;6))">
									...
									<xsl:if test="position()=1">									
										<tr>
											<td class="styTableCell" style="width: 71mm; border-bottom-width: 0px;
											 text-align: left;">
												...
												<span class="styBoldText" style="float;left; padding-left: 4.5mm;
												 vertical-align:top">
										...
										<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;
										 vertical-align:bottom;">
												<xsl:call-template name="PopulateAmount">
														<xsl:with-param name="TargetNode"
														 select="UnrelatedBusinessTaxblIncmAmt"/>
												</xsl:call-template>
											</td>
										<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;
										 text-align: center; vertical-align:bottom;">
										...
										<tr>
											...
											<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px;
											 width: 25mm; vertical-align:bottom;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode"
													 select="RelatedOrExemptFunctionIncmAmt"/>
												</xsl:call-template>
											</td>
										</tr>
									</xsl:if>
							...
							<xsl:if test="(count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) &lt;1)
							 or (($Print=$Separated) and 
							 (count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) &gt;5))">
								<tr>
									<td class="styTableCell" style="width: 71mm; border-bottom-width: 0px; 
									 text-align: left">
										<span class="styBoldText">11</span>
										...
										<span class="styIRS990PFUnderlinedText" style="width: 53mm; font-size: 6pt">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" 
												select="$FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp"/>
											</xsl:call-template>
											<span style="width: 1px"/>
										</span>
									</td>
								...
								<xsl:call-template name="RowsAtoF">
									<xsl:with-param name="RowCount" select="count($FormData/AnalysisIncomeProducingActyGrp/
									 OtherRevenueDescribedGrp) + 2"/>
									<xsl:with-param name="Letters" select="6"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="(($Print=$Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/
							 OtherRevenueDescribedGrp) &gt;5))">
								<xsl:call-template name="RowsAtoF">
									<xsl:with-param name="RowCount" select="2"/>
									<xsl:with-param name="Letters" select="6"/>
								</xsl:call-template>
							...
							<xsl:if test="count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) &lt;6">
								<xsl:if test="count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp)
								 != 0">
									<xsl:call-template name="RowsAtoF">
										<xsl:with-param name="RowCount" 
										select="count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) +
										 1"/>
										<xsl:with-param name="Letters" select="6"/>
									</xsl:call-template>
								</xsl:if>
							...
							<tr>
								...
								<td class="styTableCellSmall" style="width: 25mm; font-size: 6pt; vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/
										 SubtotalsIncmProducingActyGrp/UnrelatedBusinessTaxblIncmAmt"/>
									</xsl:call-template>
								</td>
								...
								<td class="styTableCellSmall" style="width: 25mm; font-size: 6pt; vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisIncomeProducingActyGrp/SubtotalsIncmProducingActyGrp/
										 ExclusionAmt"/>
									</xsl:call-template>
								</td>
					...
					<div>
						<div class="styGenericDiv" style="width: 137mm">
							...
							<span class="styBoldText">Total. </span> 
							    Add line 12, columns (b), (d), and (e)<span class="styDotLn" style="float: none;
							     clear: none">..................</span>
						</div>
				...
				<table class="styTable" cellspacing="0" style="width:176mm;font-size:7pt;">
					...
					<td rowspan="1" colspan="4" style="border-bottom:1px solid black;border-right:1px solid black;
					  padding-left:.5mm;">Firm's name
						<!--<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Right Arrow"/>-->
						<span style="width:2mm"/>
				...
				<!--row 3-->
					...
					<xsl:choose>
						<xsl:when test="$FormData/ExciseTaxBasedOnInvstIncmGrp/OriginalReturnTaxPaidAmt">
							<xsl:call-template name="PopulateLeftoverRowAmount">
								<xsl:with-param name="Desc">Part V Line 7 - Tax Paid with the Original Return</xsl:with-param>
						...
						<xsl:when test="$FormData/ExciseTaxBasedOnInvstIncmGrp/OriginalReturnOverpaymentAmt">
							<xsl:call-template name="PopulateLeftoverRowAmount">
								<xsl:with-param name="Desc">Part V Line 7 - Original Return Overpayment</xsl:with-param>
					...
					<!-- END Left Over Table -->
					<xsl:if test="($Print = $Separated) and 
					 (count($FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp) &gt; 5)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part IV - Capital Gains and Losses for Tax on 
						 Investment Income - Columns a - d
						</span>
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="width: 113mm" colspan="2">
									    (a) 
									    <span class="styNormalText"> List and describe the kind(s) of property sold 
									     (e.g., real estate,<br/>2-story brick warehouse; or common stock, 200 shs. MLC
									      Co.)
									    </span>
									</th>
							...
							<tbody valign="bottom">
								<xsl:for-each select="$FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp">
									<tr>
										...
										<td class="styDepTblCell" style="width: 8mm; border-color: black; 
										 border-style: solid; border-right-width: 0px; border-left-width: 0px; 
										 border-top-width: 0px; border-bottom-width: 1px; padding-left: 5mm">
											<xsl:if test="position()=1">
												<xsl:attribute name="style">width: 9mm; border-color: black; 
												 border-style: solid; border-right-width: 0px; border-left-width: 0px;
										...
										<td class="styDepTblCell" style="width:105mm;text-align:left;
										 border-left-width: 0px">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="PropertyDesc"/>
											</xsl:call-template>
										...
										<td class="styDepTblCell" style="width: 25mm; border-right-width:0px; 
										 text-align: center">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="SoldDt"/>
											</xsl:call-template>
					...
					<xsl:if test="($Print = $Separated) and 
					 (count($FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp) &gt; 5)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part IV - Capital Gains and Losses for Tax on 
						 Investment Income - Columns e - h
						</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="width: 39mm;padding-left: 2mm" colspan="2">
										(e) <span class="styNormalText">Gross sales price
											</span>
									</th>
									<th scope="col" class="styDepTblCell" style="width: 45mm">
										(f) <span class="styNormalText">Depreciation allowed<br/>(or allowable)
											</span>
									</th>
									<th scope="col" class="styDepTblCell" style="width: 45mm">
										(g) <span class="styNormalText">Cost or other basis<br/>plus expense of sale
											</span>
									</th>
									<th scope="col" class="styDepTblCell" style="width: 50mm; border-right-width: 0px">
										(h) <span class="styNormalText">Gain or (loss)<br/>(e) plus (f) minus (g)
											</span>
									</th>
								</tr>
							</thead>
        ...
        (k) <span class="styNormalText">Excess of col. (i)<br/>over col. (j), if any</span>
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/
					 ProgramServiceRevenueDtl) &gt;6)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XV-A Line 1 - Program service revenue:</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="border-bottom-width: 0px; height: 4mm;
									 width: 71mm; text-align:left">
										<span class="styNormalText">
										  Enter gross amounts unless otherwise indicated.
										</span>
									...
									<th scope="col" class="styDepTblCell" rowspan="2" style="height: 4mm; width: 25mm; 
									 border-right-width: 0px">(e)<br/>
										<span class="styNormalText">
								...
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="height: 4mm; width: 71mm; text-align: left;
									 padding-top: 7mm">
										<span class="styBoldText">1</span>
										<span style="width: 1mm"/>
										<span class="styNormalText">Program service revenue:</span>
