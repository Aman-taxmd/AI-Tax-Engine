			...
			<body class="styBodyClass" style="width:187mm">
				<form name="Form7004">
					...
					<div class="styTBB" style="width:187mm;height: 19mm">
						<div class="styFNBox" style="height:19mm; width:33mm;font-size: 9pt;padding-top:0mm;border-right-width:2px">Form 
							<span class="styFormNumber">7004</span>
								<span class="styAgency" style="font-weight:bold; ">(Rev. December 2025)
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<!-- Number, street if P.O. box -->
						<div class="styIRS7004TextBox" style="font-size:7pt;width:129mm;height:10mm;border-top-width:1px;border-right-width:0px;padding-left:2mm">
						...
						<div valign="top" class="styIRS7004TextBox" style="width:40mm; border-left-width:1px; border-top-width:1px; border-right-width:0px; padding-left:2mm; height:10mm;">
							Room or suite no.<br/>
						...
						<!-- City or town -->
						<div valign="top" class="styIRS7004TextBox" style="width:69mm; height:12mm; border-bottom:0; border-right-width:0px; padding-left:2mm;">
							City or town<br/>
						...
						<div class="styIRS7004TextBox" style="border-bottom-width:0px;width:30mm;height:12mm;border-left-width:1px; border-right-width:0px; padding-left:2mm;">
						...
						<div class="styIRS7004TextBox" style="border-bottom-width:0px;width:40mm;height:12mm;border-left-width:1px; border-right-width:0px; padding-left:2mm;">
					...
					<div style="width:187mm;clear:both;">
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top: 0;border-left:0;border-right:0;
						border-bottom-width: 1px;padding-top:.5mm;">
							<span style="font-size: 9pt;text-align:left;float:left; clear: none;">Form 708</span>
						</div>
						<div class="styLNAmountBox" style="height:5mm;width:13mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 1px;border-bottom-width: 1px;padding-top:.5mm;padding-left:1mm;">
							<span style="font-size: 9pt;text-align:center;font-weight:bold;padding-right:4mm;clear: none;">37</span>
						</div>
						<div class="styLNAmountBox" style="height:5mm;width:80mm;border-top-width: 0px;border-left-width: 1px;
						border-right-width: 0px;border-bottom-width: 1px;padding-top:.5mm;padding-left:2mm;background-color:lightgrey;">
				  ...
				  <div class="styBB" style="width:187mm;border-bottom:solid 1px;">
						...
						<span class="styLNDesc" style="width:168mm;height:4mm;">
							...
							<span style="width:173mm;font-size:8pt;">
								...
								<span style="float:right;">
									...
									<input type="checkbox" aria-label="foreign corporation" class="styCkbox" name="OrgHasNoOfficeInUSInd">
						...
						<span class="styLNDesc" style="width:168mm;height:4mm;">
							...
							<span style="width:173mm;font-size:8pt;">
								...
								<span style="float:right;">
									...
									<span style="width: 3mm;"/>
									<span style="width: 4mm;"/>
									<input type="checkbox" aria-label="common parent of a group" class="styCkbox" name="OrgConsolidatedRetToBeFiledInd">
										<xsl:call-template name="PopulateCheckbox">
						...
						<span class="styLNDesc" style="width:176mm;height:5mm;">
							<span style="float:left;font-size:8pt;">	If the organization is a corporation or partnership that qualifies under Regulations section 1.6081-5, check here
								<span style="width: 2mm;"/>
									<span style="width: 4mm;"/>
									<input type="checkbox" aria-label="partnership" class="styCkbox" name="FilingUnderRegsSect160815Ind">
										<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styGenericDiv" style="width:187mm;font-size:8pt;">
						...
						<span class="styLNDesc" style="width:175mm;height:4mm;">
							<input type="checkbox" aria-label="IRS7004InitialReturn" class="styCkbox" name="InitialReturnInd">
								<xsl:call-template name="PopulateCheckbox">
							...
							<span style="width: 4mm;"/>
							<input type="checkbox" aria-label="IRS7004FinalReturn" class="styCkbox" name="FinalReturnInd">
								<xsl:call-template name="PopulateCheckbox">
							...
							<input type="checkbox" aria-label="IRS7004ChangeInAccountingPeriod" class="styCkbox" name="AccountingPeriodChangeInd">
								<xsl:call-template name="PopulateCheckbox">
							...
							<span style="width: 6mm;"/>
							<input type="checkbox" aria-label="IRS7004ConsolidatedReturnToBeFiled" class="styCkbox" name="ConsolidatedRetToBeFiledInd">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styGenericDiv" style="width:187mm;font-size:8pt;height:6mm;">
						<span class="styLNLeftNumBox" style="height:4mm;"/>
						<span class="styLNDesc" style="width:175mm;height:4mm;">
							<input type="checkbox" aria-label="Other (see instructions - attach explanation)" class="styCkbox" name="OtherInd">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styTBB" style="width:187mm">
						...
						<div class="styLNDesc" style="width:138.75mm;">
							<span style="float:left;font-weight:normal;font-size:8pt;">	<b>Balance due. </b> Subtract line 7 from line 6. See instructions
								...
								<input type="checkbox" aria-label="ACH Debit Agreement Indicator" class="styCkbox" name="ACHDebitAgreementInd">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:186mm;clear:both;border-top:solid 1px;">
						...
						<div style="width:25mm;text-align:center;" class="styGenericDiv">Cat. No. 13804A</div>
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">7004</span> (Rev. 12-2025)</div>
					</div>
					...
					<table class="styLeftOverTbl">
						...
						<xsl:for-each select="$FormData/SpecialConditionDesc">
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="Desc">Special Condition Desc</xsl:with-param>
