		...
		<html>
			...
			<body class="styBodyClass">
							...
							<span style="font-weight:bold">
							 ...
							 <br/>
								<span style="font-weight:bold;text-align:center;">
									<!--<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>--> Attach to Form 990 or
									 Form 990-EZ. 
								</span>
								<br/>
								<!--<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>--> Go to 
								<span style="text-align:center;"/>
								<a href="http://www.irs.gov/form990" style="color:black" title="Link to IRS.gov">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<!-- 250324 greg young PLEASE NOTE THAT THE "aria-label" DOES NOT APPEAR IN THE LIST OF ACCEPTED LABELS
						 THOUGH IT ALLOWS JAWS TO PROPERLY READ THE CHECKBOX BEFORE THE LINE DESCRIPTION -->
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAChurchInd">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASchoolInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAHospitalInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox"
						 aria-label="IRS990SchAMedicalResearchOrganizationInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							...
							<xsl:choose>
								<xsl:when test="($Print != $Separated) or count($FormData/HospitalNameAndAddressGrp)
								 &lt;= 2">
							...
							<span class="styFixedUnderline" style="width:172mm; float:right; padding-top:0;
							 padding-bottom:0;"/>
							<br/>
						</label>
					</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchACollegeOrganizationInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescV">
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								governmental unit described in<b> section 170(b)(1)(A)(iv).</b> (Complete Part II.)
						</label>
					</div>
				</div>
				<!-- line 6 -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAGovernmentalUnitInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAPublicOrganization170Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								unit or from the general public described in <b>section 170(b)(1)(A)(vi).</b> (Complete Part
								II.)
						</label>
					</div>
				</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchACommunityTrustInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAAgriculturalResearchOrgInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<xsl:choose>
					<xsl:when test="($Print != $Separated) or count($FormData/AgriculturalNameAndAddressGrp) &lt;= 2">
						<xsl:for-each select="$FormData/AgriculturalNameAndAddressGrp">
							...
							<br/>
							<span class="styFixedUnderline" style="width:171mm; float:right; padding-top:0;
								 padding-bottom:0;"/>
							<br/>
						</xsl:for-each>
					</xsl:when>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAPubliclySupportedOrg509a2Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIX">
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								1/3</span>% of its support from contributions, membership fees, and gross  receipts from
								activities related to its exempt functions—subject to certain exceptions, and (2) no more
								than 33 <span style="font-size:5pt;">1/3</span>% of its support from gross investment 
								income and unrelated business taxable income (less section 511 tax) from businesses  
								acquired by the organization after June 30, 1975.  See <span style="font-weight:bold;">
								section 509(a)(2).</span> (Complete Part III.)
						</label>
					</div>
				</div>
				<!-- line 10 -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchATestPublicSafetyInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASupportingOrganization509a3Ind">
							<xsl:call-template name="PopulateCheckbox">
						...
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  An organization organized and operated exclusively for the benefit of, to perform the functions
							   ...
							   <b>section 509(a)(1)</b> or <b>section 509(a)(2).</b> See <span style="font-
							   weight:bold;">section 509(a)(3). </span> Check the box on lines 12a through 12d that describes
							   the type of supporting organization and complete lines 12e, 12f, and 12g.
						</label>
					</div>
				</div>
				<!-- line 12 ends-->
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASupportingOrgType1Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							...
							<b>Type I.</b> A supporting organization operated, supervised, or controlled by its supported 
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASupportingOrgType2Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							...
							<b> Type II.</b> A supporting organization supervised or controlled in connection with its
							 supported organization(s), by having control or management of the supporting organization vested
							 in the same persons that control or manage the supported organization(s).<b> You must complete
							 Part IV, Sections A and C.</b>
						</label>
					</div>
				</div>
				<!-- line 12c -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASupportingOrgType3FuncIntInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							...
							<b>Type III functionally integrated.</b> A supporting organization operated in connection with,
							and functionally integrated with, its supported organization(s) (see instructions).<b> You must 
							complete Part IV, Sections A, D, and E.</b>
						</label>
					</div>
				</div>
				<!-- line 12d -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchASupportingOrgType3NonFuncInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							...
							<b>Type III non-functionally integrated.</b> A supporting organization operated in connection 
							 with its supported organization(s) that is not functionally integrated. The organization 
							 must generally satisfy a distribution requirement and an attentiveness requirement (see
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAIRSWrittenDeterminationInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							<xsl:call-template name="PopulateLabel">
							 ...
							 Check this box if the organization received a written determination from the IRS that it is a 
							 Type I, Type II, Type III functionally integrated, or Type III non-functionally integrated 
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV" style="width:180mm;">
					 Enter the number of supported organizations
						<!-- Dotted Line -->
						<span style="letter-spacing:2mm; font-size:7pt; margin-left:2mm;">...........................
						</span>
						<span class="styFixedUnderline" style="width:42.5mm;float:none;padding-left:2mm;padding-top:0;
						 padding-bottom:0; font-size:7pt;">
				...
				<div class="IRS990ScheduleAPart4_TableContainer" id="p1Ln11TbCtnr" style="display:table;">
					...
					<table cellspacing="0" style="font-size:7pt;display:table;">
						...
						<!-- Column i -->
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;vertical-align:top;
							 text-align:center;font-weight:normal" scope="col" rowspan="2">
								<b>(i)</b> Name of supported organization</th>
							<!-- Column ii -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;
							 text-align:center;width:20mm;padding-bottom:17mm;border-right-width:1px;font-weight:normal"
							  scope="col" rowspan="2">
								<b>(ii)</b> EIN</th>
							<!-- Column iii -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;
							 width:32mm;border-right-width:1px;font-weight:normal" scope="col" rowspan="2">
								<b>(iii)</b> Type of organization (described on lines 1- 10 above (see instructions)) </th>
							<!-- Column iv -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;
							 width:32mm;padding-bottom:1mm;border-right-width:1px;font-weight:normal" scope="col" 
							 colspan="2">
								<b>(iv)</b> Is the organization listed in your governing document?</th>
							<!-- Column v -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;
							 padding-bottom:15mm;border-right-width:1px;font-weight:normal" scope="col" rowspan="2" 
							 colspan="1">
								<b>(v)</b> Amount of monetary support (see instructions)</th>
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;
							 padding-bottom:15mm;border-right-width:0px;font-weight:normal" scope="col" rowspan="2" 
							 colspan="1">
								<b>(vi)</b> Amount of other support (see instructions)</th>
						</tr>
						<tr>
							<th scope="col" class="IRS990ScheduleA_GenericCell" style="width:9mm;border-right-width:1px;
							 padding-left:5mm;">Yes</th>
							<th scope="col" class="IRS990ScheduleA_GenericCell" style="width:9mm;border-right-width:1px;
							 padding-left:5mm;">No</th>
						</tr>
						<!-- Display all rows: If the print parameter is not set to be Separated, OR -->
							...
							<xsl:for-each select="$FormData/SupportedOrgInformationGrp">
								<tr>
									<td class="IRS990ScheduleA_GenericCell" style="font-family:verdana;font-size:6pt;
									 vertical-align:top;">(<xsl:number value="position()" format="A"/>) 
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											 select="SupportedOrganizationName/BusinessNameLine1Txt"/>
										</xsl:call-template>
										<br/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode"
											 select="SupportedOrganizationName/BusinessNameLine2Txt"/>
										</xsl:call-template>
									</td>
									...
									<!-- Amount of Support -->
									<td class="IRS990ScheduleA_GenericCell" style="text-align:right;border-right-width:1px;
									 width:32mm;vertical-align:top;">
										<xsl:call-template name="PopulateAmount">
						...
						<!-- Display the first blank row if the data set is empty. If the number of data elements is more 				
						 than 2 -->
						<!-- and the print option is separated, display a message in the first row directing the user to the 						-->
						<!-- additional data table -->
						<xsl:if test="count($FormData/SupportedOrgInformationGrp) &lt; 1 or (($Print = $Separated) and
						 (count($FormData/SupportedOrgInformationGrp) &gt; 2)) ">
							<tr>
						...
						<xsl:if test="count($FormData/SupportedOrgInformationGrp) &lt; 2 or (($Print = $Separated) and 
						 (count($FormData/SupportedOrgInformationGrp) &gt; 2)) ">
							<tr>
								<td class="IRS990ScheduleA_GenericCell">
									<span style="width:3px"/>
						...
						<tr>
							<td style="border:black 0 solid;border-bottom-width:0px;border-right-width:1px;" colspan="1">
								...
								<!-- Per defect 42254 removed pen image <xsl:call-template 
									name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="TargetNode"
										 select="$FormData/SupportedOrganizationsTotalCnt"/>
										</xsl:call-template>-->
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;
							 width:25mm;font-size:7pt;">
							...
							<!-- Monetary Support-->
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;width:32mm;
							 font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:0px;width:25mm;
							 font-size:7pt;">
								<span style="width:1px;"/>
								<xsl:call-template name="PopulateAmount">
				...
				<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px;
				 border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
					<div class="styBoldText" style="font-weight:7pt;width:90;float: left; clear: none;"> For Paperwork 
					 Reduction Act Notice, see the Instructions for <br/>Form 990 or 990-EZ.  </div>
					<div style="width:40mm;float:left;font-size:7pt;padding-left:10mm">
					  Cat. No. 11285F
					</div>
					<div style="width:57mm;text-align:right;float:right;font-size:7pt;font-weight:bold;">Schedule A (Form
					 990) 2025</div>
				</div>
				<div class="pageEnd"/>
				...
				<div class="styBB" style="width:187mm; padding-bottom:.5mm;">
					<div style="float:left;">Schedule A (Form 990) 2025</div>
				...
				<div class="styBB" style="width:187mm;">
					...
					<div class="styPartDesc" style="width:171mm;height:auto;">Support Schedule for Organizations Described in 
						...
						<span class="styNormalText">(Complete only if you checked the box on line 5, 7, or 8 of Part I or if 
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;font-weight:bold;
							...
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" scope="col">(a) <span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" scope="col">(b) <span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" scope="col">(c) <span class="styNormalText"> 2023</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" scope="col">(d) <span class="styNormalText"> 2024</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							 vertical-align:center;" scope="col">(e) <span class="styNormalText"> 2025</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;
							 text_align:center;vertical-align:center;" scope="col">(f) <span class="styNormalText"> Total</span>
							</th>
						</tr>
						<tr>
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">1
							</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gifts, 
							...
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/GiftsGrantsContriRcvd170Grp/
						...
						<tr>
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">2
							</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Tax revenues
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:0px;width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;width:25mm;font-size:7pt;">
								<span style="width:1px;"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;width:25mm;font-size:7pt;">
								<span style="width:1px;"/>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;font-weight:bold;
							 border-bottom-width:0px;" scope="col" colspan="2">
								<span style="float: left; clear: both"> Calendar year
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts from
							 line 4<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotalCalendarYear170Grp/
									CurrentTaxYearMinus4YearsAmt"/>
								</xsl:call-template>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
				...
				<div class="styBB" style="width:187mm;border-top-width:1px;">
					<span class="styPartDesc" style="width:162mm;font-weight:bold">Section C.  Computation of Public Support
					  Percentage
					</span>
				</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage for 2025 (line 6, column (f) divided by line 11, column (f))
							   <span class="IRS990ScheduleA_DotSpacing">.........  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage for 2024 Schedule A, Part II, line 14
							   <span class="IRS990ScheduleA_DotSpacing">...............  </span>
						</label>
					</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
						    33 <span style="font-size:5pt;">1/3</span>% support test—2025.
						</span>
						...
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchA33.3%SupportTestCurrentYearInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
						   33 <span style="font-size:5pt;">1/3</span>% support test—2024.
					    </span>
						...
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchA33.3%SupportTestPriorYearInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
							  10%-facts-and-circumstances test—2025.
  						    </span>
							  If the organization did not check a box on line 13, 16a, or 16b, and line 14
							  is 10% or more, and if the organization meets the "facts-and-circumstances" test, check this 
							  box and <b>stop here.</b>  Explain in Part VI how the organization meets the 
							  "facts-and-circumstances" test.
							  The organization qualifies as a publicly supported organization
							<span class="IRS990ScheduleA_DotSpacing">............  </span>
							  <span style="width:2mm"></span>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchA10%FactsAndCircumstancesTestCurrentYearInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
								...
								<b>stop here.</b>  Explain in Part VI how the organization meets the 
								"facts-and-circumstances" test.
								The organization qualifies as a publicly supported organization
							<span class="IRS990ScheduleA_DotSpacing">............  </span>
							  <span style="width:1mm"></span>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchA10%FactsAndCircumstancesTestPriorYearInd">
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/TenPctFactsCrcmstncsTestPYInd"/>
								<xsl:with-param name="BackupName">IRS990SchATenPctFactsCrcmstncsTestPYInd
									</xsl:with-param>
							</xsl:call-template>
						</input>
						<label>
				...
				<div class="pageEnd" style="width:187mm;border-top-width:1px;">
					<div style="float:right;">
						...
						<span class="styBoldText"> Schedule A (Form 990) 2025</span>
					</div>
				</div>
				<!-- END Footer -->
				<p style="page-break-before: always"/>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;font-weight:bold;
							  border-bottom-width:0px;" scope="col" colspan="2">
								<span style="float: left; clear: both"> Calendar year <span class="styBoldText">(or fiscal
 								  year beginning in) <!--<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>-->
									</span>
								</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;
							...
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;
							  text_align:center;vertical-align:center;" scope="col">(f) 
							  <span class="styNormalText"> Total</span>
							</th>
						</tr>
						<tr>
							<!-- Line 1 -->
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gifts,
							 grants, contributions, and membership fees received. (Do not include any "unusual grants.")
							 <!--<span class="IRS990ScheduleA_DotSpacing">.</span>-->
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							...
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" scope="col">(a) 
									<span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" scope="col">(b) 
									<span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" scope="col">(c) 
									<span class="styNormalText"> 2023</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" scope="col">(d) 
									<span class="styNormalText"> 2024</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" scope="col">(e) 
									<span class="styNormalText"> 2025</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;text_align:center;vertical-align:center;"
							 scope="col">(f) <span class="styNormalText"> Total</span>
							</th>
						</tr>
						<tr>
							<!-- Line 9 -->
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">9</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts from line 6
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/Total509Grp/CurrentTaxYearMinus4YearsAmt"/>
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gross income from interest,
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Unrelated business taxable income
							 (less section 511 taxes) from businesses acquired after June 30, 1975
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Add lines 10a and 10b
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:7pt;">
								<xsl:call-template name="PopulateAmount">
          ...
          <span style="width:5mm" /> -->
            ...
            <xsl:with-param name="TargetNode" select="$FormData/OtherIncome"/>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage for 2025 (line 8, column (f) divided by line 13, column (f))
							<span class="IRS990ScheduleA_DotSpacing">.........  </span>
						</label>
					</div>
					<div class="styLNRightNumBox" style="height:4mm;">15</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Public support percentage from 2024 Schedule A, Part III, line 15
							   <span class="IRS990ScheduleA_DotSpacing">...............  </span>
						</label>
					</div>
				...
				<div class="styBB" style="width:187mm;border-top-width: 1px">
					<span class="styPartDesc" style="width:162mm;font-weight:bold;height:auto;">Section D. Computation of
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage for <b>2025</b> (line 10c, column (f) divided by line 13, 
							  column (f))
							   <span class="IRS990ScheduleA_DotSpacing">......  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage from <b>2024</b> Schedule A, Part III, line 17
							   <span class="IRS990ScheduleA_DotSpacing">.............  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">33 <span style="font-size:5pt;">1/3</span>% support
						 tests-2025.
						  ...
						  <span style="font-size:5pt;">1/3</span>%, and line 17 is not <span style="padding-left:1mm;"/>more
						  than 33 <span style="font-size:5pt;">1/3</span>%, check this box and <b>stop here.</b>  
						  The organization qualifies as a publicly supported organization
						<span class="IRS990ScheduleA_DotSpacing">....... </span>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAPublicSupported33.3%TestCurrentYearInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVAL" style="height:auto;">
						<span style="font-weight:bold;">33 
							<span style="font-size:5pt;">1/3
							</span>% support tests—2024.
						</span>
						  ...
						  <span style="font-size:5pt;">1/3</span>%, check this box and <b>stop here.</b> The organization 
						   qualifies as a publicly supported organization
						  <span class="IRS990ScheduleA_DotSpacing">..... </span>
						<span style="width:1mm"></span>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAPublicSupportedOrg33.3%TestPriorYearInd">
							<xsl:call-template name="PopulateCheckbox">
...
organization’s supported organizations?
        <i>If “Yes,” provide detail in <b>Part VI.</b>
				...
				<div style="width: 187mm">
					...
					509(a)(1) or (2))? <i>If “Yes,” provide detail in<b> Part VI.</b>
						</i>
					</div>
					<div class="styLNRightNumBox" style="height:7.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
						...
						the supporting organization had an interest?	<i>If “Yes,” provide detail in<b> Part VI.</b>
						</i>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
...
supporting organization was vested in the same persons that controlled or managed the supported organization(s).
				...
				<div class="styLNDesc" style="width: 175mm"><i>Check the box next to the method that the organization used to
				 satisfy the Integral Part Test during the year</i><b> (see instructions)</b>:
				</div>
				<!-- line 1 -->
				<div class="IRS990ScheduleA_LineContainer">
					<div class="IRS990ScheduleA_LineIndex" style="padding-left:5mm;">a</div>
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="ActivitiesTestInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV" style="width: 160mm;">
						<label>
							<xsl:call-template name="PopulateLabel">
							   ...
							   The organization satisfied the Activities Test. <i>Complete<b> line 2</b> below</i>.
						</label>
					</div>
				</div>
				<!-- line 1b -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="ParentSupportedOrgInd">
							<xsl:call-template name="PopulateCheckbox">
						...
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS990SchAForm990SchAType3FuncIntGrp</xsl:with-param>
								 ...
								 The organization is the parent of each of its supported organizations. <i>Complete<b> line 3
								 </b> below</i>.
						</label>
					</div>
				</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="GovernmentalEntityInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV" style="width: 168mm;">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  The organization supported a governmental supported organization.  <i>Describe in <b>Part VI</b> how you 
							  supported a governmental supported organization (see instructions)</i>.
						</label>
					</div>
				</div>
				<!-- Line 2 -->
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;padding-top:2.5mm;">
						Activities Test.<b><i> Answer lines 2a and 2b below.</i></b>
					</div>
				</div>
				<div style="width: 187mm">
					<div class="styLNLeftNumBox"/>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:12mm;">
						...
						its supported organization(s)?  <i>If "Yes," then in <b>Part VI identify those supported organizations and explain</b> 
						how these activities directly furthered their exempt purposes, how the organization was responsive to each of its 
						supported organizations, and how the organization determined that these activities constituted
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:10mm;">
						...
						<i>If “Yes,” explain in <b>Part VI</b> the reasons for the organization’s position that its supported organization(s)
						would have engaged in these activities but for the organization’s involvement</i>.
					</div>
					<div class="styLNRightNumBox" style="height:10mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
				...
				<div style="width:187mm;float:none;">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
						Parent of Supported Organizations.<b> Answer lines 3a, 3b, and 3c below.</b>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;"/>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey"/>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey"/>
				...
				<div style="width:187mm;float:none;">
					...
					<div class="styLNDesc" style="width:155mm;height:7.5mm;">
						Are the organization and its supported organization(s) part of an integrated system (for example, a hospital
						system)? <i>If “Yes,” provide details in <b>Part VI</b>.</i>
					</div>
					<div class="styLNRightNumBox" style="height:7.5mm;padding-top:4mm">3a</div>
					<div class="styLNRightNumBox" style="height:7.5mm;padding-top:4mm;">
						<xsl:call-template name="PopulateYesBoxText">
				...
				<div style="width: 187mm">
					<div class="styLNLeftNumBox" style="padding-left:5mm;">b</div>
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
						Did the organization direct the policies, programs, and activities of each of its supported organizations?
				...
				<div style="width:187mm;float:none;">
					...
					<div class="styLNDesc" style="width:155mm;height:7.5mm;">
						Did the organization have the power to regularly appoint or elect (and remove) a majority of the officers, directors,
						or trustees of each of the supported organizations?<i>If "Yes" or "No", provide details in <b>Part VI.</b>
						</i>
					</div>
					<div class="styLNRightNumBoxNBB" style="height:7.5mm;padding-top:4mm">3c</div>
					<div class="styLNRightNumBoxNBB" style="height:7.5mm;padding-top:4mm">
						<xsl:call-template name="PopulateYesBoxText">
							<xsl:with-param name="TargetNode" select="$FormData/Form990SchAType3FuncIntGrp/AppointElectMajorityOfficerInd"/>
						</xsl:call-template>
					</div>
				...
				<div class="styBB" style="width:187mm;float:none;">
					...
					<div class="styPartDesc" style="width:155mm;text-align:left;height:4.5mm;"> Type III Non-Functionally 
					 Integrated 509(a)(3) Supporting Organizations </div>
					<div class="styBB" style="width:187mm;"/>
					<tr>
						<div class="IRS990ScheduleA_LineContainer">
							<div class="IRS990ScheduleA_LineIndex" style="padding-left:3mm;">1</div>
							<div class="IRS990ScheduleA_LineIndex">
								<input class="IRS990ScheduleA_Checkbox" type="checkbox" aria-label="IRS990SchAIntegralPartTestSatisfiedInd">
									<xsl:call-template name="PopulateCheckbox">
...
20, 1970. <b>See instructions.</b> All other <span style="width:155mm;text-align:left">Type III non-functionally integrated supporting organizations must complete Sections A through E.</span>
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					<tr>
						...
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;text-align:center;border-top-width: 0px; padding-top:1mm;">
                  (A) Prior Year
                  <span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;text-align:center;border-top-width: 0px; padding-top:1mm;">
                (B) Current Year <br/>(optional)
                 ...
                 <!-- </span>-->
						...
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;">2</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Recoveries of prior-year distributions
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;">3</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Other gross income (see instructions)
                                         <!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;">4</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;
						 border-left:0px;border-right:0px;" colspan="3">Add lines 1 through 3
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;">5</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Depreciation and depletion
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:10.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;">6</td>
						<td class="styLNDesc" style="width:107mm;height:10.5mm;border-style: solid; border-color: black; border-top-width: 0px;
						 border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Portion of operating expenses paid or incurred for
						 production or collection of gross income or for management, conservation, or maintenance of property held for production of income (see instructions)
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:10.5mm;">6</td>
						<td class="styLNAmountBox" style="height:10.5mm;font-size:7pt;padding-top:7mm;">
							<xsl:call-template name="PopulateAmount">
            ...
            <!--Dotted Line-->
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					...
					<tr>
						...
						<td class="styLNLeftNumBox" style="height:7.5mm;"/>
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;text-align: center;">
                  (A) Prior Year
                  <span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;text-align: center;">
                (B) Current Year<br/>(optional)
                  <span style="width:1px;"/>
					...
					<tr>
						...
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;background-color:lightgrey; ">
							<span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;background-color:lightgrey; ">
							<span style="width:1px;"/>
					...
					<tr>
						...
						<td class="styLNDesc" style="width:107mm;height:auto;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;
							...
							(<i>explain in detail in <b>Part VI</b>
							</i>):
					...
					<tr>
						...
						<td class="styLNRightNumBox" style="height:7.5mm;padding-top:.5mm;">4</td>
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
            ...
            <!--Dotted Line-->
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:0mm;border-top-width: 1px"/>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;" colspan="3">
							<span class="styBoldText" style="font-size:8pt;font-weight:bold;">Section C - Distributable
							 Amount</span>
						</td>
						<td class="styLNLeftNumBox" style="height:4.5mm;"/>
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;text-align:center;
						 border-top-width: 0px;background-color:lightgrey">
							<span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;text-align:center;
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid;
						 border-color: black; border-top-width: 1px;border-bottom-width: 1px;border-left:0px;
						 border-right:0px;">1</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black;
						 border-top-width:1px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Adjusted net income for prior year (from Section A, line 8, Column A)
							<!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;border-left-width: 1px;border-top-width: 1px">1</td>
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt; background-color:lightgrey">
							<span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid;
						 border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;
						 border-right:0px;">2</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black;
						 border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Enter
						 85% of line 1
                            <!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						...
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/CYPct85AdjustedNetIncomeAmt"/>
							</xsl:call-template>
							<span style="width:1px;"/>
						</td>
					</tr>
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid;
						 border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;
						 border-right:0px;">3</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black;
						 border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" 
						 colspan="3">Minimum asset amount for prior year (from Section B, line 8, Column A)
							<!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">3</td>
						...
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/CYTotalMinAstDistributableAmt"/>
							</xsl:call-template>
							<span style="width:1px;"/>
						</td>
					</tr>
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid;
						 border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;
						 border-right:0px;">4</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black;
						 border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Enter
						 greater of line 2 or line 3
							<!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">4</td>
						...
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/CYGreaterAdjustedMinimumAmt"/>
							</xsl:call-template>
							<span style="width:1px;"/>
						</td>
					</tr>
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid;
						 border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;
						 border-right:0px;">5</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black;
						 border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Income
						 tax imposed in prior year
							<!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">5</td>
						...
						<td class="styLNAmountBox" style="height:4.5mm;font-size:7pt;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/CYIncomeTaxImposedPYAmt"/>
							</xsl:call-template>
							<span style="width:1px;"/>
						</td>
					</tr>
					<tr>
						<td class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;padding-bottom:3mm;
						 border-style: solid; border-color: black; border-top-width: 0px; border-bottom-width: 1px;
						 border-left:0px;border-right:0px;">6</td>
						<td class="styLNDesc" style="width:107mm;height:7.5mm;border-style: solid; border-color: black;
						 border-top-width: 0px;border-bottom-width: 1px; border-left:0px;border-right:0px;" colspan="3">
							<b>Distributable Amount.</b> Subtract line 5 from line 4, unless subject to emergency temporary
						...
						<td class="styLNAmountBox" style="height:7.5mm;font-size:7pt;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode"
								 select="$FormData/DistributableAmountGrp/CYDistributableAsAdjustedAmt"/>
							</xsl:call-template>
							<span style="width:1px;"/>
						</td>
					</tr>
				...
				<tr>
					<div class="IRS990ScheduleA_LineContainer">
						...
						<div class="IRS990ScheduleA_LineIndex">
							<input class="IRS990ScheduleA_Checkbox" type="checkbox"
							 aria-label="FirstYearType3NonFuncInd">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode"
									 select="$FormData/DistributableAmountGrp/FirstYearType3NonFuncInd"/>
						...
						<div class="IRS990ScheduleA_LineDescIV">
							<label>
								<xsl:call-template name="PopulateLabel">
									...
									Check here if the current year is the organization's first as a non-functionally-
									integrated Type III supporting organization (see instructions)
							</label>
						</div>
					</div>
				</tr>
              ...
              <xsl:with-param name="containerID" select="'DISctn'"/>
				...
				<div class="styTableContainer" style="border-top-width: 0px; width: 187mm;height:auto" id="DISctn">
					<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									 Qualified set-aside amounts (<i>prior IRS approval required - provide details in <b>Part VI</b>
								</i>)
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
						...
						<!--<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									 Other distributions (<i>describe in <b>Part VI</b>
								</i>). See instructions
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span class="styBoldText" style="padding-left:1.5mm">6</span>
								<span style="width: 2mm"/>
								<b>Total annual distributions.</b>  Add lines 1 through 5.
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">6</span>
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									...
									<span style="width: 6mm"/>details in <b>Part VI</b>
								</i>). See instructions
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px;
							  border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									Distributable amount for 2025 from Section C, line 6
							</td>
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								border-top-width: 0px; width: 100mm" colspan="1">
								<span class="styBoldText" style="padding-left:1mm">9</span>
								<span style="width: 2mm"/>
									Line 7 amount divided by Line 8 amount
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
					...
					<table class="styTable" style="font-size: 7pt; border-color:black;width:187mm;" cellspacing="0">
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 1.5mm">2</span>
								<span style="width: 1mm"/>
									 Underdistributions, if any, for years prior to 2025 <span style="padding-left: 7mm"/>
								<span style="width:5mm;"/>(reasonable cause required-- <i>explain in <span style="font-weight: bold;">Part VI</span>
								</i>).
								 <br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1.5mm;"/>
									Carryover from 2020 not applied (see <br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>Distributions for 2025 from Section D, line 6:</td>
						...
						<tr>
							...
							<td class="styTableCellSmall" style="width: 37mm; padding-top: 2mm; font-size: 7pt">
								<span style="padding-right: 4mm"/>
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 5mm"/> 2025, if any. Subtract lines 3g and 4a from line 2.<br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
									Remaining underdistributions for 2025. Subtract <br/>
								<span style="width: 6mm"/>lines 3h and 4b from line 1. If the amount is greater <br/>
								<span style="width: 5mm"/> than zero, <i>explain in <span style="font-weight: bold;">Part VI</span>
								</i>. 
								  See instructions.
							</td>
							<td class="styTableCellSmall" style="width: 37mm; font-size: 6pt;background-color:lightgrey;"/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
								<b> Excess distributions carryover to 2026.</b> Add lines <br/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 2.5mm">c</span>
								<span style="width: 1.5mm"/>
									Excess from 2023<span class="styDotLn" style="float:none; clear:none">.....</span>
								<span class="styIRS990AUnderlinedText" style="text-align: center; width: 20mm; font-size: 7pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
										  ExcessFromYear3Amt"/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 2.5mm">d</span>
								<span style="width: 1.5mm"/>
									Excess from 2024<span class="styDotLn" style="float:none; clear:none">.....</span>
								<span class="styIRS990AUnderlinedText" style="text-align: center; width: 20mm; font-size: 7pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
										  ExcessFromYear2Amt"/>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 2.5mm">e</span>
								<span style="width: 1.5mm"/>
								   Excess from 2025<span class="styDotLn" style="float:none; clear:none">.....</span>
								<span class="styIRS990AUnderlinedText" style="text-align: center; width: 20mm; font-size: 7pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
										  ExcessFromYear1Amt"/>
				...
				<div style="width:187mm">
					<div style="float:right">
						<span class="styBoldText" style="font-size: 7pt">Schedule A (Form 990)</span> (2025)
					</div>
				</div>
				<div class="pageEnd"/>
				<!--END FOOTER-->
				...
				<div class="styBB" style="width:187mm;float:none;border-top-width:1px">
					...
					<span style="font-size:7pt;padding-left:2mm;width: 170mm;">
						...
						line 1; Part IV, Section D, lines 2 and 3; Part IV, Section E, lines 1c, 2a, 2b, 3a, 3b, and 3c; Part V, line 1; Part V, 
						Section B, line 1e; Part V Section D, lines 5 and 7; and Part V, Section E, lines 2, 5, and 6. Also complete this 
						part for any additional information. (See instructions).</span>
				</div>
				<!--*********FactsAndCircumstancesTest******************************************-->
				<table id="GEPATbl" class="styDepTbl" style="margin-top:1mm; font-size:8pt; font-family:Arial">
				...
				<!--<div class="styBB" style="width:187mm;padding-top:0mm;padding-bottom:0mm;clear:both; 
				border-top:1 solid black;height:.5mm;">
				...
				<div class="styTableContainer" style="width:187mm;clear:all;height:auto;" id="SUPctn">
					<table class="styTable" style="font-size: 7pt; border-color:black;height:auto;" cellspacing="0">
						<thead class="styTableThead">
							<tr class="styDepTblHdr">
								<th class="styDepTblCell" scope="col" style="width:50mm;text-align:center;font-size:7pt;
								 font-weight:normal;border-color:black;">Return Reference</th>
								<th class="styDepTblCell" scope="col" style="width:137mm;text-align:center;
								 font-size:7pt;font-weight:normal;border-color:black;">Explanation</th>
							</tr>
						</thead>
						<tfoot/>
						<tbody valign="top">
							<xsl:if test="($Print!=$Separated) or (($Print=$Separated) and 
							(count($FormData/Form990ScheduleAPartVIGrp) &lt;20))">
								<xsl:for-each select="$FormData/Form990ScheduleAPartVIGrp">
									<tr>
										<td class="styTableCell" style="text-align:left; border-right-width: 1px; 
