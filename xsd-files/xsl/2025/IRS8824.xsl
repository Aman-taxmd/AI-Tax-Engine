						...
						<div style="width:187mm;height:9mm;">
							...
							<div class="styGenericDiv" style="width:25mm;float:right;clear:none;height:3.5mm;padding-top:4mm;">
								<span>
									...
									<input type="checkbox" aria-label="Exchange Made With Related Party Yes Box" class="styCkbox" name="Checkbox">
								...
								<span>
									...
									<input type="checkbox" aria-label="Exchange Made With Related Party No Box" class="styCkbox" name="Checkbox">
...
(or an intermediary) in the exchange?
							  <span class="styDotLn" style="float:right;">...............................</span>
								...
								<div class="styGenericDiv" style="padding-top:6mm;width:25mm;float:right;clear:none;height:3.5mm;">
									<span>
										...
										<input type="checkbox" aria-label="Related Party Sold Prop Received Yes Box" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8824Data/RelatedPartySoldPropRcvdInd"/>
									...
									<span>
										...
										<input type="checkbox" aria-label="Related Party Sold Prop Received No Box" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8824Data/RelatedPartySoldPropRcvdInd"/>
                  ...
                  <span class="styDotLn" style="float:right;">...............</span>
								...
								<div class="styGenericDiv" style="padding-top:3mm;width:25mm;float:right;clear:none;height:3.5mm;">
									<span>
										...
										<input type="checkbox" aria-label="You Sold Property Received Yes Box" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8824Data/YouSoldPropertyReceivedInd"/>
									...
									<span>
										...
										<input type="checkbox" aria-label="You Sold Property Received No Box" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8824Data/YouSoldPropertyReceivedInd"/>
			    ...
			    If one of the exceptions below applies to the disposition, check the applicable box.
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:165mm;padding-top:3mm">
									<input type="checkbox" aria-label="The disposition was after the death of either of the related parties" class="styCkbox" name="Checkbox">
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:165mm;padding-top:3mm">
									<input type="checkbox" aria-label="The disposition was an involuntary conversion" class="styCkbox" name="Checkbox">
										<xsl:call-template name="PopulateCheckbox">
							...
							<div class="styBB" style="width:187mm;height:14mm;">
								...
								<div class="styLNDesc" style="width:179mm;padding-top:3mm;">
									<span style="width:5mm;">
										<input type="checkbox" aria-label="Exchange Dispos Not Tax Avoidance" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateCheckbox">
 ...
 purposes. If this box is checked, attach an explanation. See instructions.
					...
					<div style="width:187mm;clear:both;padding-top:1mm;" class="pageEnd">
						...
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8824</span> (2025)</div>
					</div>
					
					<p style="page-break-before: always"/>
					<!-- header -->
					<div class="styBB" style="width:187mm;clear:both;padding-bottom:.5mm;">
						<div style="width:90mm;" class="styGenericDiv">Form 8824 (2025)</div>
					...
					<div class="styBB" style="width:187mm;clear:both; border-top-width:1px;">
						<div class="styNameBox" style="width:144mm;height:9.5mm;font-size:7pt;">
							Name(s) shown on tax return. Do not enter name and identifying number if shown on other side.<br/>
						</div>
				...
				Realized Gain or (Loss), Recognized Gain, and Basis of Like-Kind Property Received
					...
					<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
						...
						<!-- Line 12a-->
						<div style="width:187mm;height:12mm;padding-top:1mm;">
								<div class="styLNLeftNumBox" style="padding-left: 4.5mm;padding-top:1mm">a</div>
							<div class="styGenericDiv" style="padding-top:1mm;">
							Description of other property given up
								<span style="width:4px;"/>
							</div>	
							<span class="styFixedUnderline" style="float:right;clear:none;width:124mm;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form8824Data/OtherPropertyGivenUpDesc"/>
								</xsl:call-template>
							</span>
						</div>						
						...
						<div class="styBB" style="width:187mm;">
							...
							<div style="width:187mm;">
								...
								<div class="styLNRightNumBoxNBB" style="width:8mm;background-color:lightgrey;height:7mm;"/>
							...
							<div style="width:187mm;height:12mm;padding-top:1mm;">
								<div class="styLNLeftNumBox" style="padding-left: 4.5mm;padding-top:1mm">a</div>
								<div class="styGenericDiv" style="padding-top:1mm;">
									Description of other property received
									<span style="width:4px;"/>
								</div>	
								<span class="styFixedUnderline" style="float:right;clear:none;width:124mm;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form8824Data/OtherPropertyReceivedDesc"/>
									</xsl:call-template>
								</span>
							</div>								
							<!-- Line 16 -->
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:137.9mm;">
									...
									<span style="width:35mm;border-bottom:1px solid black">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8824Data/GainOrLossDesc"/>
										</xsl:call-template>
									</span>
								</div>
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:137.9mm;height:8mm">
									<span style="float:left;">
										<span class="styBoldText">Note</span>: Complete lines 25a, 25b, and 25c , as applicable, if you received any of the following in the exchange: like-kind section 1250, 1245, 1252, 1254, or 1255 property; or like-kind intangible property. </span>
								</div>
							...
							<!-- Line 25a -->
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="height:4.5mm;padding-left:4.5mm">a</div>
								<div class="styLNDesc" style="width:98mm;height:4.5mm;">
									<span style="float:left;">Basis of like-kind section 1250 property received</span>
										<!--Dotted Line-->
										<div class="styDotLn" style="float:right;padding-right:1mm;">.........</div>
								</div>
								...
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8824Data/BssLikeKindSect1250PropRcvdAmt"/>
									</xsl:call-template>
								</div>
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:98mm;height:4.5mm;">
									<span style="float:left;">Basis of like-kind section 1245, 1252, 1254, and 1255 property received</span>
										<!--Dotted Line-->
										<div class="styDotLn" style="float:right;padding-right:1mm;">.</div>	
								</div>
								...
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8824Data/BssLikeKindSectPropRcvdAmt"/>
									</xsl:call-template>
								</div>
								<div class="styLNRightNumBoxNBB" style="width:8mm;background-color:lightgrey;height:4.5mm;"/>
								<div class="styLNAmountBoxNBB" style="height:4.5mm;"/>
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:98mm;height:4.5mm;">
									<span style="float:left;">Basis of like-kind intangible property received</span>
										<!--Dotted Line-->
										<div class="styDotLn" style="float:right;padding-right:1mm;">.........</div>	
								</div>
								...
								<div class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form8824Data/BssLikeKindIntngblPropRcvdAmt"/>
									</xsl:call-template>
								</div>
								<div class="styLNRightNumBoxNBB" style="width:8mm;background-color:lightgrey;height:4.5mm;"/>
								<div class="styLNAmountBoxNBB" style="height:4.5mm;"/>
				  ...
				  requirements. This part can be used <b> only </b> if the cost of the replacement property is more than the basis of the divested property. 
						...
						<div style="width:187mm;height:auto;padding-top:3mm;">
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="width:97.9mm;">
								...
								<div class="styLNAmountBoxNBB" style="border-bottom-width:0px;"/>
							</div>
							<!-- Line 31 -->
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="">31</div>
								<div class="styLNDesc" style="width:97.9mm;">
									<span style="float:left;">Basis of divested property  </span>
									<!--Dotted Line-->
									<div class="styDotLn" style="float:right;padding-right:1mm;">................</div>
								</div>
								<div class="styLNRightNumBox" style="">31</div>
								<div class="styLNAmountBox" style="">
									<xsl:call-template name="PopulateAmount">
							...
							<!-- Line 33 -->
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="">33</div>
								<div class="styLNDesc" style="width:97.9mm;">Cost of replacement property purchased within 60 days after date of sale
								</div>
							...
							<div style="width:187mm;height:7mm;">
								<div class="styLNLeftNumBox" style="">36</div>
								<div class="styLNDesc" style="width:137.9mm;">Subtract line 35 from line 34. If zero or less, enter -0-. If more than zero, enter here and on Schedule D 						  <br/>or Form 4797. See instructions. 
									<!--Dotted Line -->
									<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
								</div>
								<div class="styLNRightNumBox" style="height:7mm;padding-top:3mm;">36</div>
							...
							<!-- Line 37 -->
							<div style="width:187mm;">
								<div class="styLNLeftNumBox" style="">37</div>
								<div class="styLNDesc" style="width:137.9mm;">
									<span style="float:left;">
							...
							<div class="styBB" style="width:187mm;border-bottom-width:2px;">
								<div class="styLNLeftNumBox" style="">38</div>
								<div class="styLNDesc" style="width:137.9mm;">
									<span style="float:left;">
								...
								<div class="styLNRightNumBoxNBB" style="">38</div>
								<div class="styLNAmountBox" style="border-bottom-width:0px;">
									<xsl:call-template name="PopulateAmount">
						...
						<div style="width:187mm;clear:both;padding-top:1mm;">
							...
							<div style="float:right;">
								<span style="width:80px;"/>Form <span class="styBoldText">8824</span> (2025)
							</div>
						</div>
					</div>
