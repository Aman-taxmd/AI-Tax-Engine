...
<!-- 01/26/2023 - Changes made for defect 71418 - Jeremy Nichols -->
<!-- 02/21/2023 - Changes made for defect 70213 - Jeremy Nichols -->
<!-- 04/27/2023 - Changes made for UWR 865735 - Jeremy Nichols -->
<!-- 01/19/2024 - defect 1268972 - Jeremy Nichols -->
<!-- 01/31/2024 - defect 1253201 - Jeremy Nichols -->
<!-- 05/20/2024 - UWR 977554 - Jeremy Nichols -->
<!-- 07/03/2024 - defect 1479165 - Jeremy Nichols -->
<!-- 07/17/2024 - UWR 984423 - Jeremy Nichols -->
<!-- 10/01/2024 - defect 1478437 - Jeremy Nichols -->
<!-- 11/08/2024 - defect 1545867 - Jeremy Nichols -->
<!-- 04/11/2025 - UWR 995949 - Jeremy Nichols -->
<!-- 05/02/2025 - pdf review defect  - Jeremy Nichols -->
<!-- 05/19/2025 - UWR 996273 - Jeremy Nichols -->
<!-- 06/05/2025 - PDF Review - AJH -->
<!-- 06/24/2025 - defect 1704798 - Jeremy Nichols -->
<!-- 07/28/2025 - defect 1715324 - Jeremy Nichols -->
<!-- 08/01/2025 - defect 1714891 - Jeremy Nichols -->
<!-- 08/04/2025 - UWR 1003202 - Jeremy Nichols -->
			...
			<body class="styBodyClass">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_FormTitleBlock" style="height:21mm;">
						...
						<xsl:if test="normalize-space($FormData/TaxYearBeginDt)=''">
							<span style="width:5mm;"/>, 2025</xsl:if>, and ending
						<xsl:call-template name="PopulateMonthDayYear">
					...
					<div class="IRS8865_FormYearBlock" style="height:21mm;">
						...
						<div style="padding-left:4px; line-height:100%">    
						  Attachment<br/>Sequence No.<span style="font-weight:bold;">865</span>
						</div>
					</div>
				</div>
				<!-- Name and Address -->
				...
				<!--address and other infos -->
					...
					<div style="width:187mm;">
						<div style="width:187mm;height:4mm;font-size:7pt;border-bottom:1px solid black;">Filer's address (if you aren't filing this form with your tax return)</div><br/>
						<span style="width:150mm;border-bottom:1px solid black;border-right:1px solid black;">
							Number and street. If P.O. box, see instructions.<br/>
						...
						<span style="width:37mm;border-bottom:1px solid black;">
							Apt. or suite no.<br/><br/>
							<xsl:call-template name="PopulateReturnHeaderFiler">
								<xsl:with-param name="TargetNode">ApartmentNo</xsl:with-param>
							</xsl:call-template>
						</span>
						<br/>
						<span style="width:75mm;border-bottom:1px solid black;border-right:1px solid black;">
							City or town<br/><br/>
							<xsl:choose>
								<xsl:when test="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/ForeignAddress/CityNm">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/ForeignAddress/CityNm"/>
									</xsl:call-template>
								</xsl:when>
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/USAddress/CityNm"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</span>
						<span style="width:50mm;padding-left:0.5mm;border-bottom:1px solid black;border-right:1px solid black;">
							State or province<br/><br/>
							<xsl:choose>
								<xsl:when test="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/ForeignAddress/ProvinceOrStateNm">
									<xsl:call-template name="PopulateText">
								...
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/USAddress/StateAbbreviationCd"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</span>
						<span style="width:25mm;padding-left:0.5mm;border-bottom:1px solid black;border-right:1px solid black;">
							Country<br/><br/>
							<xsl:choose>
								<xsl:when test="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/ForeignAddress/CountryCd">
									<xsl:call-template name="PopulateText">
						...
						<span style="width:37mm;padding-left:0.5mm;border-bottom:1px solid black;">
							ZIP or foreign postal code<br/><br/>
							<xsl:choose>
								<xsl:when test="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/ForeignAddress/ForeignPostalCd">
									<xsl:call-template name="PopulateText">
								...
								<xsl:otherwise>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="AppData/SubmissionHeaderAndDocument/ReturnHeader/Filer/USAddress/ZIPCd"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</span>
					</div>
				<div class="IRS8865_LineContainer" style="width:187mm;height:4.5mm;padding-bottom:0.5mm;padding-left:2.5mm;border-bottom:1px solid black;">
					<!-- filer's category -->
				...
				<div class="IRS8865_LineContainer" style="width:187mm;height:4.5mm;padding-top:0.5mm;padding-left:2.5mm;border-bottom:1px solid black;">
					<!-- filer's tax year -->
					...
					<xsl:if test="normalize-space($FormData/FilerTaxYearBeginDt)=''">
						<span style="width:5mm;"/>, 20
					</xsl:if>
					</span>
					, and ending
					...
					<xsl:if test="normalize-space($FormData/FilerTaxYearEndDt)=''">
						<span style="width:5mm;"/>, 20
					</xsl:if>
					</span>
				</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_CatLine" style="font-size:6pt;width:47mm;height:4mm;padding-top:2px;">Filer's share of liabilities: Nonrecourse $   </div>
				...
				<div class="IRS8865_TableContainer3" name="LineETable" id="LineETable" style="height:auto;width:187mm;border-bottom-width:0px;">
					...
					<table class="styTable" cellspacing="0" style="height:auto;width:187mm;font-size:7pt;border-color:black;" cellpadding="0">
						<tr>
							<th scope="col" class="IRS8865_SchATabNameCol" style="height:8mm;">
								<span style="font-weight:bold;">(1) </span>Name</th>
							<th scope="col" class="IRS8865_SchATabAddrCol" style="height:8mm;">
								<span style="font-weight:bold;">(2) </span>Address</th>
							<th scope="col" class="IRS8865_SchATabIDCol" style="height:8mm;">
								<span style="font-weight:bold;">(3) </span><span style="width:0.5mm;"/>Identification number</th>
							<th scope="colgroup" colspan="3" style="height:8mm">
								<span style="height:4mm;width:60mm;text-align:center;border-bottom:1px solid black;">
									<span style="font-weight:bold;">(4) </span>Check applicable box(es)
								</span><br/>	
								<span style="height:4.1mm;width:20mm;text-align:center;border-right:1px solid black;border-bottom:1px solid black;">
									Category 1
								</span>	
								<span style="height:4.1mm;width:20mm;text-align:center;border-right:1px solid black;border-bottom:1px solid black;">
									Category 2
								</span>	
								<span style="height:4mm; width:20mm; font-family: 'Arial Narrow'; border-bottom:1px solid black;">
									Constructive owner
								</span>	
							</th>
						</tr>
				...
				<table cellpadding="0" cellspacing="0" style="width:187mm;border-top-width:0px;">
					<tbody>
						<tr>
							<td rowspan="3" scope="rowgroup" style="vertical-align:top;border-top:0px solid black;border-bottom:1px solid black;">
							...
							<td>
								<table cellpadding="0" cellspacing="0" style="width:83mm;border-top-width:0px;">
									<tbody>
										<tr>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:6mm;width:12mm;padding-top:2mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="NondedIntRoyaltyUndSect267AYes" alt="Non Deduction Interest Royalty Under Section 267A Yes">
					...
					<div class="IRS8865_LineDescLong" style="height:6mm;width:12mm;padding-top:2mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="NondedIntRoyaltyUndSect267ANo" alt="Non Deduction Under Section 267A No">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="Section721cPartnershipYes" alt="Section 721c Partnership Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section721cPartnershipInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="Section721cPartnershipNo" alt="Section 721c Partnership No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section721cPartnershipInd"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="SpclAllocnMadeByFrgnPrtshpYes" alt="Special Allocation Made By Foreign Partnership Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SpclAllocnMadeByFrgnPrtshpInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="SpclAllocnMadeByFrgnPrtshpNo" alt="Special Allocation Made By Foreign Partnership No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SpclAllocnMadeByFrgnPrtshpInd"/>
				...
				<!-- line 8a -->
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LineIndex" style="text-align:center;">8a</div>
				...
				<!-- line 8b -->
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LineIndex" style="text-align:right;">b</div>
					<div class="IRS8865_LineDescLong" style="height:14mm;width:175mm;border-right-width:0px;">
						The owner of a qualified business unit (QBU) as defined in section 989(a) with a functional currency different from its owner (including a
						foreign disregarded entity, foreign branch, or foreign partnership) is required to file Form 8964 and related schedules. Enter the number of
						Forms 8964 attached to this Form 8865 
						<span style="width:25mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Form8964USQBUCnt"/>
							</xsl:call-template>
						</span>; 
						to Forms 5471 for controlled foreign corporations owned by the partnership
						<span style="width:25mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Form8964CFCQBUCnt"/>
							</xsl:call-template>
						</span>;
						and to Forms 8865 for controlled foreign partnerships owned by the partnership
						<span style="width:25mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Form8964FPSQBUCnt"/>
							</xsl:call-template>
						</span>.
					</div>
				</div>
				<!-- line 9 -->
				<div class="IRS8865_LineContainer" style="">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:10mm;width:149mm;border-right-width:0px;">Does the filer have an interest in the foreign partnership, 
						or an interest indirectly through the foreign partnership, that's a separate unit under Regulations section 1.1503(d)-1(b)(4) or part of a combined separate 
						unit under Regulations section 1.1503(d)-1(b)(4)(ii)? If &quot;No,&quot; skip question 10b.
					...
					<div class="IRS8865_LineDescLong" style="padding-top:6.5mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="FrgnPrtshpInterestSepUnitYes" alt="Foreign Partnership Interest Under Separate Unit Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FrgnPrtshpInterestSepUnitInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:6.5mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="FrgnPrtshpInterestSepUnitNo" alt="Foreign Partnership Interest Under Separate Unit No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FrgnPrtshpInterestSepUnitInd"/>
				...
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LineIndex" style="text-align:right;">b</div>
					<div class="IRS8865_LineDescLong" style="height:7mm;width:149mm;border-right-width:0px;">If  &quot;Yes,&quot; does the separate unit or combined separate unit have a dual consolidated loss as defined in Regulations section 1.1503(d)-1(b)(5)(ii)?
						<span style="width:1px;"/>
						<xsl:call-template name="SetFormLinkInline">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:3.5mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="SepCombSepDualCnsldtLossYes" alt="Dual Consolidated Loss Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SepCombSepDualCnsldtLossInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:3.5mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="SepCombSepDualCnsldtLossNo" alt="Dual Consolidated Loss No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SepCombSepDualCnsldtLossInd"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:149mm;border-right-width:0px;">
					   <span class="IRS8865_DotSpacing" style="padding-left:80px;float:right;">......</span>
					</div>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="TotalRcptsAssetsLessThanLmtYes" alt="Total Receipts Or Assets Less Than Limit Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TotalRcptsAssetsLessThanLmtInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="TotalRcptsAssetsLessThanLmtNo" alt="Total Receipts Or Assets Less Than Limit No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TotalRcptsAssetsLessThanLmtInd"/>
				...
				<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black;">
					...
					<div style="float:right;">
					  ...
					  Form <span class="styBoldText" style="font-size:8pt;">8865</span> (2025)
					</div>
				</div>
				...
				<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
					<div style="float:left;">Form 8865 (2025)<span style="width:148mm;"/>
					</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:10mm;width:140mm;border-right-width:0px;">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:5mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="FDIIBenefitsClaimYes" alt="FDII Benefits Claim Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:5mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="FDIIBenefitsClaimNo" alt="FDII Benefits Claim No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:7mm;width:140mm;border-right-width:0px;">
					...
					<div class="IRS8865_LineDescLong" style="width:39mm;padding-top:2mm;border-right-width:0px;">
						<span style="width:39mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllSlsGeneralPropGrossRcptsAmt"/>
							</xsl:call-template>
						</span>
					</div>
				</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:39mm;padding-top:2mm;border-right-width:0px;">
						<span style="width:39mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AllSlsIntngblPropGrossRcptsAmt"/>
							</xsl:call-template>
						</span>
					</div>
				</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:8mm;width:140mm;border-right-width:0px;">
					...
					<div class="IRS8865_LineDescLong" style="width:39mm;padding-top:2mm;border-right-width:0px;">
						<span style="width:39mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/ForeignServiceGrossReceiptsAmt"/>
							</xsl:call-template>
						</span>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:8mm;width:39mm;padding-top:2mm;border-right-width:0px;">
						<span style="width:39mm;border-bottom:1px solid black;text-align:right;">
							<xsl:call-template name="PopulateAmount">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:2mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="TransfersSubjectToDisclRqrYes" alt="Transfers Subject To Disclosure Requirements Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TransfersSubjectToDisclRqrInd"/>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:2mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" name="TransfersSubjectToDisclRqrNo" alt="Transfers Subject To Disclosure Requirements No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TransfersSubjectToDisclRqrInd"/>
				...
				<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;clear:both;border-top:1px solid black;">
					<tr>
						<td style="width:15mm;font-size:6pt;font-weight:bold;border-right:1px solid black;border-bottom:1px solid black;">Sign Here Only if You're Filing This Form Separately and Not With Your Tax Return
						</td>
						<td colspan="5" scope="colgroup" style="padding-left:3mm;padding-bottom:1mm;border-bottom:1px solid black;">Under penalties of perjury, I declare that I have examined this return, including accompanying schedules and statements, and to the best of my
						...
						<br/>
						<div style="width:80mm;border-right:1px solid black;">

							<div style="width:75mm; border-bottom:1px solid black;">
				...
				<div class="IRS8865_TableContainer3" name="SchA2Table" id="SchA2Table" style="height:auto;border-bottom-width:0px;display:block;">
					...
					<table class="styTable" cellspacing="0" style="height:auto;width:187mm;font-size:7pt;">
						<thead>
						<tr>
							<th scope="rowgroup" style="width:42mm;height:12mm;vertical-align:bottom;border-right:solid black 1px;" rowspan="2">Name of <br/>foreign partner</th>
							<th scope="rowgroup" style="width:43mm;height:12mm;vertical-align:bottom;border-right:solid black 1px;" rowspan="2">Address</th>
							<th scope="rowgroup" style="width:15mm;height:12mm;vertical-align:bottom;border-right:solid black 1px;" rowspan="2">Country of organization<br/> (if any)</th>
							<th scope="rowgroup" style="width:20mm;height:12mm;vertical-align:bottom;border-right:solid black 1px;" rowspan="2">U.S. taxpayer identification number<br/> (if any)</th>
							<th scope="rowgroup" style="width:15mm;height:12mm;vertical-align:bottom;border-right:solid black 1px;" rowspan="2">Check if related to U.S. transferor</th>
							<th scope="colgroup" style="width:52mm;height:6mm;vertical-align:bottom;border-right:solid black 0px;" colspan="2">Percentage interest</th>
						</tr>
						<tr>
							...
							<xsl:for-each select="$FormData/IRS8865ScheduleA2/Sect721cPrtshpFrgnPrtnrInfoGrp">
								<tr>
									...
									<td  style="text-align:center;border-right:solid black 1px;border-top:solid black 1px;">
										...
										<span style="font-weight:bold;">
											<label name="RelatedToUSTransferor">
												<xsl:call-template name="PopulateLabel">
													<xsl:with-param name="TargetNode" select="RelatedToUSTransferorInd"/>
													<xsl:with-param name="BackupName">IRS8865RelatedUSTransferor<xsl:value-of select="position()"/></xsl:with-param>
												</xsl:call-template>
									...
									<td  style="text-align:center;border-right:solid black 1px;border-top:solid black 1px;">
										<xsl:choose>
										  <xsl:when test="normalize-space(InterestCapitalPct)!=''">  
									...
									<td  style="text-align:center;border-right:solid black 0px;border-top:solid black 1px;">
										<xsl:choose>
										  <xsl:when test="normalize-space(InterestProfitsPct)!=''">  
											<xsl:call-template name="PopulatePercent">
						...
						<xsl:if test="(count($FormData/IRS8865ScheduleA2/Sect721cPrtshpFrgnPrtnrInfoGrp) &gt; 2) and ($Print = $Separated) or count($FormData/IRS8865ScheduleA2/Sect721cPrtshpFrgnPrtnrInfoGrp) &lt; 1">
							<tr>
								<td class="IRS8865_SchATabNameCol" style="font-size:6.5pt; line-height:100%;border-right-width:1px;border-top:1px solid black;border-bottom:0px solid black;">
									<xsl:call-template name="PopulateAdditionalDataTableMessage">
										<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA2/Sect721cPrtshpFrgnPrtnrInfoGrp"/>
									</xsl:call-template>
									<span style="width:3px;"/>
								</td>
								<td class="IRS8865_SchATabAddrCol" style="font-size:6.5pt; line-height:90%;border-right-width:1px;border-top:1px solid black;border-bottom:0px solid black;">
									<span style="width:3px;"/>
								</td>
								<td class="IRS8865_SchA1TabIDCol" style="border-right-width:1px;border-top:1px solid black;border-bottom:0px solid black;">
									<span style="width:3px;"/>
								</td>
								<td class="IRS8865_SchATabCatCol" style="border-right-width:0px;border-right-width:1px;border-top:1px solid black;border-bottom:0px solid black;">
									<span style="width:3px;"/>
								</td>
								<td class="IRS8865_SchATabCatCol" style="border-right-width:0px;border-right-width:1px;border-top:1px solid black;border-bottom:0px solid black;">
									<span style="width:3px;"/>
								...
								<td class="IRS8865_SchATabCatCol" style="border-right-width:0px;border-top:1px solid black;border-bottom:0px solid black;">
									<span style="width:3px;"/>
								</td>
							</tr>
						</xsl:if>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA2/HaveOtherForeignDirectPrtnrInd"/>
							</xsl:call-template>
				...
				<table style="width:187mm;" cellpadding="0" cellspacing="0" role="presentation">
					<tbody role="presentation">
						<tr >
							<!-- line 1a -->
							<td style="height:4.5mm;width:6mm;border-right:1px solid black;border-bottom:1px solid black;" rowspan="9">
								<img src="{$ImagePath}/8865_Income.gif" alt="image displaying the word income" border="0"/>
							</td>
							<td style="height:4.5mm;width:7mm;border-right:0px solid black;padding-left:2mm;">
								<b>1a</b>
							</td>
							<td style="height:4.5mm;width:102.5mm;border-right:1px solid black;">
							...
							<td style="height:4.5mm;width:7.5mm;border-right:1px solid black;border-bottom:1px solid black;padding-left:2mm;">
								<b>1a</b>
							</td>
							<td style="height:4.5mm;width:25mm;border-right:1px solid black;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleB/GrossReceiptsOrSalesAmt"/>
								</xsl:call-template>
							</td>
							<td style="height:4.5mm;width:8mm;border-right:1px solid black;background-color:lightgrey;">
							</td>
							<td style="height:4.5mm;width:24mm;border-right:0px solid black;text-align:right;">
							</td>
						</tr>
						<tr >
							<!-- line 1b, c -->
							<td style="height:4.5mm;width:7mm;border-right:0px solid black;padding-left:3.5mm;">
								<b>b</b>
							</td>
							<td style="height:4.5mm;width:102.5mm;border-right:1px solid black;">
							...
							<td style="height:4.5mm;width:8mm;border-right:1px solid black;border-bottom:1px solid black;text-align:center;">
								<b>1c</b>
							</td>
							<td style="height:4.5mm;width:24mm;border-right:0px solid black;border-bottom:1px solid black;text-align:right;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr >
							...
							<td style="height:4.5mm;width:135mm;border-right:1px solid black;" colspan="3">
								Cost of goods sold
								<span class="IRS8865_DotSpacing">.......................................</span>
							</td>
							<td style="height:4.5mm;width:8mm;border-right:1px solid black;border-bottom:1px solid black;text-align:center;">
						...
						<tr >
							<!-- line 8 -->
							<td style="height:4.5mm;width:7mm;border-right:0px solid black;border-bottom:1px solid black;padding-left:2mm;">
								<b>8</b>
							</td>
							<td style="height:4.5mm;width:135mm;border-right:1px solid black;border-bottom:1px solid black;" colspan="3">
				...
				<!-- line 30 -->
				<div class="IRS8865_LineContainer" style="border-bottom:0px solid black;" >
					<div class="IRS8865_LabelSpace"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescShortSchK" style="width:45mm;">Guaranteed payments: <span style="width:1.5mm"/>
					...
					<div class="IRS8865_LineDescShortSchK" style="width:21mm;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLongSchK">Dividends and dividend equivalents: <span style="width:1.5mm"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLongSchK" style="border-bottom-width:1px;width:65mm;border-right-width: 0px;">Other income (loss)
					...
					<div class="IRS8865_MoneyField" style="width:47mm;padding-left:1mm;border-style:solid; text-align: left;font-family:verdana;border-bottom-width:1px;">
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/OtherIncomeLossAmt/@otherIncomeTyp"/>
						</xsl:call-template>
					</div>
					<div class="IRS8865_LineDescLongSchK" style="width:22mm;padding-left:10px;border-bottom-width:1px;">
						<span style="font-weight:bold;">(2) </span>Amount 
					</div>
					<div class="IRS8865_LineIndexMid" style="font-size: 8pt;font-family:arial narrow;">11(2)</div>
					<div class="IRS8865_MoneyField">
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/OtherIncomeLossAmt"/>
						</xsl:call-template>
				...
				<span style="z-index:1;position:absolute;padding-top:1mm;padding-left:4mm;">
					<img src="{$ImagePath}/8865_Deductions.gif" height="65mm" width="10mm" alt="image displaying the word Deductions" border="0"/>
				</span>
				<!-- Schedule K line 12 -->
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LabelSpaceWide" style="height:4.5mm;padding-top:0.5mm;"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLongSchK" style="border-bottom-width:1px;width:65mm;border-right-width: 0px;">Other deductions
					<span style="font-style:italic;">(see instructions)</span>
						<xsl:call-template name="SetFormLinkInline">
					...
					<div class="IRS8865_LineIndexMid" style="font-size: 8pt;font-family:arial narrow;border-bottom-width:1px;">13d(2)</div>
					<div class="IRS8865_MoneyField">
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/OtherDeductionsAmt"/>
						</xsl:call-template>
				...
				<!-- superimposed image -->
					<span style="z-index:1;position:absolute;vertical-align: top;padding-left:1mm;" >
						<img src="{$ImagePath}/8865_International.gif" alt="image displaying the word International Transactions" border="0" height="70mm" width="33mm"/>
  					</span>
				<!-- Schedule K line 16 -->	
								
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LabelSpaceWide" style="height:19mm;padding-top:6mm;border-bottom:1px solid black;"/>

					<div class="IRS8865_LineIndex" style="height:19mm;padding-top:6mm;padding-right:9px;border-bottom:1px solid black;">
					
					16</div>
					<div class="IRS8865_LineDescLongSchK" style="height:19mm;padding-top:6mm;width:134mm;border-right-width:1px;border-bottom:1px solid black;">
						...
						<input type="checkbox" name="InternationalTaxRelevance" alt="international tax relevance" >
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/IntntlTaxRelevanceRptgInd"/>
							</xsl:call-template>
						</input>
						<label name="InternationalTaxRelevance">
							<xsl:call-template name="PopulateLabel">
								<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/IntntlTaxRelevanceRptgInd"/>
							</xsl:call-template>
						</label>
					</div>
					<div class="IRS8865_LineIndexMidFillerGray" style="height:19mm;padding-top:0.5mm;border-bottom:1px solid black;border-right:0px;"/>
					<div class="IRS8865_MoneyFieldFiller" style="height:19mm;padding-top:0.5mm;border-bottom:1px solid black;background-color:lightgrey;"/>
				</div>
					...
					<div style="float:left; width:93mm">
						...
						<div class="IRS8865_M12LineContainer">
							...
							<div class="IRS8865_LineDescLongSchM1" style="height:13mm">
								Expenses recorded on books this tax year not included on Schedule K, lines 1 through 13d, and 21 (itemize):
								<xsl:call-template name="SetFormLinkInline">
						...
						<div style="float:left; width:93.5mm">
							<div class="IRS8865_M12LineContainer">
								...
								<div class="IRS8865_LineDescLongSchM1" style="height:12mm;padding-top:1mm;">
								    Deductions included on Schedule K, lines 1 through 13d, and 21 not charged against book
					...
					<div style="float:left; width:93mm">
						...
						<div class="IRS8865_M12LineContainer">
							<div class="IRS8865_LineDescLongSchM1" style="width:62mm;">
								<span style="width:25.9mm;"/><b>b</b> Property<span style="width:2mm;"/>
								<span class="IRS8865_DotSpacing">......</span>
							</div>
							<div class="IRS8865_MoneyFieldFull" style="border-right:0;">
								<xsl:call-template name="PopulateAmount">
