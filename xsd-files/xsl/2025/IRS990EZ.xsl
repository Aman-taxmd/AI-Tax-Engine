				...
				<form name="IRS990EZ">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:133mm;height:31mm;padding-top;7mm;">
							...
							<div class="styFBT" style="font-size: 6.5pt; margin-top: 0px;text-align:left;padding-top:2mm;">Under 
							 section 501(c), 527, or 4947(a)(1) of the Internal Revenue Code (except private foundations)</div>
							<div class="styFBT" style="font-size:6.5pt; font-weight: bold; margin-top: 0px;padding-top:4mm;">
								Do not enter social security numbers on this form as it may be made public.
							</div>
							<br/>
							<br/>
							<div class="styFBT" style="font-size: 7pt; font-weight: bold; margin-top: 0px;
							 padding-top:.5mm;text-align:left;padding-left:1mm;">
								<span style="width:0mm"/>
								<span style="width:1mm"/>
								Go to
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form990EZ" 
								title="Link to IRS.gov"><i>www.IRS.gov/Form990EZ</i></a> 
					...
					<div class="styComType" style="width:187mm;border-bottom-width: 0px; font-size: 7pt">
						<div class="styBoldText" style="height:4.5mm;width:4mm;float:left;clear:none;padding-top:.5mm">
						 A</div>
						<div class="styBoldText" style="height:4.5mm;width:182mm;">
						  For calendar year 2025, or tax year beginning
							<span class="styFixedUnderline" style="float:none;text-align:left;width:12mm">
...
-->
              ...
              <span style="padding-left:2mm;font-size:6pt;" class="stySmallText">
						...
						<div class="styEINDateAssets" style="width:43mm;height:7.5mm;border-bottom:0px;padding-top:.5mm;">
							...
							<span style="width: 2mm"/>Number<span class="styIRS990EZNBSP"/>
					...
					<span style="width: 124.5mm;height:auto; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 0px;padding-bottom:0mm;float:left;padding-top:2mm;">
						...
						<span class="styIRS990EZUnderlinedBox" style="width:43mm; font-size: 6pt; font-family: arial">
							<xsl:call-template name="PopulateText">
					...
					<!-- Section H -->
					<span style="width: 62mm; font-size: 7pt; padding-left:2mm;padding-top:1mm;border-style: solid; border-left-width: 1px; 
					 border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px; padding-bottom:0mm;float:left;">
						<b>H</b>
						<span style="width: 2mm;"/>
						...
						<input type="checkbox" class="styIRS990EZCkBox" alt="ScheduleBNotRequiredInd">
							...
							<span class="styNormalText" style="font-size: 7pt;padding-left:1mm;">if the organization is <b>not</b>
							</span>
						</input>
						<label>
							<xsl:call-template name="PopulateLabel">
					...
					<!-- Section I -->
					<span style="height:auto;width: 125mm; border-style: solid; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 0mm;padding-bottom:2mm;float:left;">
						<b>I Website:</b>
						<span style="width: 1mm;"/>
						...
						<span style="width: 125mm; border-style: solid; border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 0mm;padding-top:0mm;float:left;">
							<span class="stySmallText" style="height:auto;">
  ...
  Add lines 5b, 6c, and 7b to line 9 to determine gross receipts. If gross receipts are $200,000 or more, or if total assets (Part II, column (B)  
					...
					<div class="styBB" style="width:187mm;clear:both;border-top-width:1px;">
						<div class="styPartName">Part <span style="font-size:8.75pt">&#8544;</span>
						</div>
            ...
            <span class="styNormalText" style="font-size: 7pt; width: 50mm"> (see the instructions for Part I) </span>
					...
					<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
						...
						<tbody valign="top">
							<tr>
								<td class="styIRS990EZImg" style="width: 4mm;border-style: solid; border-color: black;
							 border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; 
							 border-bottom-width: 1px" rowspan="18" valign="middle">
        ...
        Gain or (loss) from sale of assets other than inventory (Subtract line 5b from line 5a)  
          ...
          <span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
							...
							<tr>
								...
								<td class="styLNRightNumBox" style="width:8.25mm;height:4.5mm;border-right-width:1px;background-color:lightgrey;border-bottom-width:0px;"/>
							</tr>
							<!--   BEGIN LINE 6a   -->
							<tr>
						   ...
						   Gross income from gaming (attach Schedule G if greater than $15,000)
							...
							<tr>
								...
								<td class="styLNDesc" style="width:137mm;height:auto;padding-left:4mm;padding-top:1.5mm;">
									<!--Reserved-->
							...
							<td class="styLNRightNumBoxNBB" style="width:8.25mm;height:8.5mm;border-right-width:1px;
								...
								background-color:lightgrey"/>
									<td class="styLNLeftNumBox" style="width:5mm;height:4.5mm;padding-left:4mm;"/>
									<td class="styLNDesc" style="width:102mm;height:4.5mm;padding-left:9mm;">
										<!--Reserved-->
      ...
      Less: cost of goods sold
       ...
       Other revenue (describe in Schedule O) 
         ...
         <span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
							...
							<tr>
								<td class="styLNLeftNumBox" style="width:5mm;height:auto;padding-left:2mm;border-style: solid;
						 border-color: black; border-top-width: 0px; border-left-width: 0px; border-right-width: 0px; 
						 border-bottom-width: 1px;">9</td>
								<td class="styLNDesc" style="width:137mm;height:auto;padding-left:4mm; border-style: solid;
						 border-color: black; border-top-width: 0px; border-left-width: 0px; border-right-width: 0px; 
					...
					<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
						...
						<tbody valign="top">
							<tr>
								<td class="styIRS990EZImg" style="width: 4mm;border-style: solid; border-color: black;
					 border-left-width: 0px; border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px" rowspan="11" valign="middle">
    ...
    Form <span class="styBoldText" style="font-size: 8pt;"> 990-EZ </span> (2025)
					...
					<div style="width:187mm;padding-top:1mm;">
						<div style="float: left; clear: none">Form 990-EZ (2025)</div>
						<div style="float:right">
    ...
    Page <span class="styBoldText" style="font-size: 8pt">2</span>
					...
					<div class="styBB" style="float: none; clear:both; width: 187mm; border-top-width: 1px">
						<span class="styPartName">Part <span style="font-size:8.75pt">&#8545;</span>
						</span>
					...
					<div class="styIRS990EZLineItem">
						...
						<span class="styLNDesc" style="padding-left: 2mm; width: 109.5mm;">
							<span style="float:left;">
								<b>Net assets or fund balances</b> (line 27 of column (B) <b>must</b>
							 agree with line 21)</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;"/>
						</span>
						<div class="styLNAmountBoxNBB" style="border-left-width: 1px;width:34.75mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$IRS990EZData/NetAssetsOrFundBalancesGrp/BOYAmt"/>
							</xsl:call-template>
						</div>
						<span class="styLNRightNumBoxNBB" style="border-left-width: 1px;width:6mm;">27</span>
						<div class="styLNAmountBoxNBB" style="border-left-width: 1px;width:31.75mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styTableContainer" style="height:52mm;width:187mm;display:table;border-color: black; 
					 border-bottom-width: 1px; border-top-width: 1px;" id="SPctn">
						<table class="styTable" cellspacing="0" style="font-size:7pt;display:table;height:auto;">
							<tr>
								<td class="styTableCell" style="height: auto;text-align: left; width: 149mm; padding-top: 0;
								 padding-bottom: 0;display:inline;display:table;border-right-width: 0px;">
									<span class="styPartName">Part <span style="font-size: 8.75pt">&#8546;</span>
									</span>
									<span class="styPartDesc" style="width: 124mm;height:auto;">Statement of Program Service
									 Accomplishments <span class="styNormalText" style="font-size:6pt;"> (see the 
									 instructions for Part III)</span>
										<span class="styNormalText" style="font-size: 7pt; width:124mm;"> Check if the organization
										 used Schedule O to respond to any question in this Part III
								...
								<td class="styTableCell" style="height:auto;text-align:left; padding-left: 2mm; 
								 border-color: black; border-top-width: 0px; border-left-width: 1px;
								 border-right-width:0px;width:38mm; vertical-align:top;border-bottom-width:1px;" rowspan="6" colspan="2">
									<span style="text-align: center;font-weight: bold;padding-left:10mm;
									 font-size:7pt;">Expenses</span>
									<br/>
									<span style=" font-weight: normal; text-align: left; ">(Required for section 501(c)(3) 
									 and 501(c)(4) organizations; optional for others.)</span>
								</td>
							</tr>
							<tr>
								<td class="styTableCellNBB" style="height:auto;float: none; border-color: black;
								 border-left-width: 0px; border-right-width: 0px;width:149mm; font-weight: normal;
							...
							<tr>
								<td class="styTableCellHeader" style="height:auto;border-color: black;
								 border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px; 
								 width:149mm; font-weight: normal; text-align: left; display:table;">
								 Describe the organization’s program service accomplishments for each of its three largest
								 program services, as measured by expenses. In a clear and concise manner, describe the
								 services provided,   the number of persons benefited, and other relevant information for
								 each program title.
								</td>
							</tr>
							<tfoot/>
							<tbody>
								<xsl:for-each select="$IRS990EZData/ProgramSrvcAccomplishmentGrp">
									<xsl:if test="($Print != $Separated) or 
										(count($IRS990EZData/ProgramSrvcAccomplishmentGrp) &lt;=3)">
										<tr>
											<td class="styTableCell" style="height:auto;border-color: black;
											 border-bottom-width: 1px; border-right-width: 1px; border-left-width: 0px;
											 border-top-width: 0px; text-align:right; width: 149mm;
											 vertical-align:bottom;display:table;">
												<span style="float: left; clear: both; text-align: left;height:auto;">
													...
													<span>If this amount includes foreign grants, check here 
													<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt;
													 margin-left:2mm; margin-right:1mm">...</span>
														...
														<input type="checkbox" class="styCkbox" alt="ForeignGrantsInd" onclick="return false;">
															...
															<xsl:call-template name="PopulateCheckbox">
																...
																<xsl:with-param name="BackupName">IRS990EZForeignGrants<xsl:number value="position()"/>
																</xsl:with-param>
															</xsl:call-template>
														</input>
														<label>
											...
											<td class="styTableCell" style="height:auto;border-color: black; 
											 border-bottom-width: 1px; border-right-width: 1px; border-left-width: 0px; 
											 border-top-width: 0px; font-weight:bold; width: 6mm; vertical-align:top;">
												<xsl:choose>
											...
											border-top-width: 0px;vertical-align:top;font-size:7pt;">
												<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 1px; 
									 border-right-width: 1px; border-left-width: 0px; border-top-width: 0px; text-align:right; width: 149mm; ">
									...
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 1px; border-right-width: 1px; border-left-width: 0px;
									 border-top-width: 0px; width:6mm; text-align: center; font-weight: bold;vertical-align:bottom;">31a</td>
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 1px; border-right-width: 0px; border-left-width: 0px;
									 border-top-width: 0px; width: 32mm">
										<span style="width: 1px"/>
									</td>
								</tr>
								<tr>
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 0px; border-right-width: 1px; border-left-width: 0px;
									 border-top-width: 0px; text-align:left; width: 137mm;">
										<span style="float:left;">
											<b>32 Total program service expenses</b>  (add lines 28a through 31a)</span>
										<span class="styDotLn" style="float:right;padding-right:1mm;">..........
										</span>
									</td>
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 0px; border-right-width: 1px; border-left-width: 0px;
									 border-top-width: 0px; width:6mm; text-align: center; font-weight: bold">32</td>
									<td class="styTableCell" style="height:auto;border-color: black; border-bottom-width: 0px; border-right-width: 0px; border-left-width: 0px;
									 border-top-width: 0px; width: 50mm;font-size:7pt;">
										<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="height:auto;float:none; clear:both; width: 187mm;border-color: black; border-bottom-width: 1px; border-right-width: 0px; border-left-width: 0px; border-top-width: 1px;">
						<div class="styPartName" style="height:auto;">Part <span style="font-size: 8.75pt">&#8547;</span>
						</div>
    ...
    Page <span class="styBoldText" style="font-size: 8pt">3</span>
					...
					<div class="styBB" style="height:auto;float: none; clear:both; width: 187mm; border-top-width: 1px; border-bottom-width: 1px; font-size:8pt">
						<div class="styPartName" style="float:left;clear:none;height: 4.5mm;width:15mm; padding-top: .5mm">
							<b>Part <span style="font-size: 8.75pt">&#8548;</span>
							</b>
						</div>
    ...
    ; section 4955 <!--<img src="{$ImagePath}/990EZ_Bullet_Lg.gif" alt="bullet"/>-->
					...
					<div class="styIRS990EZLineItem">
						...
						<div class="styLNDesc" style="width:150mm;font-size:7pt">
							...
							<span style="float:left;white-space:nowrap;padding-left:1mm"> 4912, 4955, and 4958</span>
					...
					<div class="styIRS990EZLineItem" style="width: 187mm;">
						...
						<span class="styIRS990EZLNLongDesc" style="width: 180mm;font-size:6.5pt;height:6mm;margin-left: 0mm;
						 float: right;">
							...
							<span class="styIRS990EZUnderlinedBox" style="border-style: solid; width: 87mm;
							 font-size:5.85pt;height:auto;">
							...
							<!--<img src="{$ImagePath}/990EZ_Bullet_Lg.gif" alt="bullet"/>-->
							<span style="width: 3px"/>
							<span class="styIRS990EZUnderlinedBox" style="border-style: solid; width: 23mm; 
							 font-size:6.5pt;">
					...
					<div class="styIRS990EZLineItem" style="border-bottom-width: 0px">
						...
						<span class="styIRS990EZLNLongDesc" style="width: 135mm; font-size:7pt;height:auto;">
							<span style="float:left;">and enter the amount of tax-exempt interest received or accrued during
							 the tax year
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">....
							 <!--<img src="{$ImagePath}/990EZ_Bullet_Lg.gif" alt="bullet"/>-->
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="padding-left:4mm;">d</div>
						<div class="styLNDesc" style="width:150mm;">
							<span style="float:left;">If "Yes," to line 44c, has the organization filed a Form 720 to report these payments?  <i> If "No," provide an</i>
							</span>
							<br/>
							<span style="float:left;">
								<i>explanation in Schedule O </i>
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">............................</span>
						</div>
						<div class="styShadingCell" style="height:2.5mm;width:8mm;"/>
...
meaning of section 512(b)(13)? If "Yes," Form 990 and Schedule R may need to be completed instead of</span>
    ...
    Page <span class="styBoldText" style="font-size: 8pt">4</span>
					...
					<div style="width:187mm;float:none;display:block">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:2mm;"/>
						<div class="styLNDesc" style="width:150mm;height:4.5mm;padding-top:2mm;"/>
						<div class="styIRS990EZYesNoBox" style="width:8mm;height:6mm;border-left-width:0px;
						 border-bottom-width:1;padding-top:1mm;">
							<span style="width:1px;"/>
						</div>
						<div class="styIRS990EZYesNoBox" style="width:10mm;height:6mm;border-bottom-width:1;">
							<b>Yes</b>
						...
						<div class="styLNDesc" style="width:150mm;height:9.5mm;padding-top:2mm;">
							<span style="float:left;">Did the organization engage in lobbying activities or have a 
                                  section 501(h) 
      ...
      Complete this table for the organization's five highest compensated independent contractors who each received more than $100,000 of compensation from the organization. If there is none, enter "None."
						...
						<div class="styTable" style="height:auto;width: 187mm;" id="CDctn">
							<!--print logic-->
							<xsl:call-template name="SetInitialState"/>
							<!--end-->
							<table class="styTable" cellspacing="0">
					...
					<div style="width:187mm;float:none;">
						...
						<div class="styLNDesc" style="width:178mm;height:auto;padding-left:3mm;padding-top:2mm;">
							<span style="float:left;">Did the organization complete Schedule A? <b>NOTE.</b>  All section 501(c)(3)
                 organizations must attach a 
                 <br/> completed Schedule A
                 <!-- Dotted Line -->
								<span style="letter-spacing:2mm; font-weight:bold; font-size:7pt;
				 margin-left:1mm;">........................................
				</span>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;height:100%;display:inline;">
						...
						<tr>
							<td style="vertical-align:top;border-bottom:1px solid black;" colspan="2">Officer's name and title</td>
						</tr>
					</table>
...
-->
	...
	<!-- </label> -->
					...
					<!--   BEGIN FORM FOOTER  -->
					<div style="width:187mm;">
						<span style="float: right">Form <span class="styBoldText">990-EZ</span> (2025)</span>
					</div>
					<!--   END FORM FOOTER   -->
					<br/>
					<div class="pageEnd"/>
...
Special Condition Description</th>
					...
					<xsl:if test="(count($IRS990EZData/ProgramSrvcAccomplishmentGrp) &gt;3) and ($Print = $Separated)">
						<br/>
						<br/>
						<span class="styRepeatingDataTitle">Form 990EZ, Part III - Statement of Program Service 
						 Accomplishments</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="padding-top: 6mm; width:149mm;
									 text-align: left">
									 Describe the organization’s program service accomplishments for each of its three
									 largest program services, as measured by expenses.  In a clear and concise manner, 
									 describe the services provided,   the number of persons benefited, and other relevant
									 information for each program title.
									</th>
									<th class="styDepTblCell" scope="col" style="width:38mm" colspan="2">
									 Expenses<br/> (Required for section 501(c)(3) and 501(c)(4) organizations; optional for
									 others.)
									</th>
								</tr>
							</thead>
								...
								<xsl:for-each select="$IRS990EZData/ProgramSrvcAccomplishmentGrp">
									<xsl:if test="($Print = $Separated) or (count($IRS990EZData/ProgramSrvcAccomplishmentGrp) &gt;=3)">
										<tr>
											...
											<td class="styDepTblCell" style="border-color: black; border-bottom-width: 1\px; border-right-width: 1px; border-left-width: 0px; border-top-width: 0px; text-align:right; width: 149mm;vertical-align:top;">
												<span style="float: left; clear: none; text-align: left">
													<xsl:choose>
														<xsl:when test="position()=1">
															<b>28 </b>
					...
					<xsl:if test="(count($IRS990EZData/OfficerDirectorTrusteeEmplGrp) &gt;3) and ($Print = $Separated)">
						<br/>
						<br/>
						<span class="styRepeatingDataTitle" style="height:auto;">Form 990EZ, Part <span style="font-size: 8.75pt">&#8547;</span> &#8212; List of Officers, Directors, Trustees, and Key Employees<span class="styNormalText" style="font-size: 7pt"> (list each one even if not compensated ; see the instructions for Part IV)</span>
						</span>
						<span class="styNormalText" style="font-size: 7pt; width:163mm">
							<span style="float:left;">Check if the organization used Schedule O to respond to any question in this Part IV</span>
							<!-- Dotted Line -->
						...
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" style="border-color: black; border-bottom-width: 1px; border-right-width: 1px; border-left-width: 0px; border-top-width: 0px; text-align: center;vertical-align:top;">
										<b>(d)</b> Health benefits, contributions to<br/>employee benefit plans, and<!--&amp;-->
										<br/> deferred compensation</th>
