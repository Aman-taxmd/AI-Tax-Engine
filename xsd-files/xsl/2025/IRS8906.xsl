...
<!--
UWR 1000342: R10.9 Drop 2 - 04/29/2025 - Updated By Developer Fahd M. Saleem
-->
		...
		<xsl:call-template name="InitJS"/>
          ...
          <div class="styFST" style="height:4mm;font-size:7pt;padding-top:.5mm;">
				  ...
				  <div class="styTYBox" style="width:30mm;height:21mm;">
					...
					<div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">25</span></div>
				...
				<div class="styBB" style="width:187mm;">
				  ...
				  <div style="width:187mm;">
					...
					<span style="float:left;">Average tax-financing cost per case</span>
					  ...
					  <div class="styLNAmountBox" style="text-align:center;">0.29717</div>
					</div>
					<!--End of line 2 -->
					<!--Line 3 -->
					<div style="width:187mm;">
					...
					<div style="width:187mm;text-align:right;">
					  ...
					  <span style="width:90mm;">Form <span class="styBoldText" style="font-size:9pt;">8906</span> (2025)</span>
					</div>
					<!--br class="pageEnd"/-->
					<!-- Adding page break -->
					<p class="pageend"/>
