...
<!DOCTYPE xsl:stylesheet [ <!ENTITY nbsp "&#160;"> <!ENTITY mdash "&#8212;"> ]>
    <!-- Last Modified by Iskilu Lawal on 08/07/2025 drop 1 UWR # 1001759 -->
			...
			<body class="styBodyClass">
				...
				<!-- ********************************************************************************************************************* -->
					<div class="styArialText" style="height:20mm;font-size:9pt;width:187mm;border-top:0px solid black;border-bottom:1px solid black;">
						...
						Use this form if your taxable income, before your qualified business income deduction, is at or below $197,300						   (					           $394,600 if married filing jointly), and you aren’t a patron of an agricultural or horticultural cooperative.</i>
					</div>
			<!-- ********************************************************************************************************************* -->
					<!-- Table 1, cols (a)-(e) -->
...
(see instructions)
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <strong>8995</strong> (2025)</span>
					</div>
