		...
		<html>
			...
			<body class="styBodyClass">
              ...
              <xsl:with-param name="TargetNode" select="$FormData"/>
							...
							<div style="padding-top:2.5mm;padding-bottom:.5mm;">
		...
		Go to <!--www.irs.gov/form990.--><a href="http://www.irs.gov/form990" title="Link to IRS.gov">
                <i>www.irs.gov/Form990</i></a> for instructions and the latest information. 
						...
						<div class="styTYBox" style="width:30mm;float:right;height:auto;">
							<div class="styOMB" style="height:7mm;padding-top:6mm;padding-bottom:10mm;">OMB No. 1545-0047</div>
							<div class="styPartName" style="height:7.75mm; width:30mm;padding-top:0.3mm;padding-bottom:0.3mm;">Open to Public Inspection</div>
						</div>
					</div>
...
<!-- Footer -->
					...
					<div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageEnd">
						<div class="styGenericDiv" style="width:105mm;font-weight:bold">For Paperwork Reduction Act Notice, see the Instructions for Form 990. </div>
						<div class="styGenericDiv" style="width:25mm;">Cat. No. 50053T</div>
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText">Schedule J (Form 990) (Rev. 1-2025)</span>
						</div>
					</div>
					<br/>
					<!-- header -->
					...
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;border-bottom-width:0px" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule J (Form 990) (Rev. 1-2025)</div>
...
<!--==============================Part II Table ======================================-->
					...
					<div class="styTableContainerLandscape" id="p2TbCtnr" style="border-bottom-width:0px;">
