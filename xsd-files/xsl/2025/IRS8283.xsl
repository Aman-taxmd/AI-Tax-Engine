...
originally reported, if different from above. <br/>
					...
					<div style="width:187mm;" id="TPctn" class="styTableContainerNBB">
						...
						<table cellspacing="0" style="" name="TYTable" id="TYTable" class="styTable">
							...
							<thead class="styTableThead">
								<tr>
									<th scope="col" class="styTableCell" style="width:6mm;text-align:center;font-size:7pt;font-weight:bold;border-color:black;border-right:none;vertical-align:top;">1</th>
									...
									<th scope="col" class="styTableCell" style="width:60mm;text-align:center;font-size:7pt;border-color:black;border-right:none;font-weight:normal;vertical-align:top;">
					...
					<div style="width:187mm;">
						...
						<!-- Line 2 a  -->
						<span style="width:60mm;height:4.5mm;text-align:left;">
							<b>a </b>
					...
					<div style="width:187mm;">
						...
						<!-- Line 2 b1 -->
						<span style="width:50mm;height:4.5mm;text-align:left;">
							<b>b1</b>
							<span style="width:1mm"/>
					...
					<div class="styIRS8283TableContainer" style="width:187mm;" id="TP2ctn">
						...
						<table cellspacing="0" style="" class="styTable">
							<thead class="styTableThead">
								<tr>
									<th scope="col" colspan="2" class="styTableCell" style="width:77mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;vertical-align:top;">
									...
									<th scope="col" class="styTableCell" style="width:75mm;text-align:center;font-size:7pt;border-color:black;border-top-width:1px;font-weight:normal;vertical-align:top;">
										<b>(b)</b>
										<span style="width:1px;"/>
					...
					<div style="width:187mm;">
						...
						<div class="styTableContainerForTP3ctn" style="height:auto;" id="TP3ctn">
							...
							<table cellspacing="0" class="styTable" style=" border-bottom: 0px;">
								<thead class="styTableThead">
									<tr>
										<th scope="col" rowspan="2" colspan="1" class="styTableCell" style="width:7mm;background-color:lightgrey;border-right:1px solid black;border-bottom:1px solid black;vertical-align:top;">
											<span style="width:1mm;"/>
										</th>
										<th scope="col" rowspan="2" colspan="1" class="styTableCell" style="width:23mm;text-align:center;font-size:7pt;border-color:black;left-margin:3mm;font-weight:normal;vertical-align:top;">
											<b>(d)</b>
											<span style="width:1mm;"/>Date acquired by donor (mo., yr.)</th>
										<th scope="col" rowspan="2" class="styTableCell" style="width:27mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
											<b>(e)</b>
											<span style="width:1mm;"/>How acquired by donor</th>
										<th scope="col" rowspan="2" class="styTableCell" style="width:30mm;text-align:center;font-size:7pt;border-color:black;font-weight:normal;vertical-align:top;">
											<b>(f)</b>
											...
											<div class="styLNDesc" style="width:179mm;height:4mm;font-weight:normal;">
												...
												<div class="" style="float:right;">
													...
													<span style="width:32mm;border-bottom:1px solid black;padding-left:3mm;">
														<xsl:choose>
															<xsl:when test="((count($Form8283Data/PropertyInformation)
...
checked automatically on line 5a, the reference linking needs to be removed. This should NOT happen.
					...
					<div class="styBB" style="width:187mm;border-top-width:0px;font-family:verdana;font-size:8pt;">
						<div class="styPartName" style="float:left;clear:none;">
							<b>Part III</b>
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:187mm;"/>
						<div style="width:49mm;border-bottom:1px solid black;padding-left:1mm;clear:none;height:auto;" class="styGenericDiv">
					...
					<div style="width:187mm;border-top-width:1px;">
						...
						<div class="styEINBox" style="font-family:Arial;font-size:7pt;width:47mm;padding-left: 2mm;">
							...
							<span style="font weight:normal;padding-top:2mm;">
								<xsl:choose>
									<xsl:when test="$Form8283Data/AppraiserSSN != ''">
										<xsl:call-template name="PopulateSSN">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserSSN"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="PopulateEIN">
											<xsl:with-param name="TargetNode" select="$Form8283Data/AppraiserEIN"/>
										</xsl:call-template>
									</xsl:otherwise>
								</xsl:choose>
							</span>
								...
								<tr>
									<td colspan="7" class="styTableCell" style="width:187mm;text-align:left;font-size:7pt;border-right:none;">
										...
										<div class="styDepTblRow1" style="width:187mm;">
											...
											<div class="styLNDesc" style="width:179mm;height:7mm;border-color:black;border-style:solid;
