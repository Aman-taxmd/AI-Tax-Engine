			...
			<body class="styBodyClass">
				...
				<br/>
					...
					<!--		<div class="styLNLeftNumBox" style="padding-left:2mm;padding-top:1mm;">1</div> -->
                            ...
                            <span class="styBoldText"> A </span> Enter the total number of qualified alternative fuel vehicle refueling properties for which you are claiming this credit, 
                                      and complete and file a separate Schedule A (Form 8911) for each qualifying property (see instructions) 
                            <div class="styDotLn" style="float:none">.......</div> 
                            <span style="width:37mm;font-size:7pt;text-align:right;border-bottom:solid black 1px;">
                            <xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8911/TotQlfyAltFuelVehRefuelPropCnt"/>
								</xsl:call-template>
         			         </span>
							</div>
						</div>
			   ...
			   of line 4 or line 9 here and on Schedule 3 (Form 1040), <br/>line 6j; or the appropriate line of your return. If line 9 is smaller than line 4, see instructions 			
                <!--Dotted Line-->
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<span style="width:50mm;text-align:right;"> Form <b>8911</b> (Rev. 12-2025)</span>
						</div>
					</div>
