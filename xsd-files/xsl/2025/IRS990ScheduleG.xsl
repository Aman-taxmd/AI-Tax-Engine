...
<!-- 11/30/2022 - Changes made for defect 71630 - Jeremy Nichols -->
<!-- 12/01/2022 - Changes made for defect 71622 - Jeremy Nichols -->
<!-- 12/05/2022 - Changes made for KISAM IM02170282 - Jeremy Nichols -->
<!-- 03/03/2022 - Changes made for 2022 pdf review - Jeremy Nichols -->
<!-- 10/16/2023 - Changes made for UWR 970905 - Jeremy Nichols -->
<!-- 02/06/2024 - defect 1320148 - Jeremy Nichols -->
<!-- 08/21/2024 - Changes made for UWR 981239 - Jeremy Nichols -->
<!-- 09/30/2024 - Changes made pdf review 10.8 Drop 4 - Jeremy Nichols -->
<!-- 11/08/2024 - defect 1558716 - Jeremy Nichols -->
<!-- 03/18/2025 - defect 1558716 - Jeremy Nichols -->
<!-- 07/29/2025 - Changes made for UWR 1002029 - Jeremy Nichols -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
        ...
        <form name="Form990ScheduleG">
          ...
          <div class="styTBB" style="width:187mm;display:block;">
            ...
            <div class="styFTBox" style="height:23mm;width:122mm;">
              ...
              <div class="styFBT" style="margin-top:0mm;font-weight:bold;">
				...
				<br/>
                <span style="width:122mm;font-size:5.5pt;font-weight:bold;">
					Go to <i>www.irs.gov/Form990</i> for instructions and the latest information. 
				</span>
              </div>
            </div>
            <div class="styTYBox" style="width:31.5mm;height:23mm;">
              <div class="styOMB" style="width:31.5mm;height:15mm;padding-top:6mm;">OMB No. 1545-0047</div>
          ...
          <div class="IRS990ScheduleG_LineContainer" style="padding-top:1mm;">
            ...
            <span style="display:inline;">
              ...
              <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckAgrmtProfFundraisingActyYes" alt="CheckAgrmtProfFundraisingActyYes">
            ...
            <span style="display:inline;">
              ...
              <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckAgrmtProfFundraisingActyNo" alt="CheckAgrmtProfFundraisingActyNo">
        ...
        <div class="styNBB" style="width:187mm;float:left;clear:none;">
            ...
            <xsl:call-template name="SetInitialState"/> 
              <table class="styTable" cellspacing="0" cellpadding="0" style="font-size:7pt;overflow-y:auto;">
                <thead class="styTableThead">
                  ...
                  <tr>
                    <td scope="col" style="border-right:1px solid black;" colspan="2">
          ...
          <div style="display:block;">
            <div class="styBB" style="width:187mm; padding-bottom:.5mm;">  
              <div style="float:left;">Schedule G (Form 990) (Rev. 1-2025)</div>
            ...
            <table class="styTable" style="font-size: 7pt;height:auto;width:187mm;display:inline;" cellspacing="0" cellpadding="0">
				<tr>
					<td class="styIRS990ScheduleGVTImageBox" style="height:49.5mm;width:6mm;padding-top:0mm;border-bottom-width:1px;">
						<br/><br/><br/><br/><br/><br/>
					...
					<td>
						<table class="styTable" style="font-size: 7pt;height:auto;width:181mm;display:inline;" cellspacing="0" cellpadding="0">
							<tr>
							  <td colspan="2" style="height:30mm;width:53mm;float:left;clear:none;display:inline;">
							  ...
							  <th class="styLNAmountBox" scope="col" style="width:32mm;height:30mm;vertical-align:top;padding-top:.5mm;text-align:center;display:inline;">
								<b>(a)</b>
								<span class="styNormalText" style="display:inline;"> Event #1</span>
								<br/>
								<br/>
							  ...
							  <th class="styLNAmountBox" scope="col" style="height:30mm;width:32mm;vertical-align:top;padding-top:0.5mm;text-align:center;display:inline;">
								<b>(c)</b>
								<span class="styNormalText" style="display:inline;"> Other events</span>
								<br/>
								<br/>
								<span class="styIRS990ScheduleGUnderlinedBox" style="height:auto;">
								  <xsl:call-template name="PopulateAmount">
			...
			<table class="styTable" style="font-size: 7pt;height:auto;width:187mm;display:inline;" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td>
						<table class="styTable" style="font-size: 7pt;height:auto;width:181mm;display:inline;" cellspacing="0" cellpadding="0">
							<tr>
							  <td colspan="2" style="height:12mm;width:53mm;float:left;clear:none;display:inline;">
								<span style="width: 53mm;display:inline;"/>
							  </td>               
    ...
    <div style="width:187mm;">
      ...
      <div class="styLNLeftNumBox" style="width:8mm;padding-bottom:.5mm;padding-left:1mm;font-size:7pt;float:left;"><br/>9</div>
      <div class="styLNDesc" style="width:179mm;height:auto;padding-top:.5mm;padding-bottom:0mm;font-size:7pt;float:left;">
        <span class="styNormalText;height:auto;">
          Enter the state(s) in which the organization conducts gaming activities: </span>
          <span style="font-size: 7pt;height:auto; width:88mm;text-align: left;border-bottom:1px solid black;">
    ...
    <!-- Line 9a  -->
        ...
        <div style="height:5mm;font-size:7pt;vertical-align:center;display:inline;" id="CheckLicensedInd">
          <label id="CheckLicensed">
            <xsl:call-template name="PopulateLabel">
              <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicensedInd"/>
            </xsl:call-template>
            <span></span>
          </label>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check Licensed Yes">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicensedInd"/>
              </xsl:call-template>
            </input>
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check Licensed No">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicensedInd"/>
              </xsl:call-template>
            </input>
...
<!-- LINE  10a  -->
      ...
      <div style="height:5mm;padding-top:1mm;font-size:7pt;vertical-align:center;">
          <label id="CheckLicenseSuspendedEtc">
            <xsl:call-template name="PopulateLabel">
              <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicenseSuspendedEtcInd"/>
            </xsl:call-template>
            <span></span>
          </label>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check License Suspended Etc Yes">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicenseSuspendedEtcInd"/>
              </xsl:call-template>
            </input>
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check License Suspended Etc No">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/LicenseSuspendedEtcInd"/>
              </xsl:call-template>
            </input>
 ...
 <xsl:if test="string-length($Form990ScheduleGData/ExplanationIfYesTxt) &lt;1">
   <div class="IRS990ScheduleG_LineContainer">
    ...
    <div class="pageEnd" style="width:187mm;">
      <span style="width:141.5mm;"/>
      <span style="font-weight:bold;font-size:6pt;text-align:right;">Schedule G (Form 990) (Rev. 1-2025)</span>
    </div>
 
     <!-- PAGE 3 HEADER  -->
          <div style="display:block;">
 <div class="styBB" style="width:187mm; padding-bottom:.5mm;border-bottom-width:1.75px;">  
    <div style="float:left;font-size;6pt;">Schedule G (Form 990) (Rev. 1-2025)</div>
...
<!-- END Page Header  -->  
  ...
  <!-- Line 11  -->
      ...
      <div class="styLNDesc" style="width:150mm;height:3mm;padding-top:1mm;padding-bottom:0mm;">
        ...
        <div style="height:5mm;padding-top:1mm;font-size:7pt;vertical-align:center;">
          <label id="CheckGamingWithNonmembers">
            <xsl:call-template name="PopulateLabel">
              <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingWithNonmembersInd"/>
            </xsl:call-template>
            <span></span>
          </label>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check Gaming With Nonmembers Yes">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingWithNonmembersInd"/>
              </xsl:call-template>
            </input>
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="CheckGamingWithNonmembersNo">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingWithNonmembersInd"/>
              </xsl:call-template>
            </input>
    ...
    <div class="styBB" style="border-bottom-width:0px;">
     <div style="width:187mm;">
      ...
      <div class="styLNDesc" style="width:150mm;height:4mm;padding-top:1mm;font-size:7pt;">
        ...
        <div style="height:5mm;padding-top:1mm;font-size:7pt;vertical-align:center;">
          <label id="CheckMemberOfOtherEntity">
            <xsl:call-template name="PopulateLabel">
              <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/MemberOfOtherEntityInd"/>
            </xsl:call-template>
            <span></span>
          </label>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check Member Of Other Entity Yes">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/MemberOfOtherEntityInd"/>
              </xsl:call-template>
            </input>
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" alt="Check Member Of Other Entity No">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/MemberOfOtherEntityInd"/>
              </xsl:call-template>
            </input>
...
<!--  LINE  15a  -->
     ...
     <div style="width:187mm;">
      ...
      <div class="styLNDesc" style="width:150mm;height:4mm;padding-top:1mm;font-size:7pt;">
        ...
        <div style="height:5mm;padding-top:1mm;font-size:7pt;vertical-align:center;">
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckCntrctWith3rdPrtyForGameRevYes" alt="CheckCntrctWith3rdPrtyForGameRevYes">
              <xsl:call-template name="PopulateYesCheckbox">
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckCntrctWith3rdPrtyForGameRevNo" alt="CheckCntrctWith3rdPrtyForGameRevNo">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/CntrctWith3rdPrtyForGameRevInd"/>
...
<!--  Line 15b  -->  
 <div style="width: 187mm">
    ...
    <div class="styLNDesc" style="width: 155mm">
      If "Yes," enter the amount of gaming revenue received by the organization $  <span class="styIRS990ScheduleGUnderlinedText" style="text-align: right">  
          <xsl:call-template name="PopulateAmount">
  ...
  <div style="width: 187mm">
    ...
    <div class="styLNDesc" style="width: 155mm;height:3mm;">
        amount of gaming revenue retained by the third party $ <span class="styIRS990ScheduleGUnderlinedText" style="text-align: right">
          <xsl:call-template name="PopulateAmount">
...
<!-- LINE  16  -->
      <div style="width:187mm">
        <div class="styLNLeftNumBox" style="height:5mm;padding-left:0mm;">16</div>
         <div class="styLNDesc" style="width:155mm;height:5mm;padding-bottom:0mm;">
   ...
   <div class="IRS990ScheduleG_LineContainer">
    ...
    <div style="width:187mm;">
      ...
      <div class="styLNDesc" style="width:155mm;height:3mm;padding-top:0mm;padding-bottom:0mm;font-size:7pt;">
        <span class="styNormalText">
          Gaming manager compensation  $ </span>
     ...
     <div class="styLNLeftNumBox" style="height:4mm;"/>
      <div class="styLNDesc" style="width:155mm;height:5mm;"> 
       <span style="width:50mm;">
        <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckGamingManagerIsDirectorOfficer" alt="CheckGamingManagerIsDirectorOfficer">
         <xsl:call-template name="PopulateCheckbox">
      ...
      <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckGamingManagerIsEmployee" alt="CheckGamingManagerIsEmployee">
         <xsl:call-template name="PopulateCheckbox">
      ...
      <span style="width:45mm;">
      <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckGamingManagerIsIndContractor" alt="CheckGamingManagerIsIndContractor">
         <xsl:call-template name="PopulateCheckbox">
   ...
   <!--  Line 17a  -->
     <div style="width:187mm;">
      ...
      <div class="styLNDesc" style="width:150mm;height:4mm;padding-top:1mm;font-size:7pt;">
        ...
        <div style="height:5mm;padding-top:1mm;font-size:7pt;vertical-align:center;">
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckCharitableDistributionRqrYes" alt="CheckCharitableDistributionRqrYes">
              <xsl:call-template name="PopulateYesCheckbox">
          ...
          <span style="width:2mm;"/>
            <input type="checkbox" class="styCkbox" style="height:3mm;width:3mm;" id="CheckCharitableDistributionRqrNo" alt="CheckCharitableDistributionRqrNo">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/CharitableDistributionRqrInd"/>
...
<div style="width: 187mm;">
 ...
 <!-- Page Footer -->
    <div class="pageEnd" style="width:187mm;">
      ...
      <span style="font-weight:bold;font-size:6pt;">Schedule G (Form 990) (Rev. 1-2025)</span>
    </div>
