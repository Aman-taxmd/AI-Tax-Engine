...
<!-- 06/17/2024 - defect 1322923 - Jeremy Nichols -->
...
<!-- + Main Header Title +-->
				...
				<br/>
<!-- + Tag Line 1 + -->
				<span style="font-weight:bold; padding-top:.5mm; text-align:center;">
					Complete if the organization answered "Yes" on Form 990, Part IV, lines 31 or 32; or Form 990-EZ, line 36. 
				</span>
			<br/>
<!-- + Tag Line 2 + -->
				<span style="width:162mm; font-weight:bold; padding-top:.5mm; text-align:center;">
...
<!-- ++ Line 2 Question  ++ -->	
	...
	<div style="width: 256mm;">
		...
		<div class="styLNDescLandscape" style="width: 223mm;">
			...
			<span style="width:1mm;"/><span style="letter-spacing: 4mm; font-weight: bold;">...........................  </span>
		</div>
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">DirectorOfSuccessor</xsl:with-param>
                  </xsl:call-template>2a
			</label>
		</div>
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
			  <xsl:call-template name="PopulateLabel">
				...
				<xsl:with-param name="BackupName">EmployeeOfSuccessor</xsl:with-param>
			  </xsl:call-template>2b
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
...
<!-- ++ Line 2c Question - Populate Yes/No Box Text ++ -->		
	<div style="width: 256mm;">
		...
		<div class="styLNDescLandscape" style="width: 223mm;">Become a direct or indirect owner of a successor or transferee organization? 
			<span style="width:4mm;"/><span style="letter-spacing: 4mm; font-weight: bold;">.........................  </span>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
			  <xsl:call-template name="PopulateLabel">
				<xsl:with-param name="TargetNode" select="$FormData/OwnerOfSuccessorInd"/>
				<xsl:with-param name="BackupName">OwnerOfSuccessor</xsl:with-param>
			  </xsl:call-template>2c
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
...
<!-- ++ Line 2d Question - Populate Yes/No Box Text ++ -->	
	<div style="width: 256mm;">
		...
		<div class="styLNDescLandscape" style="width: 223mm;">
			...
			<span style="width:3mm;"/><span style="letter-spacing: 4mm; font-weight: bold;">........</span>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
			  <xsl:call-template name="PopulateLabel">
				<xsl:with-param name="TargetNode" select="$FormData/ReceiveCompensationInd"/>
				<xsl:with-param name="BackupName">ReceiveCompensation</xsl:with-param>
			  </xsl:call-template>2d
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
...
<!-- ++ Line 3 Question - Populate Yes/No ++ -->	
			...
			<div style="width:256mm;">
				...
				<div class="styLNDescLandscape" style="width:223mm">Did the organization distribute its assets in accordance with its governing instrument(s)?  If "No," describe in Part III    
					<span style="width:2mm;"/><span style="letter-spacing:4mm; font-weight:bold; ">...............</span>
				</div>
...
<!-- ++ Line 4b Question - Populate Yes/No ++ -->		
		<div style="width:256mm;">
			...
			<div class="styLNDescLandscape" style="width:223mm">
				...
				<span style="width:1.5mm;"/><span style="letter-spacing:4mm; font-weight:bold; ">................................</span>
			</div>
			<div class="IRS990ScheduleN_LineIndexMid" style="width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:1px;border-left-width:1px;">
				4b
			</div>
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">DirectorOfSuccessorPartII</xsl:with-param>
                  </xsl:call-template>2a
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/DirectorOfSuccessor2Ind"/>
						<xsl:with-param name="BackupName">DirectorOfSuccessorPartIIYes</xsl:with-param>
			</xsl:call-template>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px; border-right-width: 0px;">
			<xsl:call-template name="PopulateNoBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/DirectorOfSuccessor2Ind"/>
						<xsl:with-param name="BackupName">DirectorOfSuccessorPartIINo</xsl:with-param>
			</xsl:call-template>
		</div>
	</div>
<!-- ++ Line 2b Question - Populate Yes/No Box Text ++ -->	
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">EmployeeOfSuccessorPartII</xsl:with-param>
                  </xsl:call-template>2b
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/EmployeeOfSuccessor2Ind"/>
				<xsl:with-param name="BackupName">EmployeeOfSuccessorPartIIYes</xsl:with-param>
			</xsl:call-template>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px; border-right-width: 0px;">
			<xsl:call-template name="PopulateNoBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/EmployeeOfSuccessor2Ind"/>
				<xsl:with-param name="BackupName">EmployeeOfSuccessorPartIINo</xsl:with-param>
			</xsl:call-template>
		</div>
	</div>
<!-- ++ Line 2c Question - Populate Yes/No Box Text ++ -->		
	<div style="width: 256mm;">
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">OwnerOfSuccessorPartII</xsl:with-param>
                  </xsl:call-template>2c
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
		<xsl:call-template name="PopulateYesBoxText">
			<xsl:with-param name="TargetNode" select="$FormData/OwnerOfSuccessor2Ind"/>
				<xsl:with-param name="BackupName">OwnerOfSuccessorPartIIYes</xsl:with-param>
			</xsl:call-template>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:0px">
			<xsl:call-template name="PopulateNoBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/OwnerOfSuccessor2Ind"/>
				<xsl:with-param name="BackupName">OwnerOfSuccessorPartIINo</xsl:with-param>
			</xsl:call-template>
		</div>
	</div>
<!-- ++ Line 2d Question - Populate Yes/No Box Text ++ -->	
		...
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; border-top-width: 0px; border-right-width: 1px; border-left-width: 1px;">
			<label>
                  <xsl:call-template name="PopulateLabel">
                    ...
                    <xsl:with-param name="BackupName">ReceiveCompensationPartII</xsl:with-param>
                  </xsl:call-template>2d
			</label>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="width: 8mm; height: 4mm; padding-top: 0mm; font-weight: normal; border-top-width: 0px;">
			<xsl:call-template name="PopulateYesBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/ReceiveCompensation2Ind"/>
				<xsl:with-param name="BackupName">ReceiveCompensationPartIIYes</xsl:with-param>
			</xsl:call-template>
		</div>
		<div class="IRS990ScheduleN_LineIndexMid" style="font-weight:normal;width:8mm;height:4mm;border-top-width:0px;padding-top:0mm;border-right-width:0px">
			<xsl:call-template name="PopulateNoBoxText">
				<xsl:with-param name="TargetNode" select="$FormData/ReceiveCompensation2Ind"/>
				<xsl:with-param name="BackupName">ReceiveCompensationPartIINo</xsl:with-param>
			</xsl:call-template>
		</div>
	</div>
<!-- ++ Line 2e - Question - Populate Yes/No Box Text ++ -->	
				...
				<!--	<xsl:call-template name="SetInitialDynamicTableHeight">
					...
					<div class="pageEnd" style="width:256mm">
						<div style="float:right;">
							...
							<span class="styBoldText"> Schedule N (Form 990) (2025)</span>
						</div>
					</div>
					<!--END Page Footer-->
