...
<!-- Updated By Iskilu Lawal TY2025_IRS8919_UWR # 1003221__REL10.9_Drop3 07242025 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<form name="Form8919">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:135mm;border-right:1px solid black;border-left:1px solid black;height:20mm;padding-top:2mm;">
							...
							<div class="styFBT" style="height:4mm;margin-top:0mm;padding-top:1mm;">
								<!--<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/>-->
										Attach to Form 1040, 1040-SR, 1040-NR, or 1040-SS. <br/> 
						...
						<div class="styTYBox" style="width:25.5mm;border-left:none;padding-top:.5mm;">
							...
							<div class="styTaxYear">20<span class="styTYColor">25</span>
							</div>
					...
					<div style="width:187mm;border-bottom:none;">
						...
						<div class="styCodes" style="width:187mm; height:auto;font-size:7.5pt;padding-left:17mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
							...
							<span style="width:161mm;float:left;">
									I received other correspondence from the IRS stating that I am an employee.
								</span>
							<br/>
							<br/>
							...
							<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC and/or 1099-NEC from this firm for 2025. The amount on Form 1099-MISC and/or 1099-NEC should have been included as wages on Form W-2. <b>(Don't file Form SS-8 if you select reason code H.)</b>
							</span>
						</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
							<div style="float:left;">Add lines 11 and 12. Enter here. Include as tax on your annual tax return (Schedule 2 (Form 1040), line 6, or Form 1040-SS, Part I, line 6c). See the instructions there
									<!--Dotted Line-->
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2025)
								</div>
					</div>
	...
	<xsl:template name="CreateTableHeaders">
		<tr class="styDepTblHdr">
			<th scope="col" class="styTableCell" style="width:47mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;padding-top:8mm;" colspan="2">
				<b>(a)</b>Name of firm
			</th>
			...
			<th scope="col" class="styTableCell" style="width:23mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;padding-top:4mm;">
			...
			<th scope="col" class="styTableCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
		...
		<tr>
			...
			<td class="styTableCell">
				<xsl:attribute name="style">
							width:4mm;text-align:center;border-right:none;font-weight:bold;vertical-align:top;
	...
	<xsl:template name="CreateEmptyTableRows">
		...
		<tr>
			<td class="styTableCell" style="text-align:center;border-right:none;font-weight:bold;vertical-align:top;">
				<xsl:value-of select="$Number"/>
			</td>
			<!--Employer Name-->
			<td class="styTableCell" style="font-size: 7pt; text-align:left;">
				<span style="width:4px"/>
			...
			<!--Employer EIN-->
			<td class="styTableCell" style="font-size: 7pt; text-align:center;">
				<span style="width:4px"/>
			</td>
			<!--Reason Code-->
			<td class="styTableCell" style="font-size: 7pt; text-align:center;">
			...
			<!--Amount-->
			<td class="styTableCell" style="font-size: 7pt; text-align:center;border-right-width:0px;">
				<span style="width:4px"/>
			</td>
		</tr>
	</xsl:template>
	<xsl:template name="CreateTableHeaders1">
		<tr class="">
			...
			<th scope="col" class="styTableCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;padding-top:4mm;">
				<b>(b)</b>Firm's federal<br/>identification<br/>number<br/>(see instructions)
			</th>
			...
			<th scope="col" class="styTableCell" style="width:33.5mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;padding-top:2mm;">
				<b>(d)</b>Date of IRS<br/>determination or<br/>correspondence<label for="receivedInd"/>
				<br/>(MM/DD/YYYY)<br/>(see instructions)
			</th>
	...
	<xsl:template name="CreateTableRows1">
		<tr>
			...
			<td class="styTableCell">
				<xsl:attribute name="style">
							width:4mm;font-size:7pt;text-align:center;border-right:none;font-weight:bold;vertical-align:top;
							<xsl:if test="(position() &gt; 5) and (position() = last())">
								border-bottom-width:0px;
							</xsl:if></xsl:attribute>
				<xsl:value-of select="$RowNumber"/>
