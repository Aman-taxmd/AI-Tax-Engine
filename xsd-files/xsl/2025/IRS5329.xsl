...
<!-- Last Modified by lawal on 10/14/2025 07302025 -->
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <body class="styBodyClass">
        <form name="IRS5329">
          ...
          <div class="styBB" style="height:18mm;width:187mm;border-bottom-width:2px;float:none;clear:both;">
            <div class="styFNBox" style="height:18mm;width:28mm;border-right-width:1px;padding-top:.4mm;">
            ...
            <div class="styFTBox" style="width:129mm;">
              ...
              <div class="styFST" style="height:5mm;width:128mm;font-size:7pt;margin-left:0mm;text-align:center;">
                     <div style="height:5mm;width:129mm;">
                    
                      <!--<img src="{$ImagePath}/5329_Bullet_Sm.gif" alt="Small Right Arrow Image"/>--> 
                       Attach to Form 1040, 1040-SR, 1040-NR, or 1041.<br/>
							<!--<img src="{$ImagePath}/5329_Bullet_Sm.gif" alt="Small Right Arrow Image"/>--> Go to 
            ...
            <div class="styTYBox" style="height:18mm;width:30mm;border-left-width:1px;">
              <div class="styOMB" style="width:30mm;font-size:7pt;">OMB No. 1545-0074</div>
              <div class="styTaxYear" style="height:7mm;font-size:22pt;">20<span class="styTYColor">25</span>
              </div>
              <div class="stySequence" style="height:5mm;width:28mm;margin-left:2mm;">
					Attachment
					Sequence No. 
          ...
          <div class="styGenericDiv" style="width:187mm;border-bottom:1px solid black">
            <div class="styGenericDiv" style="">
              <!-- Left Panel -->
              <div class="styIRS5329LineItem" style="width:28%;float:left;height:35mm;border-right:1px solid black;">
                <!-- Text -->
              ...
              <div class="styIRS5329LineItem" style="width:72%;float:left;height:18mm;">
                <div class="styIRS5329LineItem" style="width:100%;border-bottom-width:1px;border-color:black;height:15mm;">
                  <div class="styIRS5329LineItem" style="height:15mm;width:135mm;">
					<div class="styGenericDiv" style="height:15mm;width:82.2mm;padding-left:4px;border-right:1px solid black;">
                    ...
                    <xsl:if test="$RtnHdrData/Filer/USAddress">
                      <xsl:call-template name="PopulateReturnHeaderFiler">
                        ...
                        <xsl:with-param name="BackupName">$RtnHdrDataFilerUSAddressLine1Txt</xsl:with-param>
                      </xsl:call-template>
                      <xsl:if test="$RtnHdrData/Filer/USAddress/AddressLine2Txt">
						  <br/>
						  <xsl:call-template name="PopulateReturnHeaderFiler">
							 <xsl:with-param name="TargetNode">AddressLine2Txt</xsl:with-param>
						  <xsl:with-param name="BackupName">$RtnHdrDataFilerUSAddressLine2Txt</xsl:with-param>
                      </xsl:call-template>
                      </xsl:if>
                    </xsl:if>
                    <xsl:if test="$RtnHdrData/Filer/ForeignAddress">
                      ...
                      <xsl:if test="$RtnHdrData/Filer/ForeignAddress/AddressLine2Txt">
						  ...
						  <xsl:call-template name="PopulateReturnHeaderFiler">
							 <xsl:with-param name="TargetNode">AddressLine2Txt</xsl:with-param>
                          <xsl:with-param name="BackupName">$RtnHdrDataFilerForeignAddressLine2Txt</xsl:with-param>
                      </xsl:call-template>
                      </xsl:if>
                    </xsl:if>
                  </div>
					<div class="styGenericDiv" style="height:15mm;width:11.5mm;padding-left:4px;border-right:1px solid black;">
						Apt. no. <br/>
					</div>
                ...
                <div class="styIRS5329LineItem" style="width:136mm;height:13mm;border-bottom:1px solid black;">
                  <div class="styIRS5329LineItem" style="width:136mm;float:left;padding-left:4px;height:6mm">
                    ...
                    <xsl:if test="$RtnHdrData/Filer/USAddress">
                      <xsl:call-template name="PopulateReturnHeaderFiler">
                        ...
                        <xsl:with-param name="BackupName">$RtnHdrDataFilerUSAddressCityNm</xsl:with-param>
                      </xsl:call-template>,
                      <span style="width:2px;"/>
                      <xsl:call-template name="PopulateReturnHeaderFiler">
                        <xsl:with-param name="TargetNode">StateAbbreviationCd</xsl:with-param>
                        <xsl:with-param name="BackupName">$RtnHdrDataFilerUSAddressStateAbbreviationCd</xsl:with-param>
                      </xsl:call-template>,
                      <span style="width:2px;"/>
                      <xsl:call-template name="PopulateReturnHeaderFiler">
                ...
                <div class="styIRS5329LineItem" style="height:7.5mm;width:135mm;">
					<div class="styGenericDiv" style="height:7.5mm;width:47.2mm;padding-left:4px;border-right:1px solid black;">
						Foreign country name<br/>
					</div>
					<div class="styGenericDiv" style="height:7.5mm;width:47mm;padding-left:4px;border-right:1px solid black;">
						Foreign province/state/county
					</div>
					<div class="styGenericDiv" style="height:7.5mm;width:40.5mm;padding-left:4px;">
						Foreign postal code
					</div>
				</div>	
              </div>
				...
				<div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
				  <span style="font-size:8pt;padding-right:1mm;"><b>Additional Tax on Early Distributions.</b></span>
					Complete this part if you took a taxable distribution (other than a qualified disaster
                                   recovery distribution) before you reached age 59½ from 
          ...
          <div class="styBB" style="height:25mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem"  style="height:9mm;">
                ...
                <div class="styIRS5329LNDesc" style="width:145mm;padding:0px 0px 0px 0px;">
					<div class="styIRS5329LNDesc" style="width:auto;">
					  <b>Additional tax.</b> Enter 10% (0.10) of line 3. Include this amount on Schedule 2 (Form 1040), line 8
					  <!--Dotted Line-->
					  <span class="styDotLn" style="float:right;clear:none;padding-right:1mm;">...</span>
					   <br/>
          ...
          <div class="styBB"  style="height:auto;;width:187mm;">
            ...
            <div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
				<span style="font-size:8pt;padding-right:1mm;"><b>
				Additional Tax on Certain Distributions From Education Accounts and ABLE Accounts.</b></span> Complete this part if you
					included an amount in income, on Schedule 1 (Form 1040), line 8z, from a Coverdell education savings account (ESA) or a 
					qualified tuition program (QTP), or on Schedule 1 (Form 1040), line 8q, from an ABLE account.
            </div>
          </div>
          <!-- Body -->
          <div class="styBB" style="height:16mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem"  style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  <b>Additional tax.</b> Enter 10% (0.10) of line 7. Include this amount on Schedule 2 (Form 1040), line 8
                 <!--Dotted Line-->
                    <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">...</span>	  
                </div>
              </div>
          ...
          <div  class="styBB"  style="height:auto;width:187mm;">
			...
			Complete this part if you contributed more to your traditional IRAs (which include your traditional SEP IRAs and traditional SIMPLE IRAs) for 2025 than is allowable or you had an amount on
					line 17 of your 2024 Form 5329.
            </div>
          </div>
          <!-- Body -->
          <div class="styBB" style="height:48mm;width:187mm;">
            <!-- (9) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem"  style="height:4mm;">
            ...
            <div class="styIRS5329LineItem"  style="height:7mm;">
                ...
                <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
					<div class="styIRS5329LNDesc" style="width:auto;height:100%;">
					  If your traditional IRA contributions for 2025 are less than your maximum<br/>
            ...
            <div class="styIRS5329LineItem"  style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:6mm;">
                  2025 distributions of prior year excess contributions to traditional IRAs (see instructions)
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.....................</span>
                </div>
              </div>
              <div class="styIRS5329LNDesc" style="height:100%;width:74mm;float:right;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="height:6mm;width:36mm;float:right;padding:0px 0px 0px 0px;">
                  <xsl:call-template name="CreateBox">
                ...
                <div class="styIRS5329LNDesc" style="height:auto;width:36mm;float:right;padding:0px 0px 0px 0px;">
                  <xsl:call-template name="CreateBox">
                    <xsl:with-param name="Height">6mm;padding-top:2mm</xsl:with-param>
            ...
            <!-- (13) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem"  style="height:6mm;padding-top:2mm">
            ...
            <div class="styIRS5329LineItem"  style="height:10mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  ...
                  December 31, 2025 (including 2025 contributions made in 2026). Include this amount on Schedule 2 (Form 1040), line 8 
				<span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">...............................</span>
                </div>
              </div>
              <div class="styIRS5329LNDesc" style="height:100%;width:36mm;float:right;padding:0px 0px 0px 0px;">
          ...
          <div  class="styBB" style="height:auto;width:187mm;">
            ...
            <div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
				<span style="font-size:8pt;padding-right:1mm;"><b>Additional Tax on Excess Contributions to Roth IRAs.</b></span>
					Complete this part if you contributed more to your Roth IRAs (which include your Roth SEP IRAs and Roth SIMPLE IRAs) for 2025 than is allowable or you had an amount on line 25
					of your 2024 Form 5329.
            </div>
          </div>
          <div class="styBB" style="height:38.5mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem" style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:6mm;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  If your Roth IRA contributions for 2025 are less than your maximum
            ...
            <div class="styIRS5329LineItem" style="height:8mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  <b>Additional tax.</b> Enter 6% (0.06) of the <b>smaller</b> of line 24 <b>or</b> the value of your Roth IRAs on December 31, 2025
	...
	<div class="pageEnd" style="width:187mm;padding-top:1mm;">
		<div style="float:left;">
			<span class="styBoldText" style="width:120mm; ">For Privacy Act and Paperwork Reduction Act Notice, see your tax return instructions.</span>
			<span style="width:5mm;"/>                      
                Cat. No. 37748H
		</div>
		...
		<div style="float:right;">
      	  ...
      	  Form <span class="styBoldText" style="font-size:8pt;">5329</span> (2025)
		</div>
	...
	<div class="styBB" style="width:187mm;padding-top:.5mm;">
		<div style="float:left;">Form 5329 (2025)<span style="width:140mm;"/></div>				
		<div style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">2</span></div>
          ...
          <div class="styBB" style="width:187mm;" >
            ...
            <div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
				<span style="font-size:8pt;padding-right:1mm;"><b>Additional Tax on Excess Contributions to Coverdell ESAs.</b></span>
					Complete this part if the contributions to your Coverdell ESAs for 2025 were more than is allowable or you had an amount
					on line 33 of your 2024 Form 5329.
             </div>
          </div>
          <!-- Body -->
          <div class="styBB" style="height:38.5mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter the excess contributions from line 32 of your 2024 Form 5329.  See instructions. If zero, go to line 31
                  <!--Dotted Line-->
                  <!--<span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">...............................</span>-->
                </div>
              </div>
            ...
            <div class="styIRS5329LineItem"  style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  If the contributions to your Coverdell ESAs for 2025 were less than the maximum <br/>allowable contribution, see instructions. Otherwise, enter -0-
                 <!--Dotted Line--> 
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">......</span>
                </div>
              </div>
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  2025 distributions from your Coverdell ESAs (see instructions)
                </div>
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 3mm 0px 0px;">
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.....</span>
          ...
          <div class="styBB" style="height:auto;width:187mm;" >
            ...
            <div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
 				<span style="font-size:8pt;padding-right:1mm;"><b> Additional Tax on Excess Contributions to Archer MSAs.</b></span>
					Complete this part if you or your employer contributed more to your Archer MSAs for 2025 than is allowable or you had
					an amount on line 41 of your 2024 Form 5329.
             </div>
          </div>
          <!-- Body -->
          <div class="styBB" style="height:41.3mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:1px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter the excess contributions from line 40 of your 2024 Form 5329.  See instructions. If zero, go to line 39
            ...
            <div class="styIRS5329LineItem" style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  If the contributions to your Archer MSAs for 2025 are less than the
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  2025 distributions from your Archer MSAs from Form 8853, line 8
                </div>
          ...
          <div class="styBB" style="height:auto;width:187mm;" >
            ...
            <div class="styLNDesc" style="height:auto;width:172mm;padding-left:3mm;">
 				<span style="font-size:8pt;padding-right:1mm;"><b>Additional Tax on Excess Contributions to Health Savings Accounts (HSAs).</b></span>
					Complete this part if you, someone on your behalf, or your employer contributed more to your HSAs for 2025 than is
					allowable or you had an amount on line 49 of your 2024 Form 5329.
              </div>
          </div>
          <!-- Body -->
          <div class="styBB" style="height:38mm;width:187mm;">
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  Enter the excess contributions from line 48 of your 2024 Form 5329. If zero, go to line 47
                </div>
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 3mm 0px 0px;">
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">......</span>
            ...
            <div class="styIRS5329LineItem" style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  If the contributions to your HSAs for 2025 are less than the maximum
                  allowable <br/>contribution, see instructions. Otherwise, enter -0-
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.........</span>
                </div>
            ...
            <div class="styIRS5329LineItem" style="height:4mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:107mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  2025 distributions from your HSAs from Form 8889, line 16
                </div>
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 3mm 0px 0px;">
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">......</span>
            ...
            <div class="styIRS5329LineItem" style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
                  <b>Additional tax.</b> Enter 6% (0.06) of the <b>smaller</b> of line 48 <b>or</b> the value of your HSAs on December 31, 2025
                  (including 2025 contributions made in 2026). Include this amount on Schedule 2 (Form 1040), line 8
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:2mm;">...</span>
                </div>
          ...
          <div class="styBB" style="width:187mm;" >
            <!-- Content -->
				...
				<span style="font-size:8pt;padding-right:1mm;"><b>Additional Tax on Excess Contributions to an ABLE Account.</b></span>
					Complete this part if contributions to your ABLE account for 2025 were more than is allowable.
				</div>
          </div>
          <!-- Body -->
            ...
            <div class="styIRS5329LineItem" style="height:7mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS5329LNDesc" style="width:auto;height:100%;">
				  ...
				  December 31, 2025. Include this amount on Schedule 2 (Form 1040), line 8
                   <!--Dotted Line-->
                   <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">...........</span>
                </div>
               </div>
	...
	<div class="styBB" style="width:187mm;padding-top:.5mm;">
       ...
       <!-- Body -->
       <div class="styBB" style="height:39mm;width:187mm;">
            <!-- (52a.) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:7mm;">
              <div class="styIRS5329LNLeftNumBox">52a.</div>
              <div class="styIRS5329LNDesc" style="width:145mm;height:mm;">
                  Minimum required distribution for 2025 from all qualified plans for which you received a distribution of the full<br/>
                  amount of the excess accumulation during the correction window.
                   <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;clear:none;padding-left:1mm;">..............</span>
              </div>
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">7mm;padding-top:3mm</xsl:with-param>
                <xsl:with-param name="Number">52a.</xsl:with-param>
            ...
            <!-- (52b) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:5mm;">
              <div class="styIRS5329LNLeftNumBox" style="padding-left: 4mm;">b.</div>
              <div class="styIRS5329LNDesc" style="width:145mm;height:5mm;">
                  Minimum required distribution for 2025 from all other plans.
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;clear:none;padding-left:1mm;">................</span>
              </div>
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">5mm;padding-top:1mm;padding-left:3mm;</xsl:with-param>
                <xsl:with-param name="Number">b.</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanMinRqrDistriAmt"/>
               </xsl:call-template>
            </div>  
  
             <!-- (53a.) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:7mm;padding-botton:1mm;">
              <div class="styIRS5329LNLeftNumBox">53a.</div>
              <div class="styIRS5329LNDesc" style="width:145mm;height:7mm;">
                  Amount distributed to you during 2025 from all qualified plans for which you received a distribution of the full<br/>
                  amount of the excess accumulation during the correction window.
                   <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;clear:none;padding-left:1mm;">..............</span>
              </div>
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">7mm;padding-top:3mm</xsl:with-param>
                <xsl:with-param name="Number">53a.</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/QlfyRetirePlanActualDistriAmt"/>
               </xsl:call-template>
            </div> 
  
              <!-- (53b) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:5mm;paddig-bottom:1mm;">
              <div class="styIRS5329LNLeftNumBox" style="padding-left: 4mm;">b.</div>
              <div class="styIRS5329LNDesc" style="width:145mm;height:5mm;">
                  Amount distributed to you during 2025 from all other plans.
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;clear:none;padding-left:1mm;">................</span>
              </div>
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">5mm;padding-top:1mm;padding-left:3mm;</xsl:with-param>
                <xsl:with-param name="Number">b.</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanActualDistriAmt"/>
               </xsl:call-template>
            </div>  
  
             <!-- (54a) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:5mm;padding-botton:1mm;">
		        <div class="styIRS5329LNLeftNumBox" style="padding-top:.7mm;" >54a.</div>
               <div class="styIRS5329LNDesc" style="width:145mm;height:5mm;">
                  Subtract line 53a from line 52a and multiply the result by 10% (0.10). If zero or less, enter -0-
                ...
                <div class="styIRS5329LNDesc" style="width:auto;height:5mm;text-align:right;float:right;padding:0px 3mm 0px 0px;">
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.</span>
                    ...
                    <xsl:if test="not($Form5329Data/QlfyRetirePlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd)">
                      <span style="width:11px;padding-top:.5mm;"/>.
                    </xsl:if>
                </div>
              </div>
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">5mm;padding-top:.7mm</xsl:with-param>
                <xsl:with-param name="Number">54a.</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/QlfyRetirePlanExcessAccumAmt"/>
                </xsl:call-template>
            </div>
             ...
             <!-- (54b) ////////////////////////////////////////////////////-->
            <div class="styIRS5329LineItem" style="height:5mm;">
				<div class="styIRS5329LNLeftNumBox" style="padding-left: 4mm;padding-top:.8mm;">b.</div>
              <div class="styIRS5329LNDesc" style="width:145mm;height:5mm;">
                  Subtract line 53b from line 52b and multiply the result by 25% (0.25). If zero or less, enter -0-
                  <xsl:if test="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd">
                    <span style="width:5px"/>
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
                      <xsl:with-param name="Desc">Waive Tax On Ex Accum QRP Statement Code</xsl:with-param>
                      <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd"/>
                    </xsl:call-template>
                  </xsl:if>
                   <xsl:if test="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt">
                    <span style="width:5px"/>
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
                      <xsl:with-param name="Desc">Waive Tax On Ex Accum QRP Statement Amount</xsl:with-param>
                      <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt"/>
                    </xsl:call-template>
                  </xsl:if>
                   <span style="width:5px"/> 
                    <xsl:call-template name="SetFormLinkInline">
							<xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt"/>
					  </xsl:call-template>
                <div class="styIRS5329LNDesc" style="width:auto;height:5mm;text-align:right;float:right;padding:0px 3mm 0px 0px;">
					  <!--Dotted Line-->
					  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.</span>
                    <xsl:if test="not($Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt)">
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.</span>
                     </xsl:if>
                    <xsl:if test="not($Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd)">
						  <!--Dotted Line-->
						  <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">.</span> 
                    </xsl:if>
                </div>
              ...
              <xsl:call-template name="CreateBox">
                <xsl:with-param name="Height">5mm;padding-top:.8mm;padding-left:3mm;</xsl:with-param>
                <xsl:with-param name="Number">b.</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt"/>
                </xsl:call-template>
            </div>
            ...
            <div class="styIRS5329LineItem" style="height:5mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:145mm;height:5mm;">
                  Add lines 54a and 54b. Include the total on Schedule 2 (Form 1040), line 8 or Form 1041, Schedule G, line 8
                    <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;clear:none;padding-left:2mm;">.</span>
              </div>
              <div class="styIRS5329LNDesc" style="height:5mm;width:36mm;float:right;padding:0px 0px 0px 0px;">
                  <xsl:call-template name="CreateBox">
					<xsl:with-param name="Height">5mm;border-bottom-width:0px;</xsl:with-param>
         ...
         <div class="styBB" style="height:20mm;width:187mm;"> 
            <div class="styIRS5329LineItem" style="height:20mm;">
              ...
              <div class="styIRS5329LNDesc" style="width:147mm;height:10mm;padding:0px 0px 0px 5px;">
                ...
                <span class="styIRS5329LNDesc" style="width:5mm;padding:0px 0px 0px 5px;">
                  <!--<img src="{$ImagePath}/5329_Bullet_Md.gif" alt="Medium Right Arrow Image"/>-->
                </span>
          ...
          <div style="width:187mm;">
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8pt;">5329</span> (2025)
            </div>
          </div>
          <div class="styStdDivLS pageEnd" style="border-top:0px solid black;">
          </div>
          <!-- END Page Break and Footer-->
          ...
          <table class="styLeftOverTbl">
           ...
           <xsl:if test="$Form5329Data/QlfyRetirePlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd">
              <xsl:call-template name="PopulateLeftoverRow">
                <xsl:with-param name="Desc">Part IX, Line 54a - Waive Tax On Ex Accum QRP Statement Code</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/QlfyRetirePlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd"/>
                <xsl:with-param name="DescWidth" select="130"/>
              </xsl:call-template>
            </xsl:if>
           <xsl:if test="$Form5329Data/QlfyRetirePlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt">
              <xsl:call-template name="PopulateLeftoverRowAmount">
                <xsl:with-param name="Desc">Part IX, Line 54a - Waive Tax On Ex Accum QRP Statement Amount</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/QlfyRetirePlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt"/>
                <xsl:with-param name="DescWidth" select="130"/>
              </xsl:call-template>
            </xsl:if>
           <xsl:if test="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd">
              <xsl:call-template name="PopulateLeftoverRow">
                <xsl:with-param name="Desc">Part IX, Line 54b - Waive Tax On Ex Accum QRP Statement Code</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtCd"/>
                <xsl:with-param name="DescWidth" select="130"/>
              </xsl:call-template>
            </xsl:if>
           <xsl:if test="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt">
              <xsl:call-template name="PopulateLeftoverRowAmount">
                <xsl:with-param name="Desc">Part IX, Line 54b - Waive Tax On Ex Accum QRP Statement Amount</xsl:with-param>
                <xsl:with-param name="TargetNode" select="$Form5329Data/AllOthQlfyPlanExcessAccumAmt/@waiveTaxOnExAccumQRPStmtAmt"/>
                <xsl:with-param name="DescWidth" select="130"/>
              </xsl:call-template>
            </xsl:if> 
