...
political action committee (PAC). If additional space is needed, provide information in Part IV.   </div>
            ...
            Cat. No. 50084S
						...
						<div style="width:50mm;text-align:right;float:left;">
							<span style="font-weight:bold;font-size:6pt">Schedule C (Form 990) 2025</span>
						</div>
					</div>
					<br/>
					<!--END Page Footer-->
					...
					<div class="styBB" style="width:187mm; float: none; clear:none">
						<div style="float:left">Schedule C (Form 990) 2025</div>
...
exempt under section 501(c)(3) and filed Form 5768 (election under section 501(h)).
    ...
    Check <span style="width:2mm;"/>
							<span style="width:1mm;"/>
								<input type="checkbox" alt="Organization belongs affiliated group" class="IRS990ScheduleC_Checkbox">
    ...
    Check <span style="width:2mm;"/>
							<span style="width:1mm;"/>
								<input type="checkbox" alt="Limited control provision" class="IRS990ScheduleC_Checkbox">
									<xsl:call-template name="PopulateCheckbox">
      ...
      (Some organizations that made a section 501(h) election do not have to complete all of the five<br/> columns below. See the separate instructions for lines 2a through 2f.)</span>
        ...
        Calendar year (or fiscal year<br/> beginning in)
								...
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(a)  </span> 2022</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(b) </span> 2023</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(c) </span> 2024</th>
								<th class="IRS990ScheduleC_GenericCell" style="height:12mm;width:21mm;text-align:center;font-weight:normal;" scope="col">
									<span style="font-weight:bold;">(d) </span> 2025</th>
							...
							<!-- filler row -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="border-bottom-width:0px;" valign="top"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_GenericCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-right-width:0px;border-bottom-width:0px;"><span style="width:1px;" /></td>
							</tr>
							<!-- line 2a -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;">2a</td>
								<td class="IRS990ScheduleC_GenericCell" scope="col">Lobbying nontaxable amount
        
      </td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" >
									<xsl:call-template name="PopulateAmount">
								...
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-right-width:0px;">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="border-bottom-width:0px;" valign="top"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_GenericCell" scope="col" style="border-bottom-width:0px;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width:0px;background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-right-width:0px;border-bottom-width:0px;"><span style="width:1px;" /></td>
							...
							<!-- line b -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;">b</td>
								<td class="IRS990ScheduleC_GenericCell" scope="col">Lobbying ceiling amount<br/> (150% of line 2a, column(e))
        
      </td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-right-width:0px;">
							...
							<!-- line c -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;">c</td>
								<td class="IRS990ScheduleC_GenericCell" scope="col">Total lobbying expenditures
							...
							<!-- line d -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;">d</td>
							...
							<!-- line e -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;">e</td>
								<td class="IRS990ScheduleC_GenericCell" scope="col" >Grassroots ceiling amount <br/>(150% of line 2d, column (e))</td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="background-color:lightgrey;"><span style="width:1px;" /></td>
							...
							<!-- line f -->
							<tr>
								<td class="IRS990ScheduleC_IndexCell" scope="col" style="vertical-align:top;border-bottom-width: 0px">f</td>
								<td class="IRS990ScheduleC_GenericCell" scope="col" style="border-bottom-width: 0px">Grassroots lobbying expenditures
       
      </td>
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-bottom-width: 0px">
									<xsl:call-template name="PopulateAmount">
								...
								<td class="IRS990ScheduleC_MoneyCell" scope="col" style="border-right-width:0px;border-bottom-width: 0px">
									<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm">
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule C (Form 990) 2025</span>
						</div>
					</div>
					<br/>
					<br/>
					...
					<div class="IRS990ScheduleC_LineIndexMid" style="width: 19.9mm; height: 12mm; padding-top: 0mm; border-top-width: 1px; border-right-width: 0px; border-left-width: 1px;">(a)<br/>
					<div class="IRS990ScheduleC_LineIndexMid" style="height:8.5mm;border-right-width:0px;width:9.7mm;border-top-width:1px;border-right-width:1px;border-bottom-width:0px;padding-top:2.5mm">Yes</div>
					<div class="IRS990ScheduleC_LineIndexMid" style="height:8.5mm;border-right-width:0px;width:9.9mm;border-top-width:1px;border-bottom-width:0px;float:right;padding-top:2.5mm;">No</div></div>
