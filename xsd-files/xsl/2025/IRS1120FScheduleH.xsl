      ...
      <body class="styBodyClass" style="width:187mm">
        <form name="Form1120FScheduleH">
          <!-- BEGIN WARNING LINE -->
			...
			<div class="styTYBox" style="width:31mm;height:20mm;border-left-width:1px;">
				...
				<div class="styTY" style="padding-top:2mm;">20<span class="styTYColor">25</span></div>
			</div>					
			</div>
			<!--End header-->
           <!--Begin Name/EIN-->
          ...
          <div class="styBB" style="width:187mm;height:11.5mm">
            ...
            <div class="styPartDesc">Home Office Deductible Expenses Definitely Related Solely to ECI or Non&#45;ECI
              <span style="font-size:7pt;">Note:
                ...
                <input type="checkbox" aria-label="US dollar or functional currency" class="styCkbox">
		...
		<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
				   ...
				   <xsl:choose>
						<xsl:when test="$FormData/USDollarsInd">
							<div style="width:30mm;">
							 <input type="checkbox" aria-label="Line 1b U.S. GAAP Indicator" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<input type="checkbox" aria-label="Line 1b Home Country GAAP Indicator" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
						...
						<label>
							...
							<br/>
					    <div style="width:30mm;">
							<input type="checkbox" aria-label="Line 1b IFRS Indicator" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<input type="checkbox" aria-label="Line 1b Other Accounting Convention Indicator" class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
						...
						<xsl:otherwise>
							...
							<div style="width:30mm;">
								<input type="checkbox" aria-label="Line 1b GAAP Functional Currency Indicator" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" aria-label="Line 1b Home Country GAAP Functional Currency Indicator" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
							...
							<br/>
					    <div style="width:30mm;">
							<input type="checkbox" aria-label="Line 1b IFRS Functional Currency Indicator" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
                            ...
                            <input type="checkbox" aria-label="Line 1b Other (Specify) Accounting Functional Currency Indicator" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
				...
				<!--End Part III Header-->                
				  <div class="styBB" style="width:187mm;height:14mm;">
					...
					<!--  <img src="{$ImagePath}/1120FSchH_Bullet_Round.gif" alt="Bullet Image"/>-->
                      ...
                      <input type="checkbox" aria-label="one or more method" class="styCkbox">
                        <xsl:call-template name="PopulateCheckbox">
                          <xsl:with-param name="TargetNode" select="$FormData/MethodDifferentPriorYearInd"/>
                          <xsl:with-param name="BackupName">IRS1120FIRS1120FScheduleHUSDollarsIndMethodDifferentPriorYearInd</xsl:with-param>
                        </xsl:call-template>
                   ...
                   <!--   <img src="{$ImagePath}/1120FSchH_Bullet_Round.gif" alt="Bullet Image"/>-->
                      ...
                      <label>
						...
						<span class="styDotLn" style="float:right;">...............................
						  <input type="checkbox"  aria-label="Interbranch amount on books and records"  class="styCkbox">
							<xsl:call-template name="PopulateCheckbox">
							  <xsl:with-param name="TargetNode"  select="$FormData/RecordedInterbranchAmountInd"/>
							  <xsl:with-param name="BackupName">IRS1120FIRS1120FScheduleHUSDollarsIndRecordedInterbranchAmountInd</xsl:with-param>
							</xsl:call-template>
            ...
            <table cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt;">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="sty1120FSchHLNDescLong" scope="row">Did the corporation use any other methods (for example, time-spent analysis or estimates) in Parts I and II? If "Yes," attach statement
                  <span style="float:left;">
                  <span style="width:0.5mm"/>
                  </span> (see instructions)                   <xsl:call-template name="SetFormLinkInline">
		  ...
		  <div class="sty1120FSchHFooter">
            ...
            <div style="float:right;text-align:right;width:40mm" class="styGenericDiv"><b>Schedule H (Form 1120-F) 2025</b>
            </div>
          </div>
          <div class="pageEnd"/>
          <!-- End Page 1 Footer-->
          ...
          <div>Schedule H (Form 1120-F) 2025</div>
          ...
          <div  class="styGenericDiv" style="width:187mm;clear:both;padding-top:2px">
            <div style="float:right;" class="styGenericDiv"><b>Schedule H (Form 1120-F) 2025</b>
            </div>
          </div>
          <!-- End Page 2 Footer-->
