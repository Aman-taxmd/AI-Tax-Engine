							...
							<span class="styLNDesc" style="width:179mm;height:auto;">
								...
								<span>
									...
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox" class="styCkbox" aria-label="Written policy of two weeks paid family and medical leave Yes" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;">
									...
									<br />
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox" class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Written policy of two weeks paid family and medical leave No">
						...
						<div class="styStdDiv">
							...
							<span class="styLNDesc" style="width:179mm;height:auto;">
								...
								<span>
									...
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox"  class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Written policy of paid family and medical leave at least fifty percent wages Yes">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/WrttnPlcyPdFamMedLv50PctInd" />
									...
									<br />
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox" class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Written policy of paid family and medical leave at least fifty percent wages No">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/WrttnPlcyPdFamMedLv50PctInd" />
												<xsl:with-param name="BackupName">IRS8994WrttnPlcyPdFamMedLv50PctInd</xsl:with-param>
											</xsl:call-template>
						...
						<div class="styStdDiv">
							...
							<span class="styLNDesc" style="width:179mm;height:auto;">
								...
								<span>
									...
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox"  class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Paid family or medical leave this year Yes">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PaidFamilyMedLeaveInd" />
									...
									<br />
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox" class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Paid family or medical leave this year No">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PaidFamilyMedLeaveInd" />
												<xsl:with-param name="BackupName">IRS8994PaidFamilyMedLeaveInd</xsl:with-param>
											</xsl:call-template>
						...
						<div class="styStdDiv">
							...
							<span class="styLNDesc" style="width:179mm;height:auto;">
								...
								<span>
									...
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox"  class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Written policy complied non-interference Yes">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/WrttnPolicyNoninterferenceInd" />
									...
									<br />
									<div style="width:5mm;height:4mm;float:left;">
										<input type="checkbox" class="styCkbox" style="margin-top:3px;margin-bottom:0px;margin-right:0px;margin-left:0px;" aria-label="Written policy complied non-interference No">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/WrttnPolicyNoninterferenceInd" />
												<xsl:with-param name="BackupName">IRS8994WrttnPolicyNoninterferenceInd</xsl:with-param>
											</xsl:call-template>
