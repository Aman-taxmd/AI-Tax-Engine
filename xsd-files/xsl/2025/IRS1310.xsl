...
<!-- 07/10/2025 - Changes for 1008577 - AJH -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html>
            ...
            Form<span class="styFormNumber"> 1310</span><br/>(Rev. January 2026)
...
Refund Due a Deceased Taxpayer</div>
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:3mm;"><br/>
								Go to <i>www.irs.gov/Form 1310</i> for the latest information.
							</div>
					...
					<div class="styGenericDiv" style="width:187mm;height:auto;">
						...
						<div class="styGenericDiv" style="width:171mm;height:auto;border-left:1px solid black;border-bottom:1px solid black;padding-left:2mm;">
							<span class="styNameBox" style="width:138mm;height:auto;font-size:7pt;">
								<span> Address of person claiming refund (number and street). If you have a P.O. box, see instructions.</span><br/>
								<span>
									<xsl:call-template name="PopulateText">
					...
					<div class="styGenericDiv" style="width:187mm;border-top:1px solid black;border-bottom:1px solid black;padding:1mm 0mm;">
						...
						<div class="styPartDesc" style="font-size:7pt;">Check only <span style= "text-decoration:underline">one</span> box.  Complete Part II only if you check the box on line C. However, you must complete Part III.</div>
					</div>
					<!-- Part I, Line A -->
					...
					<div class="styGenericDiv" style="width:187mm;padding-bottom:1mm;font-size:8pt;">
						...
						<label>
						  ...
						  <xsl:with-param name="BackupName">FormDataCourtOrPersonalRepInd</xsl:with-param>
							...
							<span style="line-height:4mm;">Court-appointed or certified personal representative (defined below) claiming a refund on Form 1040-X or Form 843.<br/> If you check the box on line B, you must attach a court certificate showing your appointment, <span style="font-weight:bold;">even if</span> you have<br/> previously filed that certificate with the IRS. </span>
						</label>
					</div>
					<!-- Part I, Line C -->
					<div class="styGenericDiv" style="width:187mm;padding-bottom:1mm;font-size:8pt;">
						...
						<label>
						  ...
						  <xsl:with-param name="BackupName">FormDataOtherPersonClaimingRefundInd</xsl:with-param>
							...
							<span style="line-height:4mm;">Person, <span style="font-weight:bold;">other</span> than A or B, claiming refund for the decedent's
								 estate. If you check the box on line C,<br/> you must complete Part II.</span>
						</label>
						</div>
							<!-- Part I END -->
							<!-- Part II -->
					...
					<div style="width:187mm;font-size:8pt;font-weight:bold;">
						<span style="width:150mm;">Signature of person claiming refund </span>
						<span style="width:37mm;">Date  
							<xsl:call-template name="PopulateMonth">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt; border-top:1px solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">1310</b> (Rev. 1-2026)
						</div>
							<br></br>
					</div>
