			...
			<body class="styBodyClass">
				<form id="Form990TScheduleA">
					...
					<div class="styStdDiv">
						...
						<div class="styFTBox" style="width:123mm;height:21.3mm;">
							...
							<span style="font-weight:bold;">
								Go to
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form990T" title="Link to IRS.gov"><i>www.IRS.gov/Form990T</i></a>
								for instructions and the latest information.
							</span><br />
							<span style="font-weight:bold;font-family:Arial;">
								Do not enter SSN numbers on this form as it may be made public if your organization is a
								 501(c)(3).
							</span>
						</div>
						<div class="styTYBox" style="width:32mm;height:21.3mm;">
							...
							<div style="text-align:center;background-color:black;font-size:6pt;
							 font-family:Arial;padding:0.5mm;padding-top:1mm;">
					...
					<div class="styStdDiv" style="font-size:7pt;border-top:1px solid black;">
						<div class="styGenericDiv" style="width:120mm;height:10.5mm;padding:0.5mm;
					...
					<div class="styStdDiv">
						...
						<div class="sty990TSchARightNumBox" style="height:7.5mm;padding-top:4mm;">4a</div>
						<div class="sty990TSchAAmtBox" style="height:7.5mm;padding-top:4mm;">
					...
					<div class="styStdDiv">
						...
						<div class="sty990TSchARightNumBox" style="height:7.5mm;padding-top:4mm;">8</div>
						<div class="sty990TSchAAmtBox" style="height:7.5mm;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDiv">
						...
						<div class="sty990TSchARightNumBox" style="height:7mm;padding-top:4mm;">9</div>
						<div class="sty990TSchAAmtBox" style="height:7mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 990-T) 2025</span>
					</div>
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="styGenericDiv" style="width:30mm;">
							<input type="checkbox" style="stCkboxNM" aria-label="Section 263A Rules Apply Yes">
							...
							<input type="checkbox" style="stCkboxNM" aria-label="Section 263A Rules Apply No">
					...
					<div class="styStdDiv" style="border-top:1px solid black;border-bottom:1px solid black;">
						...
						<div class="styPartDesc">Rent Income (From Real Property and Personal Property Leased with Real 
						 Property)</div>
					</div>
					<!-- Line 1 -->
					...
					<div class="styStdDiv">
						...
						<div class="sty990TSchADesc" style="width:178mm;">
							Description of property (property street address, city, state, ZIP code). Check if a dual-use
							 (see instructions)
						</div>
					</div>
					<xsl:if test="not($shouldSepPart4)">
						<xsl:for-each select="$FormData/RentIncomePropertyGrp">
							...
							<div class="styStdDiv" style="padding-left:8mm;">
								<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;"><xsl:number value="$pos"
								 format="A"/></div>
								<span class="styGenericDiv" style="width:4mm;">
									<input type="checkbox" class="styCkboxNM" aria-label="Dual Use">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="DualUseInd"/>
											<xsl:with-param name="BackupName">
											 IRS990TRentIncomePropertyGrpDualUseInd<xsl:value-of select="$pos"/>
											</xsl:with-param>
										</xsl:call-template>
										<xsl:attribute name="alt">Line <xsl:number format="A" value="$pos"/> 
										 Dual Use
										</xsl:attribute>
									</input>
								</span>
								<div class="styLNDesc" style="width:172mm;height:auto;min-height:4mm;
					...
					<xsl:if test="$shouldSepPart4 or ($part4Count &lt; 1)">
						<div class="styStdDiv" style="padding-left:8mm;">
							...
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property A dual-use" id="IRS990TSchAP4LADU"/>
							</span>
					...
					<xsl:if test="$shouldSepPart4 or ($part4Count &lt; 2)">
						<div class="styStdDiv" style="padding-left:8mm;">
							...
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property B dual-use" id="IRS990TSchAP4LBDU"/>
							</span>
					...
					<xsl:if test="$shouldSepPart4 or ($part4Count &lt; 3)">
						<div class="styStdDiv" style="padding-left:8mm;">
							...
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property C dual-use" id="IRS990TSchAP4LCDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="$shouldSepPart4 or ($part4Count &lt; 4)">
						<div class="styStdDiv" style="padding-left:8mm;">
							...
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property D dual-use" id="IRS990TSchAP4LDDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
						...
						<xsl:for-each select="$FormData/RentIncomePropertyGrp">
							...
							<xsl:if test="position() mod 4 = 1">
								...
								<div class="styStdDiv" style="">
									...
									<div class="sty990TSchAShortAmtBox" style="text-align:center;
									 font-weight:bold;"><xsl:number value="$pos" format="A"/>	
									</div>
									<div class="sty990TSchAShortAmtBox" style="text-align:center;
									 font-weight:bold;"><xsl:number value="$pos + 1" format="A"/>
									</div>
									<div class="sty990TSchAShortAmtBox" style="text-align:center;
									 font-weight:bold;"><xsl:number value="$pos + 2" format="A"/>
									</div>
									<div class="sty990TSchAShortAmtBox" style="text-align:center;
									 font-weight:bold;"><xsl:number value="$pos + 3" format="A"/>
									</div>
								</div>
								<!-- Part 4, Line 2 -->
								<div class="styStdDiv">
								...
								<!-- Part 4, Line 2a -->
								<div class="styStdDiv">
									<div class="styLNLeftNumBox" style="height:10mm;padding-left:4.2mm;">a
									</div>
									<div class="sty990TSchAShortDesc" style="height:auto;">
										From personal property (if the percentage of rent for personal property is more than
										 10% but not more than 50%)
										<span class="sty990TSchADotLn">......</span>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:10mm;padding-top:7mm">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="sty990TSchAShortAmtBox" style="height:10mm;padding-top:7mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/RentIncomePropertyGrp[$pos + 1]/RentPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:10mm;padding-top:7mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/RentIncomePropertyGrp[$pos + 2]/RentPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:10mm;padding-top:7mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 3]/RentPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
								</div>
								<!-- Part 4, Line 2b -->
								<div class="styStdDiv">
									<div class="styLNLeftNumBox" style="height:13mm;padding-left:4.2mm;">b
									</div>
									<div class="sty990TSchAShortDesc" style="height:auto;">
										From real and personal property (if the percentage of rent for personal property
										 exceeds 50% or if the rent is based on profit or income)
										<span class="sty990TSchADotLn">..........</span>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:13mm;padding-top:10mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="RentRealPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:13mm;padding-top:10mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 1]/RentRealPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:13mm;padding-top:10mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 2]/RentRealPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:13mm;padding-top:10mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 3]/RentRealPersonalPropertyAmt"/>
										</xsl:call-template>
									</div>
								</div>
								<!-- Part 4, Line 2c -->
								<div class="styStdDiv">
									<div class="styLNLeftNumBox" style="height:7mm;padding-left:4.2mm;">c
									</div>
									<div class="sty990TSchAShortDesc" style="height:auto;">
										Total rents received or accrued by property. Add lines 2a and 2b, columns A through D
										<span class="sty990TSchADotLn">.</span>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:7mm;padding-top:4mm">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="sty990TSchAShortAmtBox" style="height:7mm;padding-top:4mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 1]/TotalRentsByPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:7mm;padding-top:4mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 2]/TotalRentsByPropertyAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:7mm;padding-top:4mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$FormData/RentIncomePropertyGrp[$pos + 3]/TotalRentsByPropertyAmt"/>
										</xsl:call-template>
									</div>
								</div>
							</xsl:if>
					...
					<xsl:if test="$shouldSepPart5 or ($part5Count &lt; 1)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">A</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property A dual-use" id="IRS990TSchAP5LADU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateAdditionalDataTableMessage">
					...
					<xsl:if test="$shouldSepPart5 or ($part5Count &lt; 2)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">B</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property B dual-use" id="IRS990TSchAP5LBDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="$shouldSepPart5 or ($part5Count &lt; 3)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">C</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property C dual-use" id="IRS990TSchAP5LCDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="$shouldSepPart5 or ($part5Count &lt; 4)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">D</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Property D dual-use" id="IRS990TSchAP5LDDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					...
					<xsl:if test="not($shouldSepPart9)">
						<xsl:for-each select="$FormData/AdvertisingIncmPeriodicalGrp">
							...
							<div class="styStdDiv" style="padding-left:8mm;">
								<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;"><xsl:number value="$pos" format="A"/></div>
								<span class="styGenericDiv" style="width:4mm;">
									<input type="checkbox" class="styCkboxNM" aria-label="Line A Consolidated Periodical">
										<xsl:call-template name="PopulateCheckbox">
					...
					<xsl:if test="$shouldSepPart9 or ($part9Count &lt; 1)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">A</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Line A Consolidated Periodical" id="IRS990TSchAP9LADU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateAdditionalDataTableMessage">
					...
					<xsl:if test="$shouldSepPart9 or ($part9Count &lt; 2)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">B</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Line B Consolidated Periodical" id="IRS990TSchAP9LBDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="$shouldSepPart9 or ($part9Count &lt; 3)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">C</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Line C Consolidated Periodical" id="IRS990TSchAP9LCDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
					<xsl:if test="$shouldSepPart9 or ($part9Count &lt; 4)">
						<div class="styStdDiv" style="padding-left:8mm;">
							<div class="styLNLeftNumBox" style="width:3mm;padding-left:0px;">D</div>
							<span class="styGenericDiv" style="width:4mm;">
								<input type="checkbox" class="styCkboxNM" aria-label="Line D Consolidated Periodical" id="IRS990TSchAP9LDDU"/>
							</span>
							<div class="styLNDesc" style="width:172mm;border-bottom:1px solid black;">&nbsp;</div>
						</div>
					</xsl:if>
							...
							<xsl:if test="position() mod 4 = 1">
								<xsl:if test="($part9Count &gt; 4) and not($shouldSepPart9)">
									...
									<div class="styStdDiv" style="">
										<div class="styLNLeftNumBox" style="">&nbsp;</div>
										<div class="sty990TSchAShortDesc" style="">&nbsp;</div>
										<div class="sty990TSchAShortAmtBox" style="text-align:center;font-weight:bold;
										 border-top-width:1px;border-bottom-width:0px;"><xsl:number value="$pos" format="A"/>
										</div>
										<div class="sty990TSchAShortAmtBox" style="text-align:center;font-weight:bold;
										 border-top-width:1px;border-bottom-width:0px;"><xsl:number value="$pos + 1" 
										  format="A"/></div>
										<div class="sty990TSchAShortAmtBox" style="text-align:center;font-weight:bold;
										 border-top-width:1px;border-bottom-width:0px;"><xsl:number value="$pos + 2"
										  format="A"/></div>
										<div class="sty990TSchAShortAmtBox" style="text-align:center;font-weight:bold;
										 border-top-width:1px;border-bottom-width:0px;"><xsl:number value="$pos + 3" 
										 format="A"/></div>
									</div>
								</xsl:if>
								<!-- Part 9, Line 3 -->
								<div class="styStdDiv">
									...
									<div class="sty990TSchAShortAmtBox" style="height:4.2mm;border-top:1px solid black;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/AdvertisingIncmPeriodicalGrp[$pos + 1]/
									...
									<div class="sty990TSchAShortAmtBox" style="height:4.2mm;border-top:1px solid black;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/AdvertisingIncmPeriodicalGrp[$pos + 2]/
											 DirectAdvertisingCostAmt"/>
										</xsl:call-template>
									</div>
									<div class="sty990TSchAShortAmtBox" style="height:4.2mm;border-top:1px solid black;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/
											 AdvertisingIncmPeriodicalGrp[$pos + 3]/DirectAdvertisingCostAmt"/>
										</xsl:call-template>
									</div>
								</div>
							</xsl:if>
					...
					<div class="styStdDiv" style="padding-top:2mm;padding-bottom:2mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:4.2mm;">a</div>
						<div class="sty990TSchALongDesc" style="width:149mm;">
							Add line 8, columns A through D. Enter the greater of the line 8a columns total or zero here and
							 on Part II, line 13
