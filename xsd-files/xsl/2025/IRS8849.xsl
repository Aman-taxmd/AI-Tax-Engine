...
<!-- 09/12/2025 - UWR 1003382 - JSN -->
<!-- 09/15/2025 - UWR 1010944 - JSN -->
<!-- 10/03/2025 - UWR 1012064 - JSN -->
<!-- 12/05/2025 - defect 1760593 - JSN -->
<!-- 12/05/2025 - defect 1762166 - JSN -->
<!-- 12/05/2025 - defect 1762168 - JSN -->
<!-- 12/11/2025 - IRWorks ticket TESTINC0020638 - JSN -->
<!-- 01/09/2026 - UWR 1012080 - JSN -->
	...
	<xsl:template match="/">
		...
		<html>
				...
				<form name="IRS8849">
				    ...
				    <div class="styTBB" style="width:187mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:34mm;height:16mm;">
							...
							<br/>
							<span style="font-size:6.5pt;font-family:'Arial';">(Rev. December 2025)</span>
          ...
          <div class="styBB" style="font-family:'Arial';font-size:9pt;font-weight:bold;width:187mm;text-align:center;padding-top:2mm;padding-bottom:2mm;">
			...
			Schedules 2, 5, and 8 cannot be filed with any other schedules on Form 
          ...
          <table class="styTBB" style="width:187mm;font-size:7pt;border-bottom-width:1px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="3" style="width:187mm;">
				<div style="height:6mm;padding-top:2.5mm;padding-left:3mm;font-weight:bold;">1a <span style="width:1mm;"/>Total refund.</div> <span style="width:2.5mm;"/><!--Complete lines 1b, 1c, and 1d. See instructions-->
				<div style="height:6mm;padding-top:2.5mm;padding-left:3mm;padding-right:0mm;letter-spacing:4mm;font-weight:bold;">.......................</div>
				<span style="width:6mm;height:6mm;padding-top:2.5mm;font-weight:bold;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">1a</span>
				<span style="width:36mm;height:6mm;text-align:right;padding-top:2.5mm;border-bottom:1px solid black;border-left:1px solid black;">
            ...
            <tr>
              <td colspan="3" style="width:187mm;height:1mm;"></td>
			</tr>
            <tr>
              <td colspan="3" style="width:187mm;">
				<div style="height:5mm;padding-top:2mm;padding-left:5mm;font-weight:bold;">b</div> <span style="width:2mm;"/>Reserved for future use <!-- Routing number --><span style="width:4mm;"/>
				<div style="border-right:0px solid black;border-top:0px solid black;border-bottom:0px solid black;">
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
				...
				</div><span style="width:7mm;"/>
				<div style="height:5mm;padding-top:2mm;padding-left:5mm;font-weight:bold;">c</div> <span style="width:2mm;"/>Reserved for future use <!-- Type: -->
				<span style="width:5mm;"/>
				<div style="width:4mm;height:4mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;">
					<!--<input type="checkbox" class="styCkbox" aria-label="checking account">
					  <xsl:call-template name="PopulateCheckbox">
                ...
                <label>
                    ...
                    <!--Checking-->
				</label><span style="width:25mm;"/>
				<div style="width:4mm;height:4mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;">
					<!--<input type="checkbox" class="styCkbox" aria-label="savings account">
					  <xsl:call-template name="PopulateCheckbox">
            ...
            <tr>
              <td colspan="3" style="width:187mm;">
				<div style="height:5mm;padding-top:2mm;padding-left:5mm;font-weight:bold;">d</div> <span style="width:2mm;"/>Reserved for future use <!-- Account number --><span style="width:4mm;"/>
				<div style="border-right:0px solid black;border-top:0px solid black;border-bottom:0px solid black;">
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
					<span style="width:5mm;height:6mm;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;border-bottom:1px solid black;background-color:lightgrey;"></span>
            ...
            <tr>
              <td colspan="3" style="width:187mm;height:3mm;border-bottom:1px solid black;"></td>
			</tr>
            <tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:6pt;border-color:black;border-bottom:0px solid black;">
				<tr>
					...
					<td style="width:19mm;border-right:1px solid black;border-bottom:1px solid black;padding-left:1mm;vertical-align:bottom;padding-bottom:.5mm;">
						...
						<input class="styCkbox" type="checkbox" style="width:4mm;" aria-label="Self Employed">
						  <xsl:call-template name="PopulateReturnHeaderPreparer">
							<xsl:with-param name="TargetNode">SelfEmployedCheckbox</xsl:with-param>
							<xsl:with-param name="BackupName">PreparerSelfEmployed</xsl:with-param>
						  </xsl:call-template>
					...
					<tr>
						<!--row 2-->
						<td rowspan="1" colspan="3" style="border-bottom:1px solid black;border-right:0px solid black;padding-left:.5mm;">Firm's name
						...
						<td colspan="2" style="border-bottom:1px solid black;padding-left:10mm;">
							<div style="height:10mm;padding-left:1mm;padding-top:5mm;border-left:1px solid black;">
								Firm's EIN
					...
					<tr>
						<!--row 3-->
						<td rowspan="1" colspan="3" style="border-bottom:1px solid black;border-right:0px solid black;padding-left:.5mm;">Firm's address
						...
						<td colspan="2" style="border-bottom:1px solid black;padding-left:10mm;">
							<div style="height:10.5mm;padding-left:1mm;padding-top:7mm;border-left:1px solid black;">
								Phone no. 
								<xsl:call-template name="PopulateReturnHeaderPreparer">
			  ...
			  <div class="pageEnd" style="width:187mm;padding-top:1mm;">
				...
				Form <span class="styBoldText" style="font-size:8pt;">8849</span> (Rev. 12-2025)
			  </div>
			  </div>
