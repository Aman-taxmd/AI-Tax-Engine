...
<!-- Last Modified by Iskilu Lawal on 08/07/2025 drop 4 UWR # 1001759 -->  
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form8995A">
					...
					<div class="styStdDiv">
						...
						<div class="styFTBox" style="width:125mm;height:22.5mm;">
							...
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/> Attach to tax return.
							</span><br />
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/> Go to
								<a href="http://www.irs.gov/Form8995A"><i>www.irs.gov/Form8995A</i></a> 
					...
					<br/>
					<span style="width:10px;"></span>Use this form if your taxable income, before your qualified business income deduction, is above $197,300 ($394,600 if married filing jointly), or you’re a patron of an agricultural or horticultural cooperative.
						</div>
					<!-- Part 1 -->
						...
						<xsl:if test="position() mod 3 = 1">
							...
							<div class="styStdIBDiv">
								...
								<div class="sty8995ADesc" style="height:10mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $197,300 or less 
									($394,600 if married filing jointly), skip lines 4 through 12 and enter the amount from line 3 on line 13
									<span class="sty8995ADotLn">..</span>
								</div>
								...
								<div class="sty8995AAmtBox" style="min-height:10mm;"><br /><br />
									<xsl:call-template name="PopulateAmount">
						...
						<!-- Line 3 -->
							<div class="styStdDiv">
								...
								<div class="sty8995ADesc" style="height:13mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $191,950 or less ($383,900 if married 
					...
					<div class="styStdIBDiv">
						...
						<div class="sty8995ADesc" style="min-height:7.2mm;height:auto;">
							...
							<span class="sty8995ADotLn">............<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/> </span>
						</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">8995-A</span> (2025)</span>
					</div>
					<div class="styStdDiv">
						Form 8995-A (2025)
					...
					<div class="styStdDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;font-family:Arial;">
						Complete Part III only if your taxable income is more than $197,300 but not $247,300 ($394,600 and $494,600 if married filing jointly) and line 10 is less than line 3. Otherwise, skip Part III.
					</div>
					<xsl:for-each select="$FormData/QBIDeductionInformationGrp">
						<xsl:if test="position() mod 3 = 1">
							<xsl:variable name="pos" select="position()"/>
