...
<!-- 02/28/2023 - Made changes per UWR 966553 - JSN -->
<!-- 03/15/2024 - UWR 977710 - JSN -->
<!-- 03/13/2025 - UWR 995935 - JSN -->
<!-- 09/11/2025 - UWR 1003382 - JSN -->
        ...
        <form name="Form2290">
          ...
          <div class="styBB" style="width:187mm;">
			...
			Form <span class="styFormNumber">2290</span>
              ...
              <br/>
              <span class="styAgency">(Rev. July 2026)
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="font-size:6pt;width:187mm">
            <tbody>
              <tr>
                ...
                <td colspan="3" style="height:8mm;width:125mm;border:0 solid black;border-right-width:1px;border-bottom-width:1px;padding-left:2mm;">Name
                  <br/>
                ...
                <td colspan="2" style="width:30mm;height:8mm;border:0 solid black;border-right-width:0px;border-bottom-width:1px;vertical-align:top;padding-bottom:0.25mm;padding-left:1mm">
              ...
              <tr>
                <td colspan="4" valign="top" style="border:0 solid black;padding-top:.5mm;border-right-width:1px;border-bottom-width:1px;padding-left:2mm;height:8mm;">Number and street. (If a P.O. box, see instructions)
				  <br/>
                  <xsl:call-template name="PopulateReturnHeaderFiler">
                ...
                <td valign="top" style="width:24mm;border:0 solid black;padding-top:.5mm;border-right-width:0px;border-bottom-width:1px;padding-left:2mm;height:8mm;">Room or suite no.
				  <br/><br/>
                  <xsl:call-template name="PopulateReturnHeaderFiler">
              ...
              <tr>
                <td valign="top" style="border:0 solid black;border-right-width:1px;padding-left:2mm;width:32mm;height:8mm;">City or town
					<br/><br/><br/>
					<xsl:choose>
                ...
                <td valign="top" style="border:0 solid black;border-right-width:1px;padding-left:2mm;width:31mm;height:8mm;">State or province
				    <br/><br/><br/>
					<xsl:choose>
                ...
                <td valign="top" style="border:0 solid black;border-right-width:1px;padding-left:2mm;width:31mm;height:8mm;">Country
				    <br/><br/><br/>
					<xsl:choose>
                ...
                <td colspan="2" valign="top" style="border:0 solid black;border-right-width:0px;padding-left:2mm;width:31mm;height:8mm;">ZIP or foreign postal code
				    <br/><br/><br/>
					<xsl:choose>
...
Check if applicable:</div>
						...
						<tr>
							...
							<td style="height:auto;width:82.5mm;padding-top:1mm;">
								...
								<label>
								  ...
								  use limit.  <b>Do not </b>check this box for any other reason
								  </span>
							</td>
							<td style="height:auto;width:5mm;vertical-align:top;">
							...
							<td style="height:auto;width:82.5mm;padding-top:1mm;vertical-align:top;">
								<label>
								  ...
								  filed Schedule 1 (Form 2290). Attach an explanation to the return. <b>Don't</b> check this 
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:135mm;">Was the vehicle(s) reported on this return used on public highways during <b>July</b> 2026? If YES,</div>
            <div style="float:right">
...
<div style="width:187mm;">
  ...
  <div class="styLNDesc" style="width:117mm;">enter <span class="styBoldText">202607</span> in the boxes to the right. If NO, see the table on page 3 of the instructions</div>
    ...
    <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:84mm;">
              <span class="styBoldText">Credits</span><span style="width:1mm;"/> <i>(Attach supporting documentation. See instructions.)</i>
			  <xsl:call-template name="SetFormLinkInline">
        ...
        7,500 miles or less for agricultural vehicles</label>
              ...
              <br/>
during the period July 1, 2026, through June 30, 2027, and are suspended from the tax. Complete and attach Schedule 1.
       </div>
          </div>
          <!-- Line 8a -->
          <div style="height:8mm;width:187mm;padding-top:1mm;">
            ...
            I declare that the vehicles listed as suspended on the Form 2290 filed for the period July 1, 2025, through June 30, 2026, were not
          ...
          <div style="height:16mm;width:187mm;padding-top:1mm;">
           ...
           I declare that vehicle identification numbers 
            <span style="width:110mm;border-bottom:1 black solid">
              ...
              <br/>
were listed as suspended on the Form 2290 filed for the period July 1, 2025, through June 30, 2026. These vehicles were sold or
<br/>transferred to
      ...
      and RIS  ETA081635OTH   Also changed revision dates to 2008 -->
          ...
          <!-- BEGIN PREPARER SIGNATURE SECTION -->
            ...
            <tr>
							...
							<td style="width:45.5mm;border-right:1px solid black;border-bottom:1px solid black;padding-left:1mm;">Preparer's name
								<br/><br/>
								<xsl:choose>
        ...
        <xsl:call-template name="PopulateReturnHeaderPreparer">
          ...
          <div style="width:187mm;padding-top:.5mm;">
            <span>
              ...
              <span>Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2026)</span>
            </span>
          </div>
          <div class="pageEnd" />
          <!--  PAGE 1  END -->
          ...
          <div class="styBB" style="width:187mm;text-align:right;">
            <span style="float:left">Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2026)</span>Page <span class="styBoldtext" style="font-size:8pt">2</span>
          </div>
          <!--******************************************************************************************************************************************-->
          <!--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@-->
...
Tax Computation
              ...
              &lt;/xsl:choose&gt;-->
                <tr>
                  <td class="styTableCellText" style="width:105mm;height:12mm;text-align:justify" colspan="6">
                    <b>Totals.</b> Add the number of vehicles in columns (3)(a) and (3)(b). Enter the total here.
					(This should be the same total of taxable vehicles shown on Schedule 1, Part I, line c.)
                ...
                <tr>
                  <td class="styLNCtrNumBox" style="border-left-width:0px;height:10mm;vertical-align:middle" >W</td>
                  <td class="styTableCellText" style="width:40mm;font-size:6pt" colspan="2">
						Tax-Suspended Vehicles
						(See <i>Part I</i> on page 7 of the instructions.)
				  </td>
                  <td class="styTableCellText" style="height:10mm;width:76mm;background-color:lightgrey" colspan="3">
                    <span style="width:1px"/>
                  </td>
                  <td class="styTableCell" style="font-size:6pt;height:10mm;width:22mm;vertical-align:bottom">
                    <xsl:call-template name="PopulateAmount">
                  ...
                  <td class="styTableCell" style="height:10mm;width:30mm;background-color:lightgrey;border-right-width:0px">
                    <span style="width:1px"/>
                  </td>
                  <td class="styLNCtrNumBox" style="height:10mm;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;background-color:lightgrey" colspan="2">
                    <span style="width:1px"/>
                  </td>
                </tr>
                <tr>
          ...
          <div style="width:187mm">
            <span style="float:right"> Form <span class="styBoldText" style="font-size:8pt">2290</span> (Rev. 7-2026)</span>
          </div>
          <div class="pageEnd" />
