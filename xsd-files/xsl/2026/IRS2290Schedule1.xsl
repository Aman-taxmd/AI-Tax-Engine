...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
        ...
        <form name="Form2290Schedule1">
          ...
          <div class="styBB" style="width:187mm;">
            <div class="styFNBox" style="width:31mm;height:17mm;">
              ...
              <br/>
              <span class="styAgency">(Rev. July 2026)<span style="width:10mm;"/>Department of the Treasury</span>
              <br/>
            ...
            <div class="styFTBox" style="width:125mm;height:17mm;padding-top:1mm">
              ...
              <div class="styFST" style="height:4mm;font-size:8pt;text-align:center;font-weight:normal">
				 For the period July 1, 2026, through June 30, 2027<br/>
              </div>
              <div class="styFST" style="height:4mm;font-size:7pt;font-weight:normal;text-align:center">
				 <b>Complete and file both copies of Schedule 1. One copy will be stamped and returned to you for use as proof of payment when registering your vehicle(s) with a state.</b>
			  </div>
            </div>
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="font-size:6pt;width:187mm">
            <tbody>
              <tr>
                ...
                <td colspan="4" style="height:8mm;width:125mm;border:0 solid black;border-right-width:1px;border-bottom-width:1px;padding-left:2mm;">Name
                  <br/>
              ...
              <tr>
                <td colspan="5" valign="top" style="border:0 solid black;padding-top:.5mm;border-right-width:1px;border-bottom-width:1px;padding-left:2mm;height:8mm;">Number and street. (If a P.O. box, see instructions)
				  <br/>
                  <xsl:call-template name="PopulateReturnHeaderFiler">
                ...
                <td colspan="2" valign="top" style="width:20mm;border:0 solid black;padding-top:.5mm;border-right-width:0px;border-bottom-width:1px;padding-left:2mm;height:8mm;">Room or suite no.
				  <br/><br/>
                  <xsl:call-template name="PopulateReturnHeaderFiler">
              ...
              <tr>
                ...
                <td valign="top" style="border:0 solid black;border-right-width:1px;padding-left:2mm;width:31mm;height:8mm;">ZIP or foreign postal code
				    <br/><br/><br/>
					<xsl:choose>
                ...
                <td colspan="2" valign="top" style="border:0 solid black;border-right-width:1px;padding-left:2mm;width:30mm;height:8mm;text-align:center;">Month of first use
					<br/>(see instructions)		
					<br/>
					<div style="width:1mm;" />Y<div style="width:4mm;" />Y<div style="width:4mm;" />Y<div style="width:4mm;" />Y<div style="width:4mm;" />M<div style="width:4mm;" />M<br/>
                    <div style="width:1mm;"/><div style="width:5.5mm;height:4mm;border-left:1px solid black;border-right:1px solid black;" /> <div style="width:5.5mm;height:4mm;border-right:1px solid black;" /><div style="width:5.5mm;height:4mm;border-right:1px solid black;" /><div style="width:5.5mm;height:4mm;border-right:1px solid black;" />
                </td>
              </tr>
            </tbody>
          </table>
          
          <!--BEGIN PART 1 BEGIN PART 1 BEGIN PART 1 BEGIN PART 1 BEGIN PART 1-->
    ...
    <!--Dotted Line-->
          ...
          <!--  END PART 1    END PART 1   END PART 1     END PART 1   -->
          
          <!--BEGIN PART 2 BEGIN PART 2 BEGIN PART 2 BEGIN PART 2 BEGIN PART 2 BEGIN PART 2-->
          <div class="styTableContainer" id="VRTctn" style="border-top:1px solid black;border-bottom-width:0px;display:block;">
            <xsl:call-template name="SetInitialState"/>
            <!--Begin Part 1 Header-->
            <table cellspacing="0" cellpadding="0" style="font-size:7pt;border-bottom-width:0px;">
              <tr>
                <th scope="col" class="styBB" style="height:10.5mm;width:147mm;" colspan="2">
                  <div class="styPartName" style="height:10.5mm;vertical-align:center;padding-top:3.5mm;">Part II</div>
					<div style="font-size:8pt;text-align:left;padding-left:4mm;float:left;clear:none;padding-top:3.5mm;">Vehicles You Are Reporting <span style="font-weight:normal;display:inline;">(enter VIN and category)</span></div>
                </th>
                <th scope="col" style="height:10.5mm;font-weight:normal;font-size:7pt;width:40mm;height:3mm;text-align:center;border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;border-top-width:0px">
          ...
          <div style="width:187mm;border-top:1px black solid">
            ...
            <span style="float:right">
              <span class="styBoldText" style="font-size:6pt">Cat. No. 112500 <span style="width:5mm;"/>Schedule 1 (Form 2290)</span> (Rev. 7-2026)</span>
          </div>
          
          <!-- BEGIN  CONSENT TO DISCLOSURE OF TAX INFORMATION  -->
          <div class="pageEnd"/>
          <br/>
          <xsl:if test="$RtnHdrData/ConsentToVINDataDisclosureGrp/ConsentToDiscloseYesInd = 'X'">
          <div class="styTBB" style="width:187mm;border-bottom-width:1px;" >
            <div style="float:left;width:177mm;padding-bottom:0.5mm">Schedule 1 (Form 2290) (Rev. 7-2026)</div>
          ...
          <div style="width:187mm;height:8mm;font-size:11pt;text-align:center;vertical-align:middle">For the period July 1, 2026, through June 30, 2027</div>
...
authority to execute this consent to disclosure of tax information.
          ...
          <div style="width:187mm;text-align:right;padding-top:1mm">
            <b>Schedule 1 (Form 2290)</b> (Rev. 7-2026)</div>
          <div class="pageEnd"/>
          <br/>
          </xsl:if>
